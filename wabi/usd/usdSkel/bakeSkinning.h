 ...
 */
#ifndef WABI_USD_USD_SKEL_BAKE_SKINNING_H
#define WABI_USD_USD_SKEL_BAKE_SKINNING_H
...
USDSKEL_API
bool UsdSkelBakeSkinning(const UsdSkelRoot &root,
                         const GfInterval &interval = GfInterval::GetFullInterval());
...
/// saved during skinning: the caller should Save() or Export() the result.
USDSKEL_API
bool UsdSkelBakeSkinning(const UsdPrimRange &range,
                         const GfInterval &interval = GfInterval::GetFullInterval());

WABI_NAMESPACE_END

#endif  // WABI_USD_USD_SKEL_BAKE_SKINNING_H
