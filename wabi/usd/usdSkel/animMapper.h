 ...
 */
#ifndef WABI_USD_USD_SKEL_ANIM_MAPPER_H
#define WABI_USD_USD_SKEL_ANIM_MAPPER_H
...
class UsdSkelAnimMapper
{
 ...
 private:
  ...
  template<typename T>
  bool _UntypedRemap(const VtValue &source,
                     VtValue *target,
                     int elementSize,
...
#endif  // WABI_USD_USD_SKEL_ANIM_MAPPER_H
