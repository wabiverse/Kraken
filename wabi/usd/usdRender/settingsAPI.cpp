...
{
  TfType::Define<UsdRenderSettingsAPI, TfType::Bases<UsdAPISchemaBase>>();
}
...
UsdRenderSettingsAPI UsdRenderSettingsAPI::Get(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdRenderSettingsAPI(stage->GetPrimAtPath(path));
}
...
/*static*/
const TfTokenVector &UsdRenderSettingsAPI::GetSchemaAttributeNames(bool includeInherited)
{
