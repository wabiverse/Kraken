...
struct UsdRenderTokensType {
  ...
  ///
  /// Possible value for UsdRenderSettingsBase::GetAspectRatioConformPolicyAttr(), Default value
  /// for UsdRenderSettingsBase::GetAspectRatioConformPolicyAttr()
  ...
  /// \brief "raster"
  ///
  /// RenderProduct productType value that indicates a 2D raster image of pixels., Default value
  /// for UsdRenderProduct::GetProductTypeAttr()
  const TfToken raster;
  /// \brief "raw"
  ///
  /// Possible value for UsdRenderVar::GetSourceTypeAttr(), Default value for
  /// UsdRenderVar::GetSourceTypeAttr()
  const TfToken raw;
