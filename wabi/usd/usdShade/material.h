...
/// way, Materials can also be
/// [instanced](http://openusd.org/docs/USD-Glossary.html#USDGlossary-Instancing), for ease of
/// deduplication and compactness. Finally, Material encapsulation also allows us to \ref
