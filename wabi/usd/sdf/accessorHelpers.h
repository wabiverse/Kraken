...
//
#ifndef WABI_USD_SDF_ACCESSOR_HELPERS_H
#define WABI_USD_SDF_ACCESSOR_HELPERS_H
...
#define SDF_DEFINE_GET_SET(name_, key_, type_) \
  SDF_DEFINE_TYPED_GET_SET(name_, key_, type_, boost::call_traits<type_>::param_type)

#define SDF_DEFINE_GET_SET_HAS_CLEAR(name_, key_, type_) \
  SDF_DEFINE_TYPED_GET_SET_HAS_CLEAR(name_, key_, type_, boost::call_traits<type_>::param_type)
...
#endif  // #ifndef WABI_USD_SDF_ACCESSOR_HELPERS_H
