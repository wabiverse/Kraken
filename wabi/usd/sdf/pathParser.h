 ...
 */
#ifndef WABI_USD_SDF_PATH_PARSER_H
#define WABI_USD_SDF_PATH_PARSER_H
...
yy_buffer_state *pathYy_scan_bytes(const char *str, size_t len, yyscan_t yyscanner);
...
#endif  // WABI_USD_SDF_PATH_PARSER_H
