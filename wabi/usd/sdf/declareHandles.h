...
//
#ifndef WABI_USD_SDF_DECLARE_HANDLES_H
#define WABI_USD_SDF_DECLARE_HANDLES_H
...
struct Sdf_SpecTypesAreDirectlyRelated
  : std::integral_constant<bool,
                           std::is_base_of<DST, SRC>::value || std::is_base_of<SRC, DST>::value>
{};
...
#endif  // WABI_USD_SDF_DECLARE_HANDLES_H
