...
#ifndef WABI_USD_SDF_PY_SPEC_H
#define WABI_USD_SDF_PY_SPEC_H
...
template<class _SpecType> struct _HandleFromPython {
  ...
  _HandleFromPython()
  {
    bp::converter::registry::insert(&convertible, &construct, bp::type_id<Handle>());
  }
