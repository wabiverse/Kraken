...
//
#ifndef WABI_USD_SDF_PY_LIST_EDITOR_PROXY_H
#define WABI_USD_SDF_PY_LIST_EDITOR_PROXY_H
...
class SdfPyWrapListEditorProxy
{
 ...
 private:
  ...
  {
    return x._listEditor ? boost::lexical_cast<std::string>(*x._listEditor) : std::string();
  }
...
#endif  // WABI_USD_SDF_PY_LIST_EDITOR_PROXY_H
