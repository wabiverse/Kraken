...
//
#ifndef WABI_USD_SDF_PY_CHILDREN_VIEW_H
#define WABI_USD_SDF_PY_CHILDREN_VIEW_H
...
template<class _View> class SdfPyWrapChildrenView
{
 ...
 private:
  ...
  {
    std::string name = "ChildrenView_" + ArchGetDemangled<ChildPolicy>() + "_" +
...
#endif  // WABI_USD_SDF_PY_CHILDREN_VIEW_H
