...
{
  SdfAbstractData_IsEmptyChecker()
    : isEmpty(true)
  {}
...
{
  SdfAbstractData_CopySpecs(SdfAbstractData *dest_)
    : dest(dest_)
  {}
...
bool SdfAbstractData::Equals(const SdfAbstractDataRefPtr &rhs) const
{
  ...
  SdfAbstractData_CheckAllSpecsExist rhsHasAllSpecsInThis(*boost::get_pointer(rhs));
  ...
  SdfAbstractData_CheckAllSpecsMatch thisSpecsMatchRhsSpecs(*boost::get_pointer(rhs));
