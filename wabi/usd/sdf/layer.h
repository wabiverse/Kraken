...
//
#ifndef WABI_USD_SDF_LAYER_H
#define WABI_USD_SDF_LAYER_H
...
class SdfLayer : public TfRefBase, public TfWeakBase
{
 public:
  ...
  SDF_API
  bool UpdateExternalReference(const std::string &oldAssetPath,
 ...
 private:
  ...
  bool _IsInertSubtree(const SdfPath &path, std::vector<SdfPath> *inertSpecs = nullptr);
  ...
  bool _Read(const std::string &identifier, const std::string &resolvedPath, bool metadataOnly);
