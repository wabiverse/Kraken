...
#define _SDF_FIELDS \
  ((SdfFieldKeys->Active, bool))((SdfFieldKeys->AllowedTokens, VtTokenArray))(( \
      ...
      SdfFieldKeys->EndTimeCode, double))((SdfFieldKeys->FramePrecision, int))(( \
      ...
      SdfFieldKeys->Owner, std::string))((SdfFieldKeys->PrimOrder, std::vector<TfToken>))(( \
      SdfFieldKeys->NoLoadHint, bool))((SdfFieldKeys->Payload, SdfPayloadListOp))(( \
      SdfFieldKeys->Permission, SdfPermission))((SdfFieldKeys->Prefix, std::string))(( \
      SdfFieldKeys->PrefixSubstitutions, VtDictionary))((SdfFieldKeys->PropertyOrder, \
                                                         std::vector<TfToken>))(( \
      ...
      SdfFieldKeys->Specifier, SdfSpecifier))((SdfFieldKeys->StartFrame, \
                                               double))((SdfFieldKeys->StartTimeCode, double))(( \
      SdfFieldKeys->SubLayers, std::vector<std::string>))((SdfFieldKeys->SubLayerOffsets, \
      ...
      SdfFieldKeys->VariantSelection, SdfVariantSelectionMap))((SdfFieldKeys->Variability, \
                                                                SdfVariability))(( \
      SdfChildrenKeys->ConnectionChildren, \
      std::vector<SdfPath>))((SdfChildrenKeys->ExpressionChildren, std::vector<TfToken>))(( \
      SdfChildrenKeys->MapperArgChildren, \
      std::vector<TfToken>))((SdfChildrenKeys->MapperChildren, std::vector<SdfPath>))(( \
      SdfChildrenKeys->PrimChildren, std::vector<TfToken>))((SdfChildrenKeys->PropertyChildren, \
                                                             std::vector<TfToken>))(( \
      SdfChildrenKeys->RelationshipTargetChildren, \
      std::vector<SdfPath>))((SdfChildrenKeys->VariantChildren, std::vector<TfToken>))(( \
...
#endif  // WABI_USD_SDF_SCHEMA_TYPE_REGISTRATION_H
