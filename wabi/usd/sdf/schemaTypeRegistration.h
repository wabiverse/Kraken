...
#define _SDF_FIELDS \
  ((SdfFieldKeys->Active, bool))((SdfFieldKeys->AllowedTokens, VtTokenArray))( \
    ...
    SdfFieldKeys->Hidden, bool))((SdfFieldKeys->HasOwnedSubLayers, bool))((SdfFieldKeys->InheritPaths, \
                                                                           SdfPathListOp))(( \
    SdfFieldKeys->Instanceable, bool))((SdfFieldKeys->Kind, TfToken))((SdfFieldKeys->Owner, std::string))(( \
    ...
    SdfFieldKeys->StartFrame, double))((SdfFieldKeys->StartTimeCode, double))((SdfFieldKeys->SubLayers, \
    ...
    SdfChildrenKeys->ConnectionChildren, std::vector<SdfPath>))((SdfChildrenKeys->ExpressionChildren, \
                                                                 std::vector<TfToken>))(( \
    SdfChildrenKeys->MapperArgChildren, \
    std::vector<TfToken>))((SdfChildrenKeys->MapperChildren, \
                            std::vector<SdfPath>))((SdfChildrenKeys->PrimChildren, std::vector<TfToken>))(( \
    SdfChildrenKeys->PropertyChildren, std::vector<TfToken>))((SdfChildrenKeys->RelationshipTargetChildren, \
                                                               std::vector<SdfPath>))(( \
    SdfChildrenKeys->VariantChildren, std::vector<TfToken>))((SdfChildrenKeys->VariantSetChildren, \
                                                              std::vector<TfToken>))
