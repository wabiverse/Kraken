...
//
#ifndef WABI_USD_SDF_LAYER_REGISTRY_H
#define WABI_USD_SDF_LAYER_REGISTRY_H
...
class Sdf_LayerRegistry : boost::noncopyable {
 public:
  ...
  SdfLayerHandle FindByRealPath(const std::string &layerPath,
                                const std::string &resolvedPath = std::string()) const;
...
#endif  // WABI_USD_SDF_LAYER_REGISTRY_H
