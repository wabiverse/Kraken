 ...
 */
#ifndef WABI_USD_SDF_CHILDREN_UTILS_H
#define WABI_USD_SDF_CHILDREN_UTILS_H
...
template<class ChildPolicy> class Sdf_ChildrenUtils {
 public:
  ...
  SDF_API
  static bool RemoveChild(const SdfLayerHandle &layer,
                          const SdfPath &path,
...
#endif  // WABI_USD_SDF_CHILDREN_UTILS_H
