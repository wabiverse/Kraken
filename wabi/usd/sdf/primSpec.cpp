...
TF_REGISTRY_FUNCTION(TfType)
{
  ...
  TfType::Define<SdfVariantSetSpecHandleMap>().Alias(TfType::GetRoot(),
                                    ...
                                    const TfToken &typeName)
{
  ...
  if (!Sdf_ChildrenUtils<Sdf_PrimChildPolicy>::CreateSpec(layer,
                                                          childPath,
                                                          SdfSpecTypePrim,
                                                          inert)) {
    return TfNullPtr;
...
{
  return GetPath().IsRootPrimPath() ? SdfPrimSpecHandle() :
...
bool SdfPrimSpec::RemoveNameChild(const SdfPrimSpecHandle &child)
{
  ...
  return Sdf_ChildrenUtils<Sdf_PrimChildPolicy>::RemoveChild(GetLayer(),
                                                             GetPath(),
                                                             child->GetNameToken());
}
...
bool SdfPrimSpec::InsertProperty(const SdfPropertySpecHandle &property, int index)
{
  ...
  return Sdf_ChildrenUtils<Sdf_PropertyChildPolicy>::InsertChild(GetLayer(),
                                                                 GetPath(),
                                                                 property,
                                                                 index);
}
...
void SdfPrimSpec::RemoveProperty(const SdfPropertySpecHandle &property)
{
  ...
  Sdf_ChildrenUtils<Sdf_PropertyChildPolicy>::RemoveChild(GetLayer(),
                                                          GetPath(),
