...
//
#ifndef WABI_USD_SDF_ASSET_PATH_RESOLVER_H
#define WABI_USD_SDF_ASSET_PATH_RESOLVER_H
...
/// Joins the given \p layerPath and \p arguments into an identifier.
std::string Sdf_CreateIdentifier(const std::string &layerPath,
...
#endif  // WABI_USD_SDF_ASSET_PATH_RESOLVER_H
