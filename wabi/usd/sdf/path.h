...
//
#ifndef WABI_USD_SDF_PATH_H
#define WABI_USD_SDF_PATH_H
...
#if defined(GNU_HAS_SINGLE_INSTRUCTION_BUG)
  /**
   * This generates a single instruction
   * instead of 2 on gcc 6.3.  Seems  to
   * be fixed on gcc 7+ and newer clangs. */
  SdfPath() noexcept
  {
...
#endif /* GNU_HAS_SINGLE_INSTRUCTION_BUG */
