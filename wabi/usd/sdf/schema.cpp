                             ...
                             const _DefaultValueFactoryFn &defFactory)
{
  ...
  for (const PlugPluginPtr &plug : plugins) {
    ...
    for (const std::pair<const std::string, JsValue> &field : fields) {
      ...
      {
        const JsValue pluginDefault = TfMapLookupByValue(fieldInfo,
                                                         _tokens->Default.GetString(),
                                                         JsValue());
      ...
      {
        const JsValue val = TfMapLookupByValue(fieldInfo,
                                               _tokens->AppliesTo.GetString(),
                                               JsValue());
