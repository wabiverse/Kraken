...
class ArDefaultResolver : public ArResolver {
 ...
 protected:
  ...
  AR_API
  virtual ArResolverContext _CreateDefaultContextForAsset(const std::string &assetPath) override;
  ...
  AR_API
  virtual ArResolverContext _CreateContextFromString(const std::string &contextStr) override;

  AR_API
  virtual ArResolverContext _GetCurrentContext() override;

  AR_API
  virtual bool _IsContextDependentPath(const std::string &assetPath) override;
