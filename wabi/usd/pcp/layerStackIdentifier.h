...
//
#ifndef WABI_USD_PCP_LAYER_STACK_IDENTIFIER_H
#define WABI_USD_PCP_LAYER_STACK_IDENTIFIER_H
...
inline size_t hash_value(const PcpLayerStackIdentifierStr &x)
{
  return x.GetHash();
}
...
#endif  // WABI_USD_PCP_LAYER_STACK_IDENTIFIER_H
