...
//
#ifndef WABI_USD_PCP_COMPOSE_SITE_H
#define WABI_USD_PCP_COMPOSE_SITE_H
...
inline void PcpComposeSiteReferences(PcpNodeRef const &node,
                                     ...
                                     PcpSourceArcInfoVector *info)
{
  return PcpComposeSiteReferences(node.GetLayerStack(), node.GetPath(), result, info);
}
...
inline void PcpComposeSitePayloads(PcpNodeRef const &node,
                                   ...
                                   PcpSourceArcInfoVector *info)
{
  return PcpComposeSitePayloads(node.GetLayerStack(), node.GetPath(), result, info);
}
...
#endif  // WABI_USD_PCP_COMPOSE_SITE_H
