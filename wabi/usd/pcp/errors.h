...
typedef std::shared_ptr<PcpErrorInternalAssetPath> PcpErrorInternalAssetPathPtr;
...
typedef std::shared_ptr<PcpErrorInvalidVariantSelection> PcpErrorInvalidVariantSelectionPtr;
