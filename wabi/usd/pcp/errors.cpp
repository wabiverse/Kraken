...
PcpErrorInternalAssetPathPtr PcpErrorInternalAssetPath::New()
{
...
PcpErrorInvalidVariantSelectionPtr PcpErrorInvalidVariantSelection::New()
{
  return PcpErrorInvalidVariantSelectionPtr(new PcpErrorInvalidVariantSelection);
}
