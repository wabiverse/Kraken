...
{
  return layerStackIdentifierStr == rhs.layerStackIdentifierStr && path == rhs.path;
}

bool PcpSiteStr::operator<(const PcpSiteStr &rhs) const
{
  return (layerStackIdentifierStr < rhs.layerStackIdentifierStr) ||
         (layerStackIdentifierStr == rhs.layerStackIdentifierStr && path < rhs.path);
}

size_t PcpSiteStr::Hash::operator()(const PcpSiteStr &site) const
{
  size_t hash = 0;
...
std::ostream &operator<<(std::ostream &s, const PcpSiteStr &x)
{
