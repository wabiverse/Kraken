 ...
 */
#ifndef USDRI_GENERATED_RILIGHTFILTERAPI_H
#define USDRI_GENERATED_RILIGHTFILTERAPI_H

/// \file usdRi/riLightFilterAPI.h
...
class UsdRiRiLightFilterAPI : public UsdSchemaBase {
 public:
  ...
  /// Construct a UsdRiRiLightFilterAPI on UsdPrim \p prim .
  ...
  /// Return a UsdRiRiLightFilterAPI holding the prim adhering to this
  /// schema at \p path on \p stage.  If no prim exists at \p path on
  /// \p stage, or if the prim at that path does not adhere to this schema,
  /// return an invalid schema object.  This is shorthand for the following:
  ///
  /// \code
  /// UsdRiRiLightFilterAPI(stage->GetPrimAtPath(path));
  /// \endcode
  ///
  USDRI_API
