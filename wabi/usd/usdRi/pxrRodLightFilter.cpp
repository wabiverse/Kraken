 ...
 */
#include "wabi/usd/usdRi/pxrRodLightFilter.h"
...
{
  TfType::Define<UsdRiPxrRodLightFilter, TfType::Bases<UsdLuxLightFilter>>();

  // Register the usd prim typename as an alias under UsdSchemaBase. This
  // enables one to call
  // TfType::Find<UsdSchemaBase>().FindDerivedByName("wabiRodLightFilter")
  // to find TfType<UsdRiPxrRodLightFilter>, which is how IsA queries are
  // answered.
  TfType::AddAlias<UsdSchemaBase, UsdRiPxrRodLightFilter>("wabiRodLightFilter");
}
                                                      ...
                                                      const SdfPath &path)
{
  ...
  return UsdRiPxrRodLightFilter(stage->DefinePrim(path, usdPrimTypeName));
}
...
UsdAttribute UsdRiPxrRodLightFilter::GetHeightAttr() const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetDepthAttr() const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRadiusAttr() const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeThicknessAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeThickness);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeThicknessAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetScaleWidthAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->scaleWidth);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateScaleWidthAttr(VtValue const &defaultValue,
                                                          bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetScaleHeightAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->scaleHeight);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateScaleHeightAttr(VtValue const &defaultValue,
                                                           bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetScaleDepthAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->scaleDepth);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateScaleDepthAttr(VtValue const &defaultValue,
                                                          bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRefineTopAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->refineTop);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateRefineTopAttr(VtValue const &defaultValue,
                                                         bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRefineBottomAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->refineBottom);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateRefineBottomAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRefineLeftAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->refineLeft);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateRefineLeftAttr(VtValue const &defaultValue,
                                                          bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRefineRightAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->refineRight);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateRefineRightAttr(VtValue const &defaultValue,
                                                           bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRefineFrontAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->refineFront);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateRefineFrontAttr(VtValue const &defaultValue,
                                                           bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetRefineBackAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->refineBack);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateRefineBackAttr(VtValue const &defaultValue,
                                                          bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeScaleTopAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeScaleTop);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeScaleTopAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeScaleBottomAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeScaleBottom);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeScaleBottomAttr(VtValue const &defaultValue,
                                                               bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeScaleLeftAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeScaleLeft);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeScaleLeftAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeScaleRightAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeScaleRight);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeScaleRightAttr(VtValue const &defaultValue,
                                                              bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeScaleFrontAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeScaleFront);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeScaleFrontAttr(VtValue const &defaultValue,
                                                              bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetEdgeScaleBackAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->edgeScaleBack);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateEdgeScaleBackAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetColorSaturationAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->colorSaturation);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateColorSaturationAttr(VtValue const &defaultValue,
                                                               bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetFalloffAttr() const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetFalloffKnotsAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->falloffKnots);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateFalloffKnotsAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetFalloffFloatsAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->falloffFloats);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateFalloffFloatsAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetFalloffInterpolationAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->falloffInterpolation);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateFalloffInterpolationAttr(VtValue const &defaultValue,
                                                                    bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetColorRampAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->colorRamp);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateColorRampAttr(VtValue const &defaultValue,
                                                         bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetColorRampKnotsAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->colorRampKnots);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateColorRampKnotsAttr(VtValue const &defaultValue,
                                                              bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetColorRampColorsAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->colorRampColors);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateColorRampColorsAttr(VtValue const &defaultValue,
                                                               bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrRodLightFilter::GetColorRampInterpolationAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->colorRampInterpolation);
}

UsdAttribute UsdRiPxrRodLightFilter::CreateColorRampInterpolationAttr(VtValue const &defaultValue,
                                                                      bool writeSparsely) const
{
...
UsdRiSplineAPI UsdRiPxrRodLightFilter::GetFalloffRampAPI() const
{
...
UsdRiSplineAPI UsdRiPxrRodLightFilter::GetColorRampAPI() const
{
  return UsdRiSplineAPI(*this,
                        _tokens->colorRamp,
                        SdfValueTypeNames->Color3fArray,
