 ...
 */
#include "wabi/usd/usdRi/risPattern.h"
...
{
  TfType::Define<UsdRiRisPattern, TfType::Bases<UsdRiRisObject>>();
...
UsdRiRisPattern UsdRiRisPattern::Define(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdRiRisPattern(stage->DefinePrim(path, usdPrimTypeName));
}

/* virtual */
UsdSchemaKind UsdRiRisPattern::_GetSchemaKind() const
{
  return UsdRiRisPattern::schemaKind;
}

/* virtual */
UsdSchemaKind UsdRiRisPattern::_GetSchemaType() const
{
  return UsdRiRisPattern::schemaType;
}

/* static */
const TfType &UsdRiRisPattern::_GetStaticTfType()
{
...
/* static */
bool UsdRiRisPattern::_IsTypedSchema()
{
...
/* virtual */
const TfType &UsdRiRisPattern::_GetTfType() const
{
  return _GetStaticTfType();
}

/*static*/
const TfTokenVector &UsdRiRisPattern::GetSchemaAttributeNames(bool includeInherited)
{
