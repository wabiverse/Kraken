...
class UsdRiPxrRodLightFilter : public UsdLuxLightFilter {
 public:
  ...
  /// an invalid \p prim
  explicit UsdRiPxrRodLightFilter(const UsdPrim &prim = UsdPrim()) : UsdLuxLightFilter(prim)
  {}
  ...
  explicit UsdRiPxrRodLightFilter(const UsdSchemaBase &schemaObj) : UsdLuxLightFilter(schemaObj)
  {}
  ...
  ///
  USDRI_API
  static UsdRiPxrRodLightFilter Get(const UsdStagePtr &stage, const SdfPath &path);
  ...
  ///
  USDRI_API
  static UsdRiPxrRodLightFilter Define(const UsdStagePtr &stage, const SdfPath &path);
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateDepthAttr(VtValue const &defaultValue = VtValue(),
                               bool writeSparsely          = false) const;
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateScaleDepthAttr(VtValue const &defaultValue = VtValue(),
                                    bool writeSparsely          = false) const;
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateRefineFrontAttr(VtValue const &defaultValue = VtValue(),
                                     bool writeSparsely          = false) const;
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateRefineBackAttr(VtValue const &defaultValue = VtValue(),
                                    bool writeSparsely          = false) const;
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateEdgeScaleFrontAttr(VtValue const &defaultValue = VtValue(),
                                        bool writeSparsely          = false) const;
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateEdgeScaleBackAttr(VtValue const &defaultValue = VtValue(),
                                       bool writeSparsely          = false) const;
