...
{
  TfType::Define<UsdRiRiLightFilterAPI, TfType::Bases<UsdSchemaBase>>();
}
...
/* virtual */
const TfType &UsdRiRiLightFilterAPI::GetTfType() const
{
...
UsdAttribute UsdRiRiLightFilterAPI::CreateRiCombineModeAttr(VtValue const &defaultValue,
...
UsdAttribute UsdRiRiLightFilterAPI::GetRiDensityAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->riDensity);
}

UsdAttribute UsdRiRiLightFilterAPI::CreateRiDensityAttr(VtValue const &defaultValue,
                                                        bool writeSparsely) const
{
...
UsdAttribute UsdRiRiLightFilterAPI::GetRiInvertAttr() const
{
...
UsdAttribute UsdRiRiLightFilterAPI::GetRiIntensityAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->riIntensity);
}

UsdAttribute UsdRiRiLightFilterAPI::CreateRiIntensityAttr(VtValue const &defaultValue,
                                                          bool writeSparsely) const
{
...
UsdAttribute UsdRiRiLightFilterAPI::GetRiDiffuseAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->riDiffuse);
}

UsdAttribute UsdRiRiLightFilterAPI::CreateRiDiffuseAttr(VtValue const &defaultValue,
                                                        bool writeSparsely) const
{
...
UsdAttribute UsdRiRiLightFilterAPI::GetRiSpecularAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->riSpecular);
}

UsdAttribute UsdRiRiLightFilterAPI::CreateRiSpecularAttr(VtValue const &defaultValue,
                                                         bool writeSparsely) const
{
