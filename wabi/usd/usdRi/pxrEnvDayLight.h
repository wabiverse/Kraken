...
class UsdRiPxrEnvDayLight : public UsdLuxLight
{
 public:
  ...
  ///
  USDRI_API
  static UsdRiPxrEnvDayLight Get(const UsdStagePtr &stage, const SdfPath &path);
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateLongitudeAttr(VtValue const &defaultValue = VtValue(),
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDRI_API
  UsdAttribute CreateSunDirectionAttr(VtValue const &defaultValue = VtValue(),
                                      bool writeSparsely = false) const;
