 ...
 */
#include "wabi/usd/usdRi/pxrIntMultLightFilter.h"
...
{
  TfType::Define<UsdRiPxrIntMultLightFilter, TfType::Bases<UsdLuxLightFilter>>();

  // Register the usd prim typename as an alias under UsdSchemaBase. This
  // enables one to call
  // TfType::Find<UsdSchemaBase>().FindDerivedByName("wabiIntMultLightFilter")
  // to find TfType<UsdRiPxrIntMultLightFilter>, which is how IsA queries are
  // answered.
  TfType::AddAlias<UsdSchemaBase, UsdRiPxrIntMultLightFilter>("wabiIntMultLightFilter");
}
                                                              ...
                                                              const SdfPath &path)
{
  ...
  return UsdRiPxrIntMultLightFilter(stage->DefinePrim(path, usdPrimTypeName));
}
...
/* virtual */
UsdSchemaKind UsdRiPxrIntMultLightFilter::_GetSchemaType() const
{
...
UsdAttribute UsdRiPxrIntMultLightFilter::CreateRiIntensityAttr(VtValue const &defaultValue,
...
UsdAttribute UsdRiPxrIntMultLightFilter::GetColorSaturationAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->colorSaturation);
}

UsdAttribute UsdRiPxrIntMultLightFilter::CreateColorSaturationAttr(VtValue const &defaultValue,
                                                                   bool writeSparsely) const
{
