 ...
 */
#include "wabi/usd/usdRi/lightPortalAPI.h"
...
{
  TfType::Define<UsdRiLightPortalAPI, TfType::Bases<UsdAPISchemaBase>>();
}

TF_DEFINE_PRIVATE_TOKENS(_schemaTokens, (RiLightPortalAPI));
...
/* static */
UsdRiLightPortalAPI UsdRiLightPortalAPI::Get(const UsdStagePtr &stage, const SdfPath &path)
{
  if (!stage)
  {
...
/* static */
UsdRiLightPortalAPI UsdRiLightPortalAPI::Apply(const UsdPrim &prim)
{
...
/* virtual */
const TfType &UsdRiLightPortalAPI::GetTfType() const
{
...
UsdAttribute UsdRiLightPortalAPI::CreateRiPortalIntensityAttr(VtValue const &defaultValue,
...
UsdAttribute UsdRiLightPortalAPI::GetRiPortalTintAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->riPortalTint);
}

UsdAttribute UsdRiLightPortalAPI::CreateRiPortalTintAttr(VtValue const &defaultValue,
                                                         bool writeSparsely) const
{
...
/*static*/
const TfTokenVector &UsdRiLightPortalAPI::GetSchemaAttributeNames(bool includeInherited)
{
