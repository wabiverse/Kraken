...
{
  TfType::Define<UsdRiRisIntegrator, TfType::Bases<UsdTyped>>();
...
UsdRiRisIntegrator UsdRiRisIntegrator::Define(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdRiRisIntegrator(stage->DefinePrim(path, usdPrimTypeName));
}

/* virtual */
UsdSchemaKind UsdRiRisIntegrator::GetSchemaKind() const
{
  return UsdRiRisIntegrator::schemaKind;
}

/* static */
const TfType &UsdRiRisIntegrator::GetStaticTfType()
{
...
/* static */
bool UsdRiRisIntegrator::IsTypedSchema()
{
...
/* virtual */
const TfType &UsdRiRisIntegrator::GetTfType() const
{
  return GetStaticTfType();
}

UsdAttribute UsdRiRisIntegrator::GetFilePathAttr() const
{
...
UsdAttribute UsdRiRisIntegrator::GetArgsPathAttr() const
{
