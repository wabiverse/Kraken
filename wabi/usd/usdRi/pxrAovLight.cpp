...
{
  TfType::Define<UsdRiPxrAovLight, TfType::Bases<UsdLuxLight>>();

  // Register the usd prim typename as an alias under UsdSchemaBase. This
  // enables one to call
  // TfType::Find<UsdSchemaBase>().FindDerivedByName("wabiAovLight")
  // to find TfType<UsdRiPxrAovLight>, which is how IsA queries are
  // answered.
  TfType::AddAlias<UsdSchemaBase, UsdRiPxrAovLight>("wabiAovLight");
}
...
UsdRiPxrAovLight UsdRiPxrAovLight::Define(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdRiPxrAovLight(stage->DefinePrim(path, usdPrimTypeName));
}
...
UsdAttribute UsdRiPxrAovLight::GetInPrimaryHitAttr() const
{
...
UsdAttribute UsdRiPxrAovLight::GetInReflectionAttr() const
{
...
UsdAttribute UsdRiPxrAovLight::GetInRefractionAttr() const
{
...
UsdAttribute UsdRiPxrAovLight::GetInvertAttr() const
{
...
UsdAttribute UsdRiPxrAovLight::GetOnVolumeBoundariesAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->onVolumeBoundaries);
}

UsdAttribute UsdRiPxrAovLight::CreateOnVolumeBoundariesAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrAovLight::GetUseColorAttr() const
{
...
UsdAttribute UsdRiPxrAovLight::GetUseThroughputAttr() const
{
