...
struct UsdRiTokensType {
  ...
  /// \brief "analytic"
  ///
  /// Possible value for UsdRiPxrCookieLightFilter::GetCookieModeAttr(), Possible value for
  /// UsdRiPxrBarnLightFilter::GetBarnModeAttr()
  ...
  /// \brief "bspline"
  ///
  /// UsdSplineAPI - BSpline spline interpolation, Possible value for
  /// UsdRiPxrRodLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRodLightFilter::GetFalloffInterpolationAttr(), Default value for
  /// UsdRiPxrRodLightFilter::GetFalloffInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetFalloffInterpolationAttr()
  ...
  /// \brief "catmull-rom"
  ///
  /// Possible value for UsdRiPxrRodLightFilter::GetColorRampInterpolationAttr(), Possible value
  /// for UsdRiPxrRodLightFilter::GetFalloffInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetFalloffInterpolationAttr()
  ...
  /// \brief "constant"
  ///
  /// UsdSplineAPI - Constant-value spline interpolation, Possible value for
  /// UsdRiPxrRodLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRodLightFilter::GetFalloffInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetFalloffInterpolationAttr()
  ...
  ///
  /// Possible value for UsdRiPxrRampLightFilter::GetRampModeAttr(), Default value for
  /// UsdRiPxrRampLightFilter::GetRampModeAttr()
  ...
  /// \brief "linear"
  ///
  /// UsdSplineAPI - Linear spline interpolation, Possible value for
  /// UsdRiPxrRodLightFilter::GetColorRampInterpolationAttr(), Default value for
  /// UsdRiPxrRodLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRodLightFilter::GetFalloffInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetColorRampInterpolationAttr(), Default value for
  /// UsdRiPxrRampLightFilter::GetColorRampInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetFalloffInterpolationAttr(), Default value for
  /// UsdRiPxrRampLightFilter::GetFalloffInterpolationAttr(), Possible value for
  /// UsdRiPxrRampLightFilter::GetRampModeAttr()
  ...
  /// \brief "multiply"
  ///
  /// Possible value for UsdRiLightFilterAPI::GetRiCombineModeAttr(), Default value for
  /// UsdRiLightFilterAPI::GetRiCombineModeAttr()
  ...
  /// \brief "noLight"
  ///
  /// Possible value for UsdRiPxrBarnLightFilter::GetPreBarnEffectAttr(), Default value for
  /// UsdRiPxrBarnLightFilter::GetPreBarnEffectAttr()
  const TfToken noLight;
  /// \brief "off"
  ///
  /// Possible value for UsdRiPxrCookieLightFilter::GetTextureWrapModeAttr(), Default value for
  /// UsdRiPxrCookieLightFilter::GetTextureWrapModeAttr()
  const TfToken off;
  ...
  /// \brief "physical"
  ///
  /// Possible value for UsdRiPxrCookieLightFilter::GetCookieModeAttr(), Default value for
  /// UsdRiPxrCookieLightFilter::GetCookieModeAttr(), Possible value for
  /// UsdRiPxrBarnLightFilter::GetBarnModeAttr(), Default value for
  /// UsdRiPxrBarnLightFilter::GetBarnModeAttr()
