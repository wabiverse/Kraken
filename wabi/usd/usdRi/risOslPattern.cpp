 ...
 */
#include "wabi/usd/usdRi/risOslPattern.h"
...
{
  TfType::Define<UsdRiRisOslPattern, TfType::Bases<UsdRiRisPattern>>();
...
UsdRiRisOslPattern UsdRiRisOslPattern::Define(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdRiRisOslPattern(stage->DefinePrim(path, usdPrimTypeName));
}
...
/* virtual */
const TfType &UsdRiRisOslPattern::GetTfType() const
{
...
UsdAttribute UsdRiRisOslPattern::GetOslPathAttr() const
{
