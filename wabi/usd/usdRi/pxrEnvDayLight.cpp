...
{
  TfType::Define<UsdRiPxrEnvDayLight, TfType::Bases<UsdLuxLight>>();

  // Register the usd prim typename as an alias under UsdSchemaBase. This
  // enables one to call
  // TfType::Find<UsdSchemaBase>().FindDerivedByName("wabiEnvDayLight")
  // to find TfType<UsdRiPxrEnvDayLight>, which is how IsA queries are
  // answered.
  TfType::AddAlias<UsdSchemaBase, UsdRiPxrEnvDayLight>("wabiEnvDayLight");
}
...
UsdRiPxrEnvDayLight UsdRiPxrEnvDayLight::Define(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdRiPxrEnvDayLight(stage->DefinePrim(path, usdPrimTypeName));
}
...
UsdAttribute UsdRiPxrEnvDayLight::GetHazinessAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetHourAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetLatitudeAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetLongitudeAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetMonthAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetSkyTintAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetSunDirectionAttr() const
{
  return GetPrim().GetAttribute(UsdRiTokens->sunDirection);
}

UsdAttribute UsdRiPxrEnvDayLight::CreateSunDirectionAttr(VtValue const &defaultValue,
                                                         bool writeSparsely) const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetSunSizeAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetSunTintAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetYearAttr() const
{
...
UsdAttribute UsdRiPxrEnvDayLight::GetZoneAttr() const
{
