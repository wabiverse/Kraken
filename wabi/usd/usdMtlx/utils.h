...
#ifndef WABI_USD_USDMTLX_UTILS_H
#define WABI_USD_USDMTLX_UTILS_H

#include "wabi/wabi.h"
#include "wabi/usd/usdMtlx/api.h"
...
/// the environment variable 'WABI_MTLX_PLUGIN_SEARCH_PATHS'
USDMTLX_API
...
///   'WABI_MTLX_PLUGIN_SEARCH_PATHS'
/// - standard library paths set in the env var 'WABI_MTLX_STDLIB_SEARCH_PATHS'
...
#endif  // WABI_USD_USDMTLX_UTILS_H
