...
//
#ifndef WABI_USD_PLUGIN_USD_ABC_ALEMBIC_UTIL_H
#define WABI_USD_PLUGIN_USD_ABC_ALEMBIC_UTIL_H
   ...
   private:
    ...
    class _HolderValue
    {
     public:
      ...
      bool IsError(std::string *msg) const
      {
        return _holder->Error(msg);
      }
...
#endif  // WABI_USD_PLUGIN_USD_ABC_ALEMBIC_UTIL_H
