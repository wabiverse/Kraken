...
namespace
{
  ...
  class _ReaderSchema
  {
   public:
    ...
    {
     public:
      TypeRef(PrimReaderVector *readers)
        : _readerVector(readers)
      {}
  ...
  class _ReaderContext
  {
   ...
   private:
    ...
    {
     public:
      _Lock(std::recursive_mutex *mutex)
        : _mutex(mutex)
      {
        if (_mutex)
          _mutex->lock();
                                        ...
                                        std::set<std::string> *usedNames)
  {
    ...
    for (const auto &value : instances)
    {
      ...
      const SdfPath prototypePath = SdfPath::AbsoluteRootPath().AppendChild(TfToken(
        _CleanName(prototypeName, " _", *usedNames, _AlembicFixName(), &SdfPath::IsValidIdentifier)));
  ...
  {
    IXform object;
    _CopyXform(const IXform &object_)
      : object(object_)
    {}
  ...
  struct _CopyCameraBase
  {
    ...
    _CopyCameraBase(const ICamera &object_)
      : object(object_)
    {}
  ...
  struct _CopyFaceSetBase
  {
    ...
    _CopyFaceSetBase(const IFaceSet &object_)
      : object(object_)
    {}
