...
#ifndef WABI_USD_PLUGIN_USD_DRACO_IMPORT_TRANSLATOR_H
#define WABI_USD_PLUGIN_USD_DRACO_IMPORT_TRANSLATOR_H
...
#endif  // WABI_USD_PLUGIN_USD_DRACO_IMPORT_TRANSLATOR_H
