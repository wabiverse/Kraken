...
#ifndef WABI_USD_PLUGIN_USD_DRACO_EXPORT_ATTRIBUTE_H
#define WABI_USD_PLUGIN_USD_DRACO_EXPORT_ATTRIBUTE_H
...
#endif  // WABI_USD_PLUGIN_USD_DRACO_EXPORT_ATTRIBUTE_H
