...
#ifndef WABI_USD_PLUGIN_USD_MTLX_UTILS_H
#define WABI_USD_PLUGIN_USD_MTLX_UTILS_H

#include "wabi/base/tf/staticTokens.h"
#include "wabi/base/vt/value.h"
#include "wabi/usd/ndr/declare.h"
#include "wabi/usd/plugin/usdMtlx/api.h"
...
USDMTLX_LOCAL
NdrStringVec UsdMtlxGetSearchPathsFromEnvVar(const char *name);

/// Combines two search path lists.
USDMTLX_LOCAL
NdrStringVec UsdMtlxMergeSearchPaths(const NdrStringVec &stronger, const NdrStringVec &weaker);
...
#endif  // WABI_USD_PLUGIN_USD_MTLX_UTILS_H
