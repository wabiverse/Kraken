...
inline GfMatrix4d _ConvertMatrix(const AtMatrix &mat)
{
  ...
  const static std::unordered_map<uint8_t, ArrayConversion> ret{
      ...
      {AI_TYPE_UINT,
       {SdfValueTypeNames->UIntArray,
        [](const AtArray *a) -> VtValue {
          return _ExportArray<uint32_t>(a, AiArrayGetUIntFunc);
        }}},
      {AI_TYPE_BOOLEAN,
      ...
      {AI_TYPE_RGB,
       {SdfValueTypeNames->Color3fArray,
        [](const AtArray *a) -> VtValue {
          return _ExportArray<GfVec3f, AtRGB>(a, AiArrayGetRGBFunc);
        }}},
      {AI_TYPE_RGBA,
       {SdfValueTypeNames->Color4fArray,
        [](const AtArray *a) -> VtValue {
          return _ExportArray<GfVec4f, AtRGBA>(a, AiArrayGetRGBAFunc);
        }}},
      {AI_TYPE_VECTOR,
       {SdfValueTypeNames->Vector3fArray,
        [](const AtArray *a) -> VtValue {
          return _ExportArray<GfVec3f, AtVector>(a, AiArrayGetVecFunc);
        }}},
      {AI_TYPE_VECTOR2,
       {SdfValueTypeNames->Float2Array,
        [](const AtArray *a) -> VtValue {
          return _ExportArray<GfVec2f, AtVector2>(a, AiArrayGetVec2Func);
        }}},
      {AI_TYPE_STRING,
       {SdfValueTypeNames->StringArray,
        [](const AtArray *a) -> VtValue {
          return _ExportArray<std::string, AtString>(a, AiArrayGetStrFunc);
        }}},
  ...
  while (!AiParamIteratorFinished(paramIter)) {
    ...
    if (paramType == AI_TYPE_ARRAY) {
      ...
      auto attr = prim.CreateAttribute(
          TfToken(AiParamGetName(pentry).c_str()), conversion->type, false);
