 ...
 */
#ifndef WABI_USD_USD_UTILS_COALESCING_DIAGNOSTIC_DELEGATE_H
#define WABI_USD_USD_UTILS_COALESCING_DIAGNOSTIC_DELEGATE_H
...
#endif  // WABI_USD_USD_UTILS_COALESCING_DIAGNOSTIC_DELEGATE_H
