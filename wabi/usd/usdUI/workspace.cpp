...
/* virtual */
UsdSchemaKind UsdUIWorkspace::GetSchemaKind() const
{
  return UsdUIWorkspace::schemaKind;
}

/* static */
const TfType &UsdUIWorkspace::GetStaticTfType()
{
...
/* static */
bool UsdUIWorkspace::IsTypedSchema()
{
...
/* virtual */
const TfType &UsdUIWorkspace::GetTfType() const
{
