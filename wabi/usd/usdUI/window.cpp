...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowTitle,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowIcon,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowType,
                                    SdfValueTypeNames->Token,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowState,
                                    SdfValueTypeNames->Token,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowDpi,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowScale,
                                    SdfValueTypeNames->Float,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowPixelsz,
                                    SdfValueTypeNames->Float,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
UsdAttribute UsdUIWindow::CreateWidgetunitAttr(VtValue const &defaultValue,
                                               bool writeSparsely) const
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowWidgetunit,
                                    SdfValueTypeNames->Float,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
UsdAttribute UsdUIWindow::CreateLinewidthAttr(VtValue const &defaultValue,
                                              bool writeSparsely) const
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowLinewidth,
                                    SdfValueTypeNames->Float,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowCursor,
                                    SdfValueTypeNames->Token,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
UsdAttribute UsdUIWindow::CreateAlignmentAttr(VtValue const &defaultValue,
                                              bool writeSparsely) const
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowAlignment,
                                    SdfValueTypeNames->Token,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowPos,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiWindowSize,
                                    SdfValueTypeNames->Float2,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return GetPrim().GetRelationship(UsdUITokens->uiWindowWorkspace);
}

UsdRelationship UsdUIWindow::CreateUiWindowWorkspaceRel() const
{
  return GetPrim().CreateRelationship(UsdUITokens->uiWindowWorkspace,
                                      /* custom = */ false);
}
