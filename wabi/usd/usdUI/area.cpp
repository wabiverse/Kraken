...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiAreaName,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiAreaSpacetype,
                                    SdfValueTypeNames->Token,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiAreaIcon,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiAreaPos,
...
{
  return UsdSchemaBase::_CreateAttr(UsdUITokens->uiAreaSize,
                                    SdfValueTypeNames->Float2,
                                    /* custom = */ false,
                                    SdfVariabilityUniform,
                                    defaultValue,
