...
void wrapUsdUITokens()
{
  boost::python::class_ < UsdUITokensType, boost::noncopyable >
    cls("Tokens", boost::python::no_init);
      ...
      _AddToken(cls, "spaceClip", UsdUITokens->spaceClip);
      _AddToken(cls, "spaceConsole", UsdUITokens->spaceConsole);
      _AddToken(cls, "spaceEmpty", UsdUITokens->spaceEmpty);
      _AddToken(cls, "spaceFile", UsdUITokens->spaceFile);
      _AddToken(cls, "spaceGraph", UsdUITokens->spaceGraph);
      _AddToken(cls, "spaceImage", UsdUITokens->spaceImage);
      _AddToken(cls, "spaceInfo", UsdUITokens->spaceInfo);
      _AddToken(cls, "spaceNode", UsdUITokens->spaceNode);
      _AddToken(cls, "spaceOutliner", UsdUITokens->spaceOutliner);
      _AddToken(cls, "spacePref", UsdUITokens->spacePref);
      _AddToken(cls, "spaceProperties", UsdUITokens->spaceProperties);
      _AddToken(cls, "spaceSequence", UsdUITokens->spaceSequence);
      _AddToken(cls, "spaceSpreadsheet", UsdUITokens->spaceSpreadsheet);
      _AddToken(cls, "spaceStatusbar", UsdUITokens->spaceStatusbar);
      _AddToken(cls, "spaceText", UsdUITokens->spaceText);
      _AddToken(cls, "spaceTopbar", UsdUITokens->spaceTopbar);
      _AddToken(cls, "spaceView3D", UsdUITokens->spaceView3D);
