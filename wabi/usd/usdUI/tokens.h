...
struct UsdUITokensType
{
  ...
  /// \brief "alignAbsolute"
  ///
  /// Possible value for UsdUIWindow::GetAlignmentAttr(), Default value for
  /// UsdUIWindow::GetAlignmentAttr()
  ...
  /// \brief "areas"
  ///
  ///  This token represents the collection name to use with UsdCollectionAPI to represent groups
  ///  of UI layout areas of a UsdUIScreen prim.
  const TfToken areas;
  /// \brief "bottom"
  ///
  ...
  /// \brief "default"
  ///
  /// Possible value for UsdUIWindow::GetCursorAttr(), Default value for
  /// UsdUIWindow::GetCursorAttr()
  ...
  /// \brief "minimized"
  ///
  /// Possible value for UsdUINodeGraphNodeAPI::GetExpansionStateAttr(), Possible value for
  /// UsdUIWindow::GetStateAttr()
  const TfToken minimized;
  /// \brief "none"
  ///
  /// Possible value for UsdUIScreen::GetAlignmentAttr(), Default value for
  /// UsdUIScreen::GetAlignmentAttr()
  const TfToken none;
  /// \brief "normal"
  ///
  /// Possible value for UsdUIWindow::GetStateAttr(), Default value for
  /// UsdUIWindow::GetStateAttr(), Possible value for UsdUIWindow::GetTypeAttr(), Default value for
  /// UsdUIWindow::GetTypeAttr()
  ...
  /// \brief "SpaceEmpty"
  ///
  /// Possible value for UsdUIArea::GetSpacetypeAttr(), Default value for
  /// UsdUIArea::GetSpacetypeAttr()
