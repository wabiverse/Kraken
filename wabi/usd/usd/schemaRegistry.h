...
class UsdSchemaRegistry : public TfWeakBase, boost::noncopyable {
 public:
  ...
  USD_API
  static std::pair<TfToken, TfToken> GetTypeAndInstance(const TfToken &apiSchemaName);
 ...
 private:
  ...
  typedef TfHashMap<TfToken, UsdPrimDefinition *, TfToken::HashFunctor>
      _TypeNameToPrimDefinitionMap;
