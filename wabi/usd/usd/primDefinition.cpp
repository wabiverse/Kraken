...
UsdPrimDefinition::UsdPrimDefinition(const SdfPrimSpecHandle &primSpec, bool isAPISchema)
{
...
void UsdPrimDefinition::_SetPrimSpec(const SdfPrimSpecHandle &primSpec, bool providesPrimMetadata)
{
  _primSpec = primSpec;
