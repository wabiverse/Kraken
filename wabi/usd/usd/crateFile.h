...
namespace Usd_CrateFile
{
  ...
  struct ValueRep
  {
    ...
    {
      return data & _IsInlinedBit;
    }
    inline void SetIsInlined()
    {
      data |= _IsInlinedBit;
    }
    ...
    {
      return data & _IsCompressedBit;
    }
    inline void SetIsCompressed()
    {
      data |= _IsCompressedBit;
    }
  ...
  struct TimeSamples
  {
    ...
    friend inline void swap(TimeSamples &l, TimeSamples &r)
    {
      l.swap(r);
    }
  };
   ...
   private:
    ...
    struct _FileMapping
    {
     ...
     private:
      ...
      friend inline void intrusive_ptr_add_ref(_FileMapping const *m)
      {
...
#undef LOGIC_OP
    ...
    struct Spec
    {
      ...
      {
        return pathIndex == other.pathIndex && fieldSetIndex == other.fieldSetIndex &&
    ...
    inline vector<Field> const &GetFields() const
    {
      return _fields;
    }

    inline vector<FieldIndex> const &GetFieldSets() const
    {
      return _fieldSets;
    }
    ...
    inline vector<SdfPath> const &GetPaths() const
    {
      return _paths;
    }

    inline vector<Spec> const &GetSpecs() const
    {
      return _specs;
    }
    ...
    inline vector<TfToken> const &GetTokens() const
    {
      return _tokens;
    }
    ...
    inline vector<TokenIndex> const &GetStrings() const
    {
      return _strings;
    }
   ...
   private:
    ...
    static _FileMappingIPtr _MmapAsset(char const *fileName, ArAssetSharedPtr const &asset);
    ...
    void _AddSpec(const SdfPath &path,
                  SdfSpecType type,
                  const std::vector<FieldValuePair> &fields);
...
#endif  // WABI_USD_USD_CRATE_FILE_H
