...
/// which you are authoring.  If your edits are targeted to a different layer,
/// across various composition arcs (because you specified a non-default \ref
/// UsdEditTarget), the target's path will be automatically translated
...
#endif  // WABI_USD_USD_RELATIONSHIP_H
