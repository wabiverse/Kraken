...
//
#ifndef WABI_USD_USD_STAGE_H
#define WABI_USD_USD_STAGE_H
...
class UsdStage : public TfRefBase, public TfWeakBase
{
 ...
 public:
  ...
  /// \ref Usd_ColorConfigurationAPI "Color Configuration API"
  USD_API
  static void SetColorConfigFallbacks(const SdfAssetPath &colorConfiguration,
 ...
 private:
  ...
  SdfPropertySpecHandle _GetSchemaPropertySpec(const UsdPrim &prim, const TfToken &propName) const;
  ...
  SdfRelationshipSpecHandle _GetSchemaRelationshipSpec(const UsdRelationship &rel) const;
...
typename std::enable_if<!UsdStage::_IsEditTargetMappable<T>::value, bool>::type UsdStage::
  _SetMetadata(const UsdObject &object, const TfToken &key, const TfToken &keyPath, const T &value)
{
