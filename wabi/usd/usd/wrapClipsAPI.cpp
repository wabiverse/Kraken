  ...
  _class.def("GetClips", _GetClips)
      ...
      .def("GetClipAssetPaths",
           (VtArray<SdfAssetPath>(*)(const UsdClipsAPI &,
                                     const std::string &))(&_GetClipAssetPaths),
           return_value_policy<TfPySequenceToList>(),
           arg("clipSet"))
      ...
      .def("SetClipPrimPath",
           (bool (UsdClipsAPI::*)(const std::string &,
                                  const std::string &))(&UsdClipsAPI::SetClipPrimPath),
      ...
      .def("GetClipActive",
           ...
           arg("clipSet"))
      .def("SetClipActive",
           (void (*)(UsdClipsAPI &, TfPyObjWrapper))(&_SetClipActive),
           arg("activeClips"))
      .def("SetClipActive",
      ...
      .def("GetClipTimes",
           ...
           arg("clipSet"))
      .def("SetClipTimes",
           (void (*)(UsdClipsAPI &, TfPyObjWrapper))(&_SetClipTimes),
           arg("clipTimes"))
      .def("SetClipTimes",
      ...
      .def("GetClipManifestAssetPath",
           (SdfAssetPath(*)(const UsdClipsAPI &))(&_GetClipManifestAssetPath))
      .def("GetClipManifestAssetPath",
      ...
      .def("SetInterpolateMissingClipValues",
           (bool (UsdClipsAPI::*)(
               bool, const std::string &))(&UsdClipsAPI::SetInterpolateMissingClipValues),
           (arg("interpolate"), arg("clipSet")))

      .def("GetClipTemplateAssetPath",
           (std::string(*)(const UsdClipsAPI &))(&_GetClipTemplateAssetPath))
      .def("GetClipTemplateAssetPath",
      ...
      .def("SetClipTemplateAssetPath",
           (void (*)(
               UsdClipsAPI &, TfPyObjWrapper, const std::string &))(&_SetClipTemplateAssetPath),
      ...
      .def("SetClipTemplateStride",
           (bool (UsdClipsAPI::*)(double,
                                  const std::string &))(&UsdClipsAPI::SetClipTemplateStride),
           (arg("clipTemplateStride"), arg("clipSet")))

      .def("GetClipTemplateActiveOffset",
           (double (*)(const UsdClipsAPI &))(&_GetClipTemplateActiveOffset))
      .def("GetClipTemplateActiveOffset",
      ...
      .def("SetClipTemplateActiveOffset",
           (bool (UsdClipsAPI::*)(double,
                                  const std::string &))(&UsdClipsAPI::SetClipTemplateActiveOffset),
           (arg("clipTemplateActiveOffset"), arg("clipSet")))

      .def("GetClipTemplateStartTime",
           (double (*)(const UsdClipsAPI &))(&_GetClipTemplateStartTime))
      .def("GetClipTemplateStartTime",
      ...
      .def("SetClipTemplateStartTime",
           (bool (UsdClipsAPI::*)(double,
                                  const std::string &))(&UsdClipsAPI::SetClipTemplateStartTime),
      ...
      .def("SetClipTemplateEndTime",
           (bool (UsdClipsAPI::*)(double,
                                  const std::string &))(&UsdClipsAPI::SetClipTemplateEndTime),
