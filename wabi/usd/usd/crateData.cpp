...
class Usd_CrateDataImpl
{
 ...
 public:
  ...
  Usd_CrateDataImpl() : _lastSet(_data.end()), _crateFile(CrateFile::CreateNew()) {}
  ...
  template<class... Args> bool Open(string const &assetPath, Args &&...args)
  {
...
bool Usd_CrateData::Open(const std::string &assetPath, const std::shared_ptr<ArAsset> &asset)
{
