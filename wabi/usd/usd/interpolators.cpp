...
bool Usd_UntypedInterpolator::Interpolate(const SdfLayerRefPtr &layer,
                                          const SdfPath &path,
                                          double time,
                                          double lower,
                                          double upper)
...
bool Usd_UntypedInterpolator::Interpolate(const Usd_ClipSetRefPtr &clipSet,
                                          const SdfPath &path,
                                          double time,
                                          double lower,
                                          double upper)
...
template<class Src>
bool Usd_UntypedInterpolator::_Interpolate(const Src &src,
                                           const SdfPath &path,
                                           double time,
                                           double lower,
                                           double upper)
