...
//
#ifndef WABI_USD_USD_INTERPOLATION_H
#define WABI_USD_USD_INTERPOLATION_H
...
BOOST_PP_SEQ_FOR_EACH(_USD_DECLARE_INTERPOLATION_TRAITS, ~, USD_LINEAR_INTERPOLATION_TYPES)
...
#endif  // WABI_USD_USD_INTERPOLATION_H
