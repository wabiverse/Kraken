...
// Array types.
xx(Bool, 1, bool, true) xx(UChar, 2, uint8_t, true) xx(Int, 3, int, true) xx(UInt, 4, unsigned int, true)
  xx(Int64, 5, int64_t, true) xx(UInt64, 6, uint64_t, true)
      ...
      xx(String, 10, std::string, true)
        ...
        xx(Token, 11, TfToken, true)
          ...
          xx(AssetPath, 12, SdfAssetPath, true)
            ...
            xx(Quatd, 16, GfQuatd, true) xx(Quatf, 17, GfQuatf, true) xx(Quath, 18, GfQuath, true)

              xx(Vec2d, 19, GfVec2d, true) xx(Vec2f, 20, GfVec2f, true) xx(Vec2h, 21, GfVec2h, true)
                xx(Vec2i, 22, GfVec2i, true)

                  xx(Vec3d, 23, GfVec3d, true) xx(Vec3f, 24, GfVec3f, true) xx(Vec3h, 25, GfVec3h, true)
                    xx(Vec3i, 26, GfVec3i, true)

                      xx(Vec4d, 27, GfVec4d, true) xx(Vec4f, 28, GfVec4f, true) xx(Vec4h, 29, GfVec4h, true)
  ...
  xx(Dictionary, 31, VtDictionary, false)
    ...
    xx(TokenListOp, 32, SdfTokenListOp, false) xx(StringListOp, 33, SdfStringListOp, false)
      xx(PathListOp, 34, SdfPathListOp, false) xx(ReferenceListOp, 35, SdfReferenceListOp, false)
        xx(IntListOp, 36, SdfIntListOp, false) xx(Int64ListOp, 37, SdfInt64ListOp, false)
          xx(UIntListOp, 38, SdfUIntListOp, false) xx(UInt64ListOp, 39, SdfUInt64ListOp, false)

            xx(PathVector, 40, SdfPathVector, false) xx(TokenVector, 41, std::vector<TfToken>, false)
                      ...
                      xx(DoubleVector, 48, std::vector<double>, false)
                        xx(LayerOffsetVector, 49, std::vector<SdfLayerOffset>, false)
                          xx(StringVector, 50, std::vector<std::string>, false)
                            ...
                            xx(ValueBlock, 51, SdfValueBlock, false) xx(Value, 52, VtValue, false)
