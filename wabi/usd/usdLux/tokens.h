...
struct UsdLuxTokensType {
  ...
  /// \brief "automatic"
  ///
  /// Possible value for UsdLuxDomeLight::GetTextureFormatAttr(), Default value for
  /// UsdLuxDomeLight::GetTextureFormatAttr()
  ...
  ///  filter-linking of a UsdLuxLightFilter prim.
  ...
  ///
  ///  This token represents the collection name to use with UsdCollectionAPI to represent
  ///  light-linking of a UsdLuxLight prim.
  ...
  ///
  ///  This token represents the collection name to use with UsdCollectionAPI to represent
  ///  shadow-linking of a UsdLuxLight prim.
