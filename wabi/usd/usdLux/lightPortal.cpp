 ...
 */
#include "wabi/usd/usdLux/lightPortal.h"
...
{
  TfType::Define<UsdLuxLightPortal, TfType::Bases<UsdLuxPortalLight>>();
...
UsdLuxLightPortal UsdLuxLightPortal::Define(const UsdStagePtr &stage, const SdfPath &path)
{
  ...
  return UsdLuxLightPortal(stage->DefinePrim(path, usdPrimTypeName));
}

/* virtual */
UsdSchemaKind UsdLuxLightPortal::GetSchemaKind() const
{
  return UsdLuxLightPortal::schemaKind;
}

/* static */
const TfType &UsdLuxLightPortal::GetStaticTfType()
{
...
/* static */
bool UsdLuxLightPortal::IsTypedSchema()
{
...
/* virtual */
const TfType &UsdLuxLightPortal::GetTfType() const
{
  return GetStaticTfType();
}

/*static*/
const TfTokenVector &UsdLuxLightPortal::GetSchemaAttributeNames(bool includeInherited)
{
  static TfTokenVector localNames;
  static TfTokenVector allNames = UsdLuxPortalLight::GetSchemaAttributeNames(true);
