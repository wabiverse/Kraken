...
static std::string _Repr(const UsdLuxLightPortal &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  return TfStringPrintf("UsdLux.LightPortal(%s)", primRepr.c_str());
}
...
void wrapUsdLuxLightPortal()
{
  ...
  class_<This, bases<UsdLuxPortalLight>> cls("LightPortal");
