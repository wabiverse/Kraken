...
/* virtual */
UsdSchemaKind UsdLuxPluginLightFilter::GetSchemaKind() const
{
  return UsdLuxPluginLightFilter::schemaKind;
}

/* static */
const TfType &UsdLuxPluginLightFilter::GetStaticTfType()
{
...
/* static */
bool UsdLuxPluginLightFilter::IsTypedSchema()
{
