...
#define SDR_PROPERTY_TYPE_TOKENS \
  ((Int, "int"))((String, "string"))((Float, "float"))((Color, "color"))((Point, "point"))(( \
    Normal, "normal"))((Vector, "vector"))((Matrix, "matrix"))((Struct, "struct"))(( \
    Terminal, "terminal"))((Vstruct, "vstruct"))((Unknown, "unknown"))
...
#define SDR_PROPERTY_METADATA_TOKENS \
  ((Label, "label"))((Help, "help"))( \
    (Page, "page"))((RenderType, "renderType"))((Role, "role"))((Widget, "widget"))((Hints, "hints"))(( \
    Options, "options"))((IsDynamicArray, "isDynamicArray"))((Connectable, "connectable"))(( \
    ValidConnectionTypes, "validConnectionTypes"))((VstructMemberOf, "vstructMemberOf"))(( \
    VstructMemberName, "vstructMemberName"))((VstructConditionalExpr, "vstructConditionalExpr"))(( \
    IsAssetIdentifier, "__SDR__isAssetIdentifier"))((ImplementationName, "__SDR__implementationName"))(( \
...
#endif  // WABI_USD_SDR_SHADER_PROPERTY_H
