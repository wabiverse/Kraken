...
#ifndef WABI_USD_SDR_SHADER_NODE_H
#define WABI_USD_SDR_SHADER_NODE_H
...
#define SDR_NODE_CONTEXT_TOKENS                                                                     \
  ((Pattern, "pattern"))((Surface, "surface"))((Volume, "volume"))((Displacement, "displacement"))( \
    (Light, "light"))((LightFilter, "lightFilter"))((SampleFilter, "sampleFilter"))(                \
...
#endif  // WABI_USD_SDR_SHADER_NODE_H
