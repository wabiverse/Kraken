...
#ifndef WABI_USD_NDR_DECLARE_H
#define WABI_USD_NDR_DECLARE_H
...
class NdrVersion {
 public:
  ...
  {
    return (static_cast<std::size_t>(_major) << 32) + static_cast<std::size_t>(_minor);
  }
