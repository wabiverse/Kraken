...
#ifndef WABI_USD_GDR_GEOM_METADATA_HELPERS_H
#define WABI_USD_GDR_GEOM_METADATA_HELPERS_H

/** @file gdr/geomMetadataHelpers.h */
...
/**
 * @namespace GeomMetadataHelpers
 *
 * Various utilities for parsing metadata contained within geoms. */
namespace GeomMetadataHelpers {
/**
 * Determines if the given property in the metadata dictionary
 * has a truthy value. All values are considered to be true except
 * the following (case-insensitive): '0', 'false', and 'f'. The
 * absence of `propName` in the metadata also evaluates to false. */
GDR_API
...
#endif /* WABI_USD_GDR_GEOM_METADATA_HELPERS_H */
