...
#ifndef WABI_USD_GDR_GEOM_PROPERTY_H
#define WABI_USD_GDR_GEOM_PROPERTY_H

/**
 * @file gdr/geomProperty.h */
...
/**
 * If additional types are added here, it's also worth
 * trying to add a mapping to the equivalent Sdf type
 * in the implementation file. */
#define GDR_PROPERTY_TYPE_TOKENS \
  ((Int, "int"))((String, "string"))((Float, "float"))((Point, "point"))((Normal, "normal"))(( \
      Vector, "vector"))((Matrix, "matrix"))((Struct, "struct"))((Group, "group"))(( \
...
#define GDR_PROPERTY_METADATA_TOKENS \
  ((Label, "label"))((Help, "help"))( \
      (Page, "page"))((PrimitiveType, "primitiveType"))((Role, "role"))((Widget, "widget"))(( \
      Hints, "hints"))((Options, "options"))((IsDynamicArray, "isDynamicArray"))(( \
      Connectable, "connectable"))((ValidConnectionTypes, "validConnectionTypes"))(( \
      VstructMemberOf, "vstructMemberOf"))((VstructMemberName, "vstructMemberName"))(( \
      VstructConditionalExpr, "vstructConditionalExpr"))((IsAssetIdentifier, \
                                                          "__GDR__isAssetIdentifier"))(( \
      ImplementationName, "__GDR__implementationName"))((DefaultInput, "__GDR__defaultinput"))(( \
      Target, "__GDR__target"))((ControlHandle, "controlHandle"))((Transform, \
                                                                   "__GDR__transform"))

/**
 * The following tokens are valid values for the metadata "role" */
#define GDR_PROPERTY_ROLE_TOKENS ((None, "none"))

TF_DECLARE_PUBLIC_TOKENS(GdrPropertyTypes, GDR_API, GDR_PROPERTY_TYPE_TOKENS);
TF_DECLARE_PUBLIC_TOKENS(GdrPropertyMetadata, GDR_API, GDR_PROPERTY_METADATA_TOKENS);
TF_DECLARE_PUBLIC_TOKENS(GdrPropertyRole, GDR_API, GDR_PROPERTY_ROLE_TOKENS);

/**
 * @class GdrGeomProperty
 *
 * A specialized version of `NdrProperty`
 * which holds modeling information. */
class GdrGeomProperty : public NdrProperty {
 public:
  GDR_API /* Constructor. */
  GdrGeomProperty(const TfToken &name,
                  const TfToken &type,
   ...
   * might be used as the display name for the property instead of the
   * name. */
  GDR_API
  ...
  GDR_API
  const NdrTokenMap &GetHints() const
  {
    return _hints;
  }
  ...
  GDR_API
  const NdrOptionVec &GetOptions() const
  {
    return _options;
  }
   ...
   * property is how to refer to the property in geom networks.  The
   ...
   * comes from geom metadata, and may not be specified. The value from
 ...
 protected:
  GdrGeomProperty &operator=(const GdrGeomProperty &) = delete;

  /**
   * Allow the geom's post process function to access the property's
   * internals. Some property information can only be determined after parse
   * time. */
  friend void GdrGeomNode::_PostProcessProperties();
...
#endif /* WABI_USD_GDR_GEOM_PROPERTY_H */
