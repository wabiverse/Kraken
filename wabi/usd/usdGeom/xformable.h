...
/// float3 xformOp:scale = (2, 2, 2)
/// double3 xformOp:translate = (0, 100, 0)
/// uniform token[] xformOpOrder = [ "xformOp:translate", "xformOp:rotateZ", "xformOp:rotateY",
/// "xformOp:rotateX", "xformOp:scale" ] \endcode
///
...
/// "xformOp:translate:scalePivot", "xformOp:scale" ] \endcode
///
...
class UsdGeomXformable : public UsdGeomImageable {
 ...
 public:
  ...
  USDGEOM_API
  UsdAttribute CreateXformOpOrderAttr(VtValue const &defaultValue = VtValue(),
 ...
 private:
  ...
  std::vector<UsdGeomXformOp> _GetOrderedXformOps(bool *resetsXformStack,
