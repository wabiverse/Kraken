 ...
 */
#ifndef WABI_USD_USD_GEOM_BBOX_CACHE_H
#define WABI_USD_USD_GEOM_BBOX_CACHE_H
 ...
 private:
  ...
  struct _PrimContext {
    ...
    explicit _PrimContext(const UsdPrim &prim_, const TfToken &purpose = TfToken())
        : prim(prim_),
          instanceInheritablePurpose(purpose){};
  ...
  bool _ComputeExtent(const UsdGeomBoundable &boundableObj, VtVec3fArray *extent) const;
  ...
  _Entry *_FindOrCreateEntriesForPrim(const _PrimContext &prim,
...
#endif  // WABI_USD_USD_GEOM_BBOX_CACHE_H
