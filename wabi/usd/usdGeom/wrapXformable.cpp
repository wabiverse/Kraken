...
#define WRAP_CUSTOM   \
  ...
  static std::string _Repr(const UsdGeomXformable &self)
  {
    ...
    return TfStringPrintf("UsdGeom.Xformable(%s)", primRepr.c_str());
  }
...
void wrapUsdGeomXformable()
{
  ...
  class_<This, bases<UsdGeomImageable>> cls("Xformable");
  ...
  cls.def(init<UsdPrim>(arg("prim")))
    ...
    .def("GetXformOpOrderAttr", &This::GetXformOpOrderAttr)
...
namespace
{
  ...
  static GfMatrix4d _GetLocalTransformation1(const UsdGeomXformable &self, const UsdTimeCode time)
  {
    GfMatrix4d result(1);
  ...
  static GfMatrix4d _GetLocalTransformation2(const UsdGeomXformable &self,
  ...
  static std::vector<double> _GetTimeSamples(const UsdGeomXformable &self)
  {
  ...
  static std::vector<double> _GetTimeSamplesInInterval(const UsdGeomXformable &self,
  ...
  static std::vector<UsdGeomXformOp> _GetOrderedXformOps(const UsdGeomXformable &self)
  {
  ...
  WRAP_CUSTOM
  {
    ...
    bool (This::*TransformMightBeTimeVarying_1)() const = &This::TransformMightBeTimeVarying;
    bool (This::*TransformMightBeTimeVarying_2)(const std::vector<UsdGeomXformOp> &)
      const = &This::TransformMightBeTimeVarying;
    ...
    scope s = _class
                ...
                .def("SetResetXformStack", &This::SetResetXformStack, (arg("resetXform")))

                .def("GetResetXformStack", &This::GetResetXformStack)

                .def("SetXformOpOrder",
                     &This::SetXformOpOrder,
                     (arg("orderedXformOps"), arg("resetXformStack") = false))

                .def("GetOrderedXformOps",
                     &_GetOrderedXformOps,
                     return_value_policy<TfPySequenceToList>(),
