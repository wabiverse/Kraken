...
static std::string _Repr(const UsdGeomPrimvarsAPI &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  return TfStringPrintf("UsdGeom.PrimvarsAPI(%s)", primRepr.c_str());
}
...
static UsdGeomPrimvar _CreateNonIndexedPrimvar(const UsdGeomPrimvarsAPI &self,
                                               const TfToken &name,
                                               ...
                                               UsdTimeCode time)
{
  ...
  return self.CreateNonIndexedPrimvar(name, typeName, val, interpolation, elementSize, time);
}

static UsdGeomPrimvar _CreateIndexedPrimvar(const UsdGeomPrimvarsAPI &self,
                                            const TfToken &name,
                                            const SdfValueTypeName &typeName,
                                            const object &pyVal,
