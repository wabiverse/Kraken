...
static object _ComputePointInstanceWorldBounds(UsdGeomBBoxCache &self,
...
static object _ComputePointInstanceRelativeBounds(UsdGeomBBoxCache &self,
                                                  const UsdGeomPointInstancer &instancer,
                                                  object instanceIds,
...
static object _ComputePointInstanceLocalBounds(UsdGeomBBoxCache &self,
                                               const UsdGeomPointInstancer &instancer,
                                               object instanceIds)
{
  boost::python::stl_input_iterator<int64_t> begin(instanceIds), end;
...
static object _ComputePointInstanceUntransformedBounds(UsdGeomBBoxCache &self,
                                                       const UsdGeomPointInstancer &instancer,
                                                       object instanceIds)
{
  boost::python::stl_input_iterator<int64_t> begin(instanceIds), end;
...
void wrapUsdGeomBBoxCache()
{
  ...
  GfBBox3d (BBoxCache::*ComputeUntransformedBound_1)(
      const UsdPrim &) = &BBoxCache::ComputeUntransformedBound;
  GfBBox3d (BBoxCache::*ComputeUntransformedBound_2)(
      const UsdPrim &, const SdfPathSet &, const TfHashMap<SdfPath, GfMatrix4d, SdfPath::Hash> &) =
  ...
  class_<BBoxCache>(
      ...
      .def("ComputeUntransformedBound",
           ...
           (arg("prim"), arg("pathsToSkip"), arg("ctmOverrides")))
      ...
      .def("ComputePointInstanceRelativeBounds",
           ...
           (arg("instancer"), arg("instanceIds"), arg("relativeToAncestorPrim")))
      .def("ComputePointInstanceRelativeBound",
           &BBoxCache::ComputePointInstanceRelativeBound,
           (arg("instancer"), arg("instanceId"), arg("relativeToAncestorPrim")))
