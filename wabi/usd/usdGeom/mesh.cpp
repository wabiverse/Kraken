...
UsdAttribute UsdGeomMesh::CreateInterpolateBoundaryAttr(VtValue const &defaultValue,
                                                        bool writeSparsely) const
{
...
UsdAttribute UsdGeomMesh::CreateTriangleSubdivisionRuleAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
