...
struct UsdGeomTokensType {
  ...
  /// \brief "bezier"
  ///
  /// Possible value for UsdGeomBasisCurves::GetBasisAttr(), Default value for
  /// UsdGeomBasisCurves::GetBasisAttr()
  ...
  /// \brief "catmullClark"
  ///
  /// Possible value for UsdGeomMesh::GetSubdivisionSchemeAttr(), Default value for
  /// UsdGeomMesh::GetSubdivisionSchemeAttr(), Possible value for
  /// UsdGeomMesh::GetTriangleSubdivisionRuleAttr(), Default value for
  ...
  /// \brief "closed"
  ///
  /// Possible value for UsdGeomNurbsPatch::GetUFormAttr(), Possible value for
  /// UsdGeomNurbsPatch::GetVFormAttr()
  const TfToken closed;
  /// \brief "constant"
  ///
  /// Possible value for UsdGeomPrimvar::SetInterpolation. Default value for
  /// UsdGeomPrimvar::GetInterpolation. One value remains constant over the entire surface
  /// primitive.
  ...
  /// \brief "cornersPlus1"
  ///
  /// Possible value for UsdGeomMesh::GetFaceVaryingLinearInterpolationAttr(), Default value for
  /// UsdGeomMesh::GetFaceVaryingLinearInterpolationAttr()
  ...
  /// \brief "cross"
  ///
  /// Possible value for UsdGeomModelAPI::GetModelCardGeometryAttr(), Default value for
  /// UsdGeomModelAPI::GetModelCardGeometryAttr()
  const TfToken cross;
  /// \brief "cubic"
  ///
  /// Possible value for UsdGeomBasisCurves::GetTypeAttr(), Default value for
  /// UsdGeomBasisCurves::GetTypeAttr()
  const TfToken cubic;
  ...
  /// \brief "default"
  ///
  /// Possible value for UsdGeomModelAPI::GetModelDrawModeAttr(), Possible value for
  /// UsdGeomImageable::GetPurposeAttr(), Default value for UsdGeomImageable::GetPurposeAttr()
  ...
  /// \brief "edgeAndCorner"
  ///
  /// Possible value for UsdGeomMesh::GetInterpolateBoundaryAttr(), Default value for
  /// UsdGeomMesh::GetInterpolateBoundaryAttr()
  ...
  /// \brief "elementSize"
  ///
  /// UsdGeomPrimvar - The number of values in the value array that must be aggregated for each
  /// element on the  primitive.
  ...
  /// \brief "extentsHint"
  ///
  /// Name of the attribute used to author extents hints at the root of leaf models. Extents hints
  /// are stored by purpose as a vector of GfVec3f values. They are ordered based on the order of
  /// purpose tokens returned by  UsdGeomImageable::GetOrderedPurposeTokens.
  const TfToken extentsHint;
  /// \brief "face"
  ///
  /// Possible value for UsdGeomSubset::GetElementTypeAttr(), Default value for
  /// UsdGeomSubset::GetElementTypeAttr()
  const TfToken face;
  /// \brief "faceVarying"
  ///
  /// Possible value for UsdGeomPrimvar::SetInterpolation. For polygons and subdivision surfaces,
  /// four values are interpolated over each face of the mesh. Bilinear interpolation  is used for
  ...
  /// \brief "inactiveIds"
  ///
  /// int64listop prim metadata that specifies the PointInstancer ids that should be masked
  /// (unrenderable) over all time.
  ...
  /// \brief "interpolation"
  ///
  /// UsdGeomPrimvar - How a Primvar interpolates across a primitive; equivalent to RenderMan's
  ...
  /// \brief "metersPerUnit"
  ///
  /// Stage-level metadata that encodes a scene's linear unit of measure as meters per encoded
  /// unit.
  ...
  /// UsdGeomMesh::GetInterpolateBoundaryAttr(), Possible value for
  /// UsdGeomMesh::GetSubdivisionSchemeAttr()
  const TfToken none;
  /// \brief "nonOverlapping"
  ///
  /// A type of family of GeomSubsets. It implies that  the elements in the various subsets
  /// belonging to the family are  mutually exclusive, i.e., an element that appears in one  subset
  /// may not belong to any other subset in the family.
  const TfToken nonOverlapping;
  /// \brief "nonperiodic"
  ///
  /// Possible value for UsdGeomBasisCurves::GetWrapAttr(), Default value for
  /// UsdGeomBasisCurves::GetWrapAttr()
  ...
  /// \brief "open"
  ///
  /// Possible value for UsdGeomNurbsPatch::GetUFormAttr(), Default value for
  /// UsdGeomNurbsPatch::GetUFormAttr(), Possible value for UsdGeomNurbsPatch::GetVFormAttr(),
  /// Default value for UsdGeomNurbsPatch::GetVFormAttr()
  const TfToken open;
  /// \brief "order"
  ///
  /// UsdGeomNurbsCurves
  ...
  /// one of the  subsets in the family.
  const TfToken partition;
  /// \brief "periodic"
  ///
  /// Possible value for UsdGeomBasisCurves::GetWrapAttr(), Possible value for
  /// UsdGeomNurbsPatch::GetUFormAttr(), Possible value for UsdGeomNurbsPatch::GetVFormAttr()
  const TfToken periodic;
  /// \brief "perspective"
  ///
  /// Possible value for UsdGeomCamera::GetProjectionAttr(), Default value for
  /// UsdGeomCamera::GetProjectionAttr()
  ...
  /// \brief "rightHanded"
  ///
  /// Possible value for UsdGeomGprim::GetOrientationAttr(), Default value for
  ...
  ///
  /// UsdGeomPrimvar - The index that represents  unauthored values in the indices array of an
  /// indexed primvar.
  ...
  /// membership of elements in  the subsets. There could be overlapping members in subsets
  /// belonging to the family and the union of all subsets in the  family may not contain all the
  /// elements.
  ...
  /// \brief "upAxis"
  ///
  /// Stage-level metadata that encodes a scene's orientation as a token whose value can be "Y" or
  /// "Z".
  ...
  /// \brief "varying"
  ///
  /// Possible value for UsdGeomPrimvar::SetInterpolation. Four values are interpolated over each
  /// uv patch segment of the  surface. Bilinear interpolation is used for interpolation  between
  /// the four values.
  ...
  /// \brief "vertex"
  ///
  /// Possible value for UsdGeomPrimvar::SetInterpolation. Values are interpolated between each
  /// vertex in the surface primitive. The basis function of the surface is used for  interpolation
  /// between vertices.
  ...
  /// \brief "X"
  ///
  /// Possible value for UsdGeomCone::GetAxisAttr(), Possible value for
  /// UsdGeomCapsule::GetAxisAttr(), Possible value for UsdGeomCylinder::GetAxisAttr()
  const TfToken x;
  /// \brief "xformOpOrder"
  ///
  /// UsdGeomXformable
  ...
  /// \brief "Z"
  ///
  /// Possible value for UsdGeomCone::GetAxisAttr(), Default value for UsdGeomCone::GetAxisAttr(),
  /// Possible value for UsdGeomCapsule::GetAxisAttr(), Default value for
  /// UsdGeomCapsule::GetAxisAttr(), Possible value for UsdGeomCylinder::GetAxisAttr(), Default
  /// value for UsdGeomCylinder::GetAxisAttr()
  const TfToken z;
