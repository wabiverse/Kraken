...
GfCamera UsdGeomCamera::GetCamera(const UsdTimeCode &time) const
{
  ...
  if (const boost::optional<GfVec2f> clippingRange =
  ...
  if (const boost::optional<float> fStop = _GetValue<float>(GetPrim(),
                                                            UsdGeomTokens->fStop,
                                                            time)) {
