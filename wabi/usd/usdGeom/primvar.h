...
/// and Alembic as its <A
/// HREF="https://github.com/alembic/alembic/blob/master/lib/Alembic/AbcGeom/GeometryScope.h#L47">
/// "geometry scope"</A>); it also includes the attribute's \ref GetElementSize() "elementSize",
...
/// HREF="http://renderman.pixar.com/resources/current/rps/appnote.22.html#classSpecifiers"> the
/// RPS documentation</a>, which contains further details, \em interpolation describes how the
/// Primvar will be interpolated over the uv parameter space of a surface primitive (or curve or
/// pointcloud).  The possible values are: \li <b>constant</b> One value remains constant over the
/// entire surface
///     primitive.
...
class UsdGeomPrimvar {
 public:
  ...
  USDGEOM_API
  void GetDeclarationInfo(TfToken *name,
