...
class UsdGeomVisibilityAPI : public UsdAPISchemaBase
{
 ...
 public:
  ...
  USDGEOM_API
  UsdAttribute CreateGuideVisibilityAttr(VtValue const &defaultValue = VtValue(),
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDGEOM_API
  UsdAttribute CreateProxyVisibilityAttr(VtValue const &defaultValue = VtValue(),
                                         bool writeSparsely = false) const;
 ...
 public:
  ...
  /// the default for \p writeSparsely is \c false.
  USDGEOM_API
  UsdAttribute CreateRenderVisibilityAttr(VtValue const &defaultValue = VtValue(),
                                          bool writeSparsely = false) const;
