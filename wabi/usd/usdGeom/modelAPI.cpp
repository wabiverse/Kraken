...
UsdAttribute UsdGeomModelAPI::CreateModelApplyDrawModeAttr(VtValue const &defaultValue,
                                                           bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelDrawModeColorAttr(VtValue const &defaultValue,
                                                           bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardGeometryAttr(VtValue const &defaultValue,
                                                          bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardTextureXPosAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardTextureYPosAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardTextureZPosAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardTextureXNegAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardTextureYNegAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
UsdAttribute UsdGeomModelAPI::CreateModelCardTextureZNegAttr(VtValue const &defaultValue,
                                                             bool writeSparsely) const
{
...
bool UsdGeomModelAPI::SetExtentsHint(VtVec3fArray const &extents, const UsdTimeCode &time) const
{
  if (!TF_VERIFY(extents.size() >= 2 &&
                 extents.size() <= (2 * UsdGeomImageable::GetOrderedPurposeTokens().size())))
    return false;

  UsdAttribute extentsHintAttr = GetPrim().CreateAttribute(UsdGeomTokens->extentsHint,
...
VtVec3fArray UsdGeomModelAPI::ComputeExtentsHint(UsdGeomBBoxCache &bboxCache) const
{
  ...
  for (size_t bboxType = purposeTokens.size(); bboxType-- != 0;) {
    ...
    bboxCache.SetIncludedPurposes(std::vector<TfToken>(1, purposeTokens[bboxType]));

    GfBBox3d bbox = bboxCache.ComputeUntransformedBound(GetPrim());
