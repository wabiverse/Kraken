...
/* virtual */
const TfType &UsdGeomXformable::GetType() const
{
...
{
  return std::find(opOrderVec.begin(), opOrderVec.end(), UsdGeomXformOpTypes->resetXformStack) !=
         opOrderVec.end();
}
...
bool UsdGeomXformable::SetXformOpOrder(vector<UsdGeomXformOp> const &orderedXformOps,
...
vector<UsdGeomXformOp> UsdGeomXformable::_GetOrderedXformOps(bool *resetsXformStack,
...
bool UsdGeomXformable::XformQuery::GetLocalTransformation(GfMatrix4d *transform,
