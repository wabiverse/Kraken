...
def GetPySideModule():
    ...
    e.g. 'PySide' or 'PySide6'"""
    # Inspect objects imported in a UI module generated by uic to determine 
    # which PySide module they come from (e.g. PySide.QtCore, PySide6.QtCore).
...
if PySideModule == 'PySide':
    ...
    # Patch missing functions to make PySide look like PySide6
    ...
    # Patch missing classes to make PySide look like PySide6
