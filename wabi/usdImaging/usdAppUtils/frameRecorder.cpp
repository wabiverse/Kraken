...
#include "wabi/imaging/hdx/types.h"
...
static bool _HasPurpose(const TfTokenVector &purposes, const TfToken &purpose)
{
...
static GfCamera _ComputeCameraToFrameStage(const UsdStagePtr &stage,
...
static void _ReadbackTexture(Hgi *const hgi,
...
static bool _WriteTextureToFile(HgiTextureDesc const &textureDesc,
...
bool UsdAppUtilsFrameRecorder::Record(const UsdStagePtr &stage,
                                      ...
                                      const std::string &outputImagePath)
{
  ...
  return _WriteTextureToFile(handle.Get()->GetDescriptor(), buffer, outputImagePath, true);
}
