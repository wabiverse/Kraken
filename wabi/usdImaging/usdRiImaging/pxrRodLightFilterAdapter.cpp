 ...
 */
#include "wabi/usdImaging/usdRiImaging/pxrRodLightFilterAdapter.h"
...
bool UsdRiImagingPxrRodLightFilterAdapter::IsSupported(UsdImagingIndexProxy const *index) const
{
