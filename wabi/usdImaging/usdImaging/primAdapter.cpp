...
/*virtual*/
bool UsdImagingPrimAdapter::ShouldCullChildren() const
{
  return false;
}

/*virtual*/
bool UsdImagingPrimAdapter::ShouldIgnoreNativeInstanceSubtrees() const
{
  return false;
}

/*virtual*/
bool UsdImagingPrimAdapter::IsInstancerAdapter() const
{
  return false;
}

/*virtual*/
bool UsdImagingPrimAdapter::CanPopulateUsdInstance() const
{
  return false;
}

/*virtual*/
HdDirtyBits UsdImagingPrimAdapter::ProcessPrimChange(UsdPrim const &prim,
...
/*virtual*/
void UsdImagingPrimAdapter::ProcessPrimResync(SdfPath const &cachePath, UsdImagingIndexProxy *index)
{
...
/*virtual*/
void UsdImagingPrimAdapter::ProcessPrimRemoval(SdfPath const &cachePath, UsdImagingIndexProxy *index)
{
  _RemovePrim(cachePath, index);
}

/*virtual*/
void UsdImagingPrimAdapter::MarkRefineLevelDirty(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
                                                 UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkReprDirty(UsdPrim const &prim,
                                          SdfPath const &cachePath,
                                          UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkCullStyleDirty(UsdPrim const &prim,
                                               SdfPath const &cachePath,
                                               UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkRenderTagDirty(UsdPrim const &prim,
                                               SdfPath const &cachePath,
                                               UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkTransformDirty(UsdPrim const &prim,
                                               SdfPath const &cachePath,
                                               UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkVisibilityDirty(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkMaterialDirty(UsdPrim const &prim,
                                              SdfPath const &cachePath,
                                              UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkLightParamsDirty(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
                                                 UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::MarkWindowPolicyDirty(UsdPrim const &prim,
                                                  SdfPath const &cachePath,
                                                  UsdImagingIndexProxy *index)
{}

/*virtual*/
void UsdImagingPrimAdapter::InvokeComputation(SdfPath const &cachePath, HdExtComputationContext *context)
{}

/*virtual*/
std::vector<VtArray<TfToken>> UsdImagingPrimAdapter::GetInstanceCategories(UsdPrim const &prim)
{
  return std::vector<VtArray<TfToken>>();
}

/*virtual*/
PxOsdSubdivTags UsdImagingPrimAdapter::GetSubdivTags(UsdPrim const &prim,
                                                     SdfPath const &cachePath,
...
/*virtual*/
size_t UsdImagingPrimAdapter::SampleInstancerTransform(UsdPrim const &instancerPrim,
...
/*virtual*/
GfMatrix4d UsdImagingPrimAdapter::GetInstancerTransform(UsdPrim const &instancerPrim,
                                                        SdfPath const &instancerPath,
                                                        UsdTimeCode time) const
{
...
/*virtual*/
SdfPath UsdImagingPrimAdapter::GetInstancerId(UsdPrim const &usdPrim, SdfPath const &cachePath) const
{
  return SdfPath::EmptyPath();
}

/*virtual*/
SdfPathVector UsdImagingPrimAdapter::GetInstancerPrototypes(UsdPrim const &usdPrim,
...
/*virtual*/
size_t UsdImagingPrimAdapter::SamplePrimvar(UsdPrim const &usdPrim,
                                            SdfPath const &cachePath,
                                            TfToken const &key,
                                            UsdTimeCode time,
                                            size_t maxNumSamples,
...
/*virtual*/
SdfPath UsdImagingPrimAdapter::GetScenePrimPath(SdfPath const &cachePath,
                                                int instanceIndex,
                                              ...
                                              HdSelectionSharedPtr const &result) const
{
  ...
  if (TfDebug::IsEnabled(USDIMAGING_SELECTION))
  {
    ...
    TF_DEBUG(USDIMAGING_SELECTION)
      .Msg("PopulateSelection: (prim) %s %s\n", indexPath.GetText(), ss.str().c_str());
  }

  return true;
}

HdVolumeFieldDescriptorVector UsdImagingPrimAdapter::GetVolumeFieldDescriptors(UsdPrim const &usdPrim,
                                                                               SdfPath const &id,
                                                                               UsdTimeCode time) const
{
...
void UsdImagingPrimAdapter::SetDelegate(UsdImagingDelegate *delegate)
{
  _delegate = delegate;
}

bool UsdImagingPrimAdapter::IsChildPath(SdfPath const &path) const
{
...
UsdPrim UsdImagingPrimAdapter::_GetPrim(SdfPath const &usdPath) const
{
...
const UsdImagingPrimAdapterSharedPtr &UsdImagingPrimAdapter::_GetPrimAdapter(UsdPrim const &prim,
                                                                             bool ignoreInstancing) const
{
  return _delegate->_AdapterLookup(prim, ignoreInstancing);
}

const UsdImagingPrimAdapterSharedPtr &UsdImagingPrimAdapter::_GetAdapter(TfToken const &adapterKey) const
{
  return _delegate->_AdapterLookup(adapterKey);
}

SdfPath UsdImagingPrimAdapter::_GetPrimPathFromInstancerChain(SdfPathVector const &instancerChain) const
{
...
UsdTimeCode UsdImagingPrimAdapter::_GetTimeWithOffset(float offset) const
{
  return _delegate->GetTimeWithOffset(offset);
}

SdfPath UsdImagingPrimAdapter::_ConvertCachePathToIndexPath(const SdfPath &usdPath) const
{
  return _delegate->ConvertCachePathToIndexPath(usdPath);
}

SdfPath UsdImagingPrimAdapter::_ConvertIndexPathToCachePath(const SdfPath &indexPath) const
{
  return _delegate->ConvertIndexPathToCachePath(indexPath);
}

TfToken UsdImagingPrimAdapter::_GetMaterialBindingPurpose() const
{
  return _delegate->GetRenderIndex().GetRenderDelegate()->GetMaterialBindingPurpose();
}

TfTokenVector UsdImagingPrimAdapter::_GetMaterialRenderContexts() const
{
...
{
  return _delegate->GetRenderIndex().GetRenderDelegate()->GetShaderSourceTypes();
}

bool UsdImagingPrimAdapter::_IsInInvisedPaths(SdfPath const &usdPath) const
{
  return _delegate->IsInInvisedPaths(usdPath);
}

void UsdImagingPrimAdapter::_MergePrimvar(HdPrimvarDescriptorVector *vec,
                                          TfToken const &name,
                                          ...
                                          bool indexed) const
{
  ...
  HdPrimvarDescriptorVector::iterator it = std::find(vec->begin(), vec->end(), primvar);
  if (it == vec->end())
...
HdDirtyBits UsdImagingPrimAdapter::_ProcessNonPrefixedPrimvarPropertyChange(
  UsdPrim const &prim,
  SdfPath const &cachePath,
...
HdDirtyBits UsdImagingPrimAdapter::_ProcessPrefixedPrimvarPropertyChange(
  UsdPrim const &prim,
  SdfPath const &cachePath,
  TfToken const &propertyName,
...
UsdImaging_CollectionCache &UsdImagingPrimAdapter::_GetCollectionCache() const
{
  return _delegate->_collectionCache;
}

UsdImaging_CoordSysBindingStrategy::value_type UsdImagingPrimAdapter::_GetCoordSysBindings(
  UsdPrim const &prim) const
{
  return _delegate->_coordSysBindingCache.GetValue(prim);
}

UsdImaging_InheritedPrimvarStrategy::value_type UsdImagingPrimAdapter::_GetInheritedPrimvars(
  UsdPrim const &prim) const
{
  return _delegate->_inheritedPrimvarCache.GetValue(prim);
}

bool UsdImagingPrimAdapter::_DoesDelegateSupportCoordSys() const
{
  return _delegate->_coordSysEnabled;
}

bool UsdImagingPrimAdapter::_IsVarying(UsdPrim prim,
...
bool UsdImagingPrimAdapter::_IsTransformVarying(UsdPrim prim,
                                                HdDirtyBits dirtyFlag,
                                                TfToken const &perfToken,
...
GfMatrix4d UsdImagingPrimAdapter::GetTransform(UsdPrim const &prim,
                                               SdfPath const &cachePath,
                                               UsdTimeCode time,
...
GfInterval UsdImagingPrimAdapter::_GetCurrentTimeSamplingInterval()
{
...
VtValue UsdImagingPrimAdapter::Get(UsdPrim const &prim,
                                   SdfPath const &cachePath,
                                   TfToken const &key,
                                   UsdTimeCode time,
...
bool UsdImagingPrimAdapter::GetVisible(UsdPrim const &prim, SdfPath const &cachePath, UsdTimeCode time) const
{
  TRACE_FUNCTION();
...
TfToken UsdImagingPrimAdapter::GetPurpose(UsdPrim const &prim,
                                          SdfPath const &cachePath,
                                          TfToken const &instanceInheritablePurpose) const
{
  HD_TRACE_FUNCTION();

  UsdImaging_PurposeStrategy::value_type purposeInfo = _IsEnabledPurposeCache() ?
                                                         _delegate->_purposeCache.GetValue(prim) :
                                                         UsdImaging_PurposeStrategy::ComputePurposeInfo(
                                                           prim);
  ...
  return purposeInfo.purpose.IsEmpty() ? UsdGeomTokens->default_ : purposeInfo.purpose;
}

TfToken UsdImagingPrimAdapter::GetInheritablePurpose(UsdPrim const &prim) const
{
  HD_TRACE_FUNCTION();
...
HdCullStyle UsdImagingPrimAdapter::GetCullStyle(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdTimeCode time) const
{
...
SdfPath UsdImagingPrimAdapter::GetMaterialUsdPath(UsdPrim const &prim) const
{
  HD_TRACE_FUNCTION();
...
TfToken UsdImagingPrimAdapter::GetModelDrawMode(UsdPrim const &prim)
{
  return _delegate->_GetModelDrawMode(prim);
}

/*virtual*/
VtValue UsdImagingPrimAdapter::GetTopology(UsdPrim const &prim,
                                           SdfPath const &cachePath,
                                           UsdTimeCode time) const
{
  return VtValue();
...
/*virtual*/
GfRange3d UsdImagingPrimAdapter::GetExtent(UsdPrim const &prim,
                                           SdfPath const &cachePath,
                                           UsdTimeCode time) const
{
  return GfRange3d();
...
/*virtual*/
bool UsdImagingPrimAdapter::GetDoubleSided(UsdPrim const &prim,
                                           SdfPath const &cachePath,
                                           UsdTimeCode time) const
{
  return false;
...
/*virtual*/
SdfPath UsdImagingPrimAdapter::GetMaterialId(UsdPrim const &prim,
                                             SdfPath const &cachePath,
                                             UsdTimeCode time) const
{
  return SdfPath();
...
/*virtual*/
VtValue UsdImagingPrimAdapter::GetMaterialResource(UsdPrim const &prim,
                                                   SdfPath const &cachePath,
                                                   UsdTimeCode time) const
{
  return VtValue();
...
/*virtual*/
const TfTokenVector &UsdImagingPrimAdapter::GetExtComputationSceneInputNames(SdfPath const &cachePath) const
{
...
/*virtual*/
HdExtComputationInputDescriptorVector UsdImagingPrimAdapter::GetExtComputationInputs(
  UsdPrim const &prim,
  SdfPath const &cachePath,
...
/*virtual*/
HdExtComputationOutputDescriptorVector UsdImagingPrimAdapter::GetExtComputationOutputs(
  UsdPrim const &prim,
  SdfPath const &cachePath,
  const UsdImagingInstancerContext *instancerContext) const
{
...
/*virtual*/
HdExtComputationPrimvarDescriptorVector UsdImagingPrimAdapter::GetExtComputationPrimvars(
  UsdPrim const &prim,
  SdfPath const &cachePath,
...
/*virtual*/
VtValue UsdImagingPrimAdapter::GetExtComputationInput(
  UsdPrim const &prim,
  SdfPath const &cachePath,
  TfToken const &name,
  UsdTimeCode time,
...
/*virtual*/
size_t UsdImagingPrimAdapter::SampleExtComputationInput(UsdPrim const &prim,
                                                        SdfPath const &cachePath,
                                                        TfToken const &name,
                                                        UsdTimeCode time,
...
/*virtual*/
std::string UsdImagingPrimAdapter::GetExtComputationKernel(
  UsdPrim const &prim,
  SdfPath const &cachePath,
  const UsdImagingInstancerContext *instancerContext) const
{
...
/*virtual*/
VtValue UsdImagingPrimAdapter::GetInstanceIndices(UsdPrim const &instancerPrim,
...
VtArray<VtIntArray> UsdImagingPrimAdapter::GetPerPrototypeIndices(UsdPrim const &prim,
                                                                  UsdTimeCode time) const
{
  TRACE_FUNCTION();
...
/*virtual*/
GfMatrix4d UsdImagingPrimAdapter::GetRelativeInstancerTransform(SdfPath const &instancerPath,
