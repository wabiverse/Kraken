...
static TfTokenVector _CollectMaterialPrimvars(const VtValue &vtMaterial)
{
  ...
  if (vtMaterial.IsHolding<HdMaterialNetworkMap>())
  {
    ...
    HdMaterialNetworkMap const &networkMap = vtMaterial.UncheckedGet<HdMaterialNetworkMap>();
...
SdfPath UsdImagingGprimAdapter::_AddRprim(TfToken const &primType,
                                          ...
                                          UsdImagingInstancerContext const *instancerContext)
{
  ...
  UsdPrim proxyPrim = usdPrim.GetStage()->GetPrimAtPath(cachePath.GetAbsoluteRootOrPrimPath());

  index->InsertRprim(primType,
                     cachePath,
                     proxyPrim,
  ...
  {
    if (UsdImagingPrimAdapterSharedPtr coordSysAdapter = _GetAdapter(HdPrimTypeTokens->coordSys))
    {
...
void UsdImagingGprimAdapter::_RemovePrim(SdfPath const &cachePath, UsdImagingIndexProxy *index)
{
  index->RemoveRprim(cachePath);
}

bool UsdImagingGprimAdapter::_IsBuiltinPrimvar(TfToken const &primvarName) const
{
                                           ...
                                           UsdImagingInstancerContext const *instancerContext) const
{
  ...
  if (requestedBits & HdChangeTracker::DirtyPoints)
  {
    ...
    _MergePrimvar(&vPrimvars, HdTokens->points, HdInterpolationVertex, HdPrimvarRoleTokens->point);
...
HdDirtyBits UsdImagingGprimAdapter::ProcessPropertyChange(UsdPrim const &prim,
                                                          SdfPath const &cachePath,
                                                          TfToken const &propertyName)
{
  ...
  {
    return HdChangeTracker::DirtyMaterialId | HdChangeTracker::DirtyPrimvar;
  }
...
void UsdImagingGprimAdapter::MarkDirty(UsdPrim const &prim,
                                       SdfPath const &cachePath,
                                       HdDirtyBits dirty,
                                       UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkRefineLevelDirty(UsdPrim const &prim,
                                                  SdfPath const &cachePath,
                                                  UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkReprDirty(UsdPrim const &prim,
                                           SdfPath const &cachePath,
                                           UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkCullStyleDirty(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkRenderTagDirty(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkTransformDirty(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkVisibilityDirty(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
                                                 UsdImagingIndexProxy *index)
{
...
void UsdImagingGprimAdapter::MarkMaterialDirty(UsdPrim const &prim,
                                               SdfPath const &cachePath,
                                               UsdImagingIndexProxy *index)
{
...
/*virtual*/
VtValue UsdImagingGprimAdapter::GetPoints(UsdPrim const &prim, UsdTimeCode time) const
{
  HD_TRACE_FUNCTION();
...
/*virtual*/
GfRange3d UsdImagingGprimAdapter::GetExtent(UsdPrim const &prim,
                                            SdfPath const &cachePath,
...
/*virtual*/
bool UsdImagingGprimAdapter::GetDoubleSided(UsdPrim const &prim,
                                            SdfPath const &cachePath,
                                            UsdTimeCode time) const
{
  HD_TRACE_FUNCTION();
...
/*virtual*/
SdfPath UsdImagingGprimAdapter::GetMaterialId(UsdPrim const &prim,
                                              SdfPath const &cachePath,
                                              UsdTimeCode time) const
{
...
/*virtual*/
VtValue UsdImagingGprimAdapter::Get(UsdPrim const &prim,
                                    SdfPath const &cachePath,
                                    TfToken const &key,
                                    UsdTimeCode time,
...
/* static */
bool UsdImagingGprimAdapter::GetColor(UsdPrim const &prim,
                                      UsdTimeCode time,
                                      ...
                                      VtIntArray *indices)
{
  ...
  // material rel >  local prim var(s)
  {
    ...
    UsdRelationship mat = UsdShadeMaterialBindingAPI(prim).GetDirectBindingRel();
...

  {
    // -- Prim local prim var --
    if (!hasAuthoredColor)
    {  // did not get color from material
...
/* static */
bool UsdImagingGprimAdapter::GetOpacity(UsdPrim const &prim,
                                        UsdTimeCode time,
                                        TfToken *interpolation,
                                        VtValue *opacity,
                                        VtIntArray *indices)
{
...

  {
    ...
    {  // did not get opacity from material
      UsdGeomGprim gprimSchema(prim);
...
UsdGeomPrimvar UsdImagingGprimAdapter::_GetInheritedPrimvar(UsdPrim const &prim,
