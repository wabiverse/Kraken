  ...
  template<typename T> class _ScalingTypedSampledDataSource : public HdTypedSampledDataSource<T>
  {
   public:
      ...
      std::vector<HdSampledDataSource::Time> *outSampleTimes) override
    {
      ...
      return _dataSource->GetContributingSampleTimesForInterval(startTime,
                                                                endTime,
                                                                outSampleTimes);
    }
...
bool UsdImagingDataSourceCamera::Has(const TfToken &name)
{
...
bool UsdImagingDataSourceCameraPrim::UsdImagingDataSourceCameraPrim::Has(const TfToken &name)
{
...
{
  if (name == HdCameraSchemaTokens->camera) {
    return UsdImagingDataSourceCamera::New(_GetSceneIndexPath(),
