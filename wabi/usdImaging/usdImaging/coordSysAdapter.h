...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_COORD_SYS_ADAPTER_H
#define WABI_USD_IMAGING_USD_IMAGING_COORD_SYS_ADAPTER_H
...
class UsdImagingCoordSysAdapter : public UsdImagingPrimAdapter {
 public:
  ...
  virtual void TrackVariability(UsdPrim const &prim,
                                ...
                                UsdImagingInstancerContext const *instancerContext = NULL) const;

  USDIMAGING_API
  virtual void ProcessPrimResync(SdfPath const &primPath, UsdImagingIndexProxy *index);
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_COORD_SYS_ADAPTER_H
