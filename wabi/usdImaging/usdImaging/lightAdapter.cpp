...
bool UsdImagingLightAdapter::IsSupported(UsdImagingIndexProxy const *index) const
{
  return IsEnabledSceneLights() && index->IsSprimTypeSupported(HdPrimTypeTokens->light);
}

SdfPath UsdImagingLightAdapter::Populate(UsdPrim const &prim,
...
void UsdImagingLightAdapter::_RemovePrim(SdfPath const &cachePath, UsdImagingIndexProxy *index)
{
...
void UsdImagingLightAdapter::MarkDirty(UsdPrim const &prim,
                                       SdfPath const &cachePath,
                                       HdDirtyBits dirty,
                                       UsdImagingIndexProxy *index)
{
...
void UsdImagingLightAdapter::MarkTransformDirty(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdImagingIndexProxy *index)
{
...
void UsdImagingLightAdapter::MarkVisibilityDirty(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
                                                 UsdImagingIndexProxy *index)
{
...
void UsdImagingLightAdapter::MarkLightParamsDirty(UsdPrim const &prim,
                                                  SdfPath const &cachePath,
                                                  UsdImagingIndexProxy *index)
{
  static const HdDirtyBits paramsDirty = HdLight::DirtyParams;
