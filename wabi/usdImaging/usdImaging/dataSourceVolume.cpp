...
UsdImagingDataSourceVolumeFieldBindings ::UsdImagingDataSourceVolumeFieldBindings(
...
bool UsdImagingDataSourceVolumeFieldBindings::Has(const TfToken &name)
{
  return _usdVolume.HasFieldRelationship(name);
}

TfTokenVector UsdImagingDataSourceVolumeFieldBindings::GetNames()
{
  TRACE_FUNCTION();
...
HdDataSourceBaseHandle UsdImagingDataSourceVolumeFieldBindings::Get(const TfToken &name)
{
  TRACE_FUNCTION();
...
bool UsdImagingDataSourceVolumePrim::Has(const TfToken &name)
{
...
TfTokenVector UsdImagingDataSourceVolumePrim::GetNames()
{
...
HdDataSourceBaseHandle UsdImagingDataSourceVolumePrim::Get(const TfToken &name)
{
  if (name == HdVolumeFieldBindingSchemaTokens->volumeFieldBinding) {
    return UsdImagingDataSourceVolumeFieldBindings::New(UsdVolVolume(_GetUsdPrim()),
                                                        _GetStageGlobals());
  } else {
