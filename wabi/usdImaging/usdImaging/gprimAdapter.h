...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_GPRIM_ADAPTER_H
#define WABI_USD_IMAGING_USD_IMAGING_GPRIM_ADAPTER_H
...
class UsdImagingGprimAdapter : public UsdImagingPrimAdapter {
 public:
  ...
  USDIMAGING_API
  virtual VtValue GetPoints(UsdPrim const &prim, UsdTimeCode time) const;
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_GPRIM_ADAPTER_H
