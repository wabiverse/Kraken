...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_INDEX_PROXY_H
#define WABI_USD_IMAGING_USD_IMAGING_INDEX_PROXY_H
...
class UsdImagingIndexProxy {
 public:
  ...
  USDIMAGING_API
  void AddDependency(SdfPath const &cachePath, UsdPrim const &usdPrim);
 ...
 private:
  ...
  typedef std::vector<UsdImagingDelegate::_DependencyMap::value_type> _DependencyVector;
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_INDEX_PROXY_H
