...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_ADAPTER_REGISTRY_H
#define WABI_USD_IMAGING_USD_IMAGING_ADAPTER_REGISTRY_H
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_ADAPTER_REGISTRY_H
