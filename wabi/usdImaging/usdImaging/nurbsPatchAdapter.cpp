...
bool UsdImagingNurbsPatchAdapter::IsSupported(UsdImagingIndexProxy const *index) const
{
  return index->IsRprimTypeSupported(HdPrimTypeTokens->mesh);
}

SdfPath UsdImagingNurbsPatchAdapter::Populate(UsdPrim const &prim,
...
/*virtual*/
VtValue UsdImagingNurbsPatchAdapter::GetPoints(UsdPrim const &prim, UsdTimeCode time) const
{
  return GetMeshPoints(prim, time);
}

HdDirtyBits UsdImagingNurbsPatchAdapter::ProcessPropertyChange(UsdPrim const &prim,
                                                               SdfPath const &cachePath,
...
/*static*/
VtValue UsdImagingNurbsPatchAdapter::GetMeshPoints(UsdPrim const &prim, UsdTimeCode time)
{
...
/*static*/
VtValue UsdImagingNurbsPatchAdapter::GetMeshTopology(UsdPrim const &prim, UsdTimeCode time)
{
...
/*virtual*/
VtValue UsdImagingNurbsPatchAdapter::GetTopology(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
