...
SdfPath UsdImagingCubeAdapter::Populate(UsdPrim const &prim,
...
HdDirtyBits UsdImagingCubeAdapter::ProcessPropertyChange(UsdPrim const &prim,
                                                         SdfPath const &cachePath,
...
/*virtual*/
VtValue UsdImagingCubeAdapter::GetPoints(UsdPrim const &prim, UsdTimeCode time) const
{
...
/*static*/
VtValue UsdImagingCubeAdapter::GetMeshPoints(UsdPrim const &prim, UsdTimeCode time)
{
...
/*static*/
VtValue UsdImagingCubeAdapter::GetMeshTopology()
{
...
/*virtual*/
VtValue UsdImagingCubeAdapter::GetTopology(UsdPrim const &prim,
                                           SdfPath const &cachePath,
