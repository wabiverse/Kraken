...
class UsdImagingPrimAdapter : public std::enable_shared_from_this<UsdImagingPrimAdapter>
{
 public:
  ...
  virtual SdfPath Populate(UsdPrim const &prim,
                           ...
                           UsdImagingInstancerContext const *instancerContext = nullptr) = 0;
  ...
  USDIMAGING_API
  virtual void ProcessPrimResync(SdfPath const &cachePath, UsdImagingIndexProxy *index);
  ...
  // ---------------------------------------------------------------------- //
  USDIMAGING_API
  virtual void InvokeComputation(SdfPath const &cachePath, HdExtComputationContext *context);
  ...
  USDIMAGING_API
  virtual std::vector<VtArray<TfToken>> GetInstanceCategories(UsdPrim const &prim);

  /// Get the instancer transform for the given prim.
  /// \see HdSceneDelegate::GetInstancerTransform()
  USDIMAGING_API
  virtual GfMatrix4d GetInstancerTransform(UsdPrim const &instancerPrim,
  ...
  USDIMAGING_API
  virtual size_t SampleInstancerTransform(UsdPrim const &instancerPrim,
                                          SdfPath const &instancerPath,
                                          UsdTimeCode time,
  ...
  USDIMAGING_API
  virtual SdfPath GetInstancerId(UsdPrim const &usdPrim, SdfPath const &cachePath) const;
  ...
  USDIMAGING_API
  virtual size_t SamplePrimvar(UsdPrim const &usdPrim,
                               SdfPath const &cachePath,
                               TfToken const &key,
                               UsdTimeCode time,
                               size_t maxNumSamples,
  ...
  /// "super vis/invis".
  USDIMAGING_API
  virtual bool GetVisible(UsdPrim const &prim, SdfPath const &cachePath, UsdTimeCode time) const;
  ...
  USDIMAGING_API
  virtual TfToken GetPurpose(UsdPrim const &prim,
                             SdfPath const &cachePath,
  ...
  USDIMAGING_API
  VtArray<VtIntArray> GetPerPrototypeIndices(UsdPrim const &prim, UsdTimeCode time) const;
  ...
  // ---------------------------------------------------------------------- //
  USDIMAGING_API
  virtual const TfTokenVector &GetExtComputationSceneInputNames(SdfPath const &cachePath) const;
  ...
  USDIMAGING_API
  virtual size_t SampleExtComputationInput(UsdPrim const &prim,
                                           SdfPath const &cachePath,
                                           TfToken const &name,
                                           UsdTimeCode time,
 ...
 protected:
  ...
  USDIMAGING_API
  const UsdImagingPrimAdapterSharedPtr &_GetPrimAdapter(UsdPrim const &prim,
                                                        bool ignoreInstancing = false) const;

  USDIMAGING_API
  const UsdImagingPrimAdapterSharedPtr &_GetAdapter(TfToken const &adapterKey) const;
  ...
  USDIMAGING_API
  SdfPath _GetPrimPathFromInstancerChain(SdfPathVector const &instancerChain) const;
  ...
  USDIMAGING_API
  void _MergePrimvar(HdPrimvarDescriptorVector *vec,
                     TfToken const &name,
  ...
  USDIMAGING_API
  void _RemovePrimvar(HdPrimvarDescriptorVector *vec, TfToken const &name) const;
  ...
  USDIMAGING_API
  UsdImaging_CoordSysBindingStrategy::value_type _GetCoordSysBindings(UsdPrim const &prim) const;

  USDIMAGING_API
  UsdImaging_InheritedPrimvarStrategy::value_type _GetInheritedPrimvars(UsdPrim const &prim) const;
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_PRIM_ADAPTER_H
