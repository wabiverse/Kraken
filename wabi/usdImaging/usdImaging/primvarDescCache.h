...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_PRIMVARDESC_CACHE_H
#define WABI_USD_IMAGING_USD_IMAGING_PRIMVARDESC_CACHE_H
...
class UsdImagingPrimvarDescCache {
 ...
 private:
  ...
  template<typename T> T &_Get(Key const &key) const
  {
    ...
    std::pair<typename Cache_t::_MapIt, bool> res = cache->_map.insert(std::make_pair(key, T()));
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_PRIMVARDESC_CACHE_H
