...
TF_REGISTRY_FUNCTION(TfDebug)
{
  ...
  TF_DEBUG_ENVIRONMENT_SYMBOL(USDIMAGING_COMPUTATIONS,
                              "Report Hydra computation usage in usdImaging.");
  TF_DEBUG_ENVIRONMENT_SYMBOL(USDIMAGING_COORDSYS, "Coordinate systems");
  ...
  TF_DEBUG_ENVIRONMENT_SYMBOL(USDIMAGING_UPDATES,
