...
bool UsdImagingCylinderAdapter::IsSupported(UsdImagingIndexProxy const *index) const
{
  return index->IsRprimTypeSupported(HdPrimTypeTokens->mesh);
}

SdfPath UsdImagingCylinderAdapter::Populate(UsdPrim const &prim,
...
HdDirtyBits UsdImagingCylinderAdapter::ProcessPropertyChange(UsdPrim const &prim,
                                                             SdfPath const &cachePath,
...
/*virtual*/
VtValue UsdImagingCylinderAdapter::GetPoints(UsdPrim const &prim, UsdTimeCode time) const
{
...
/*static*/
VtValue UsdImagingCylinderAdapter::GetMeshPoints(UsdPrim const &prim, UsdTimeCode time)
{
...
/*static*/
VtValue UsdImagingCylinderAdapter::GetMeshTopology()
{
...
/*virtual*/
VtValue UsdImagingCylinderAdapter::GetTopology(UsdPrim const &prim,
                                               SdfPath const &cachePath,
