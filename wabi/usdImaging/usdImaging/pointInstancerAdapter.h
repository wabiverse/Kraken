...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_POINT_INSTANCER_ADAPTER_H
#define WABI_USD_IMAGING_USD_IMAGING_POINT_INSTANCER_ADAPTER_H
...
class UsdImagingPointInstancerAdapter : public UsdImagingPrimAdapter
{
 ...
 private:
  ...
  void _UnloadInstancer(SdfPath const &instancerPath, UsdImagingIndexProxy *index);
  ...
  bool _GetInstancerVisible(SdfPath const &instancerPath, UsdTimeCode time) const;

  // Gets the associated _ProtoPrim for the given instancer and cache path.
  _ProtoPrim const &_GetProtoPrim(SdfPath const &instancerPath, SdfPath const &cachePath) const;
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_POINT_INSTANCER_ADAPTER_H
