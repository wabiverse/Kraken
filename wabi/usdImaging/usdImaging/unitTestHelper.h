...
//
#ifndef WABI_USD_IMAGING_USD_IMAGING_UNIT_TEST_HELPER_H
#define WABI_USD_IMAGING_USD_IMAGING_UNIT_TEST_HELPER_H
...
class UsdImaging_TestDriver final
{
 public:
  ...
  UsdImaging_TestDriver(std::string const &usdFilePath,
    ...
    : _engine(),
      ...
      _stage()
  {
    HdRprimCollection collection = HdRprimCollection(collectionName, HdReprSelector(reprName));
 ...
 private:
             ...
             TfTokenVector const &renderTags)
  {
    ...
    _geometryPass = HdRenderPassSharedPtr(new Hd_UnitTestNullRenderPass(_renderIndex, collection));
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_UNIT_TEST_HELPER_H
