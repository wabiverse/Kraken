...
//
#include "wabi/usdImaging/usdImaging/dataSourceMesh.h"
...
bool UsdImagingDataSourceSubdivisionTags::Has(const TfToken &name)
{
  return name == HdSubdivisionTagsSchemaTokens->faceVaryingLinearInterpolation ||
...
TfTokenVector UsdImagingDataSourceSubdivisionTags::GetNames()
{
  return {
...
HdDataSourceBaseHandle UsdImagingDataSourceSubdivisionTags::Get(const TfToken &name)
{
  if (name == HdSubdivisionTagsSchemaTokens->faceVaryingLinearInterpolation) {
    return UsdImagingDataSourceAttribute<TfToken>::New(
      _usdMesh.GetFaceVaryingLinearInterpolationAttr(),
      _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->interpolateBoundary) {
    return UsdImagingDataSourceAttribute<TfToken>::New(_usdMesh.GetInterpolateBoundaryAttr(),
                                                       _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->triangleSubdivisionRule) {
    return UsdImagingDataSourceAttribute<TfToken>::New(_usdMesh.GetTriangleSubdivisionRuleAttr(),
                                                       _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->cornerIndices) {
    return UsdImagingDataSourceAttribute<VtIntArray>::New(_usdMesh.GetCornerIndicesAttr(),
                                                          _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->cornerSharpnesses) {
    return UsdImagingDataSourceAttribute<VtFloatArray>::New(_usdMesh.GetCornerSharpnessesAttr(),
                                                            _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->creaseIndices) {
    return UsdImagingDataSourceAttribute<VtIntArray>::New(_usdMesh.GetCreaseIndicesAttr(),
                                                          _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->creaseLengths) {
    return UsdImagingDataSourceAttribute<VtIntArray>::New(_usdMesh.GetCreaseLengthsAttr(),
                                                          _stageGlobals);
  } else if (name == HdSubdivisionTagsSchemaTokens->creaseSharpnesses) {
    return UsdImagingDataSourceAttribute<VtFloatArray>::New(_usdMesh.GetCreaseSharpnessesAttr(),
                                                            _stageGlobals);
  }
...
bool UsdImagingDataSourceMeshTopology::Has(const TfToken &name)
{
  return name == HdMeshTopologySchemaTokens->faceVertexCounts ||
...
TfTokenVector UsdImagingDataSourceMeshTopology::GetNames()
{
  return {
...
HdDataSourceBaseHandle UsdImagingDataSourceMeshTopology::Get(const TfToken &name)
{
  if (name == HdMeshTopologySchemaTokens->faceVertexCounts) {
    static const HdDataSourceLocator locator = HdMeshTopologySchema::GetDefaultLocator().Append(
      name);
    return UsdImagingDataSourceAttribute<VtIntArray>::New(_usdMesh.GetFaceVertexCountsAttr(),
                                                          _stageGlobals,
                                                          _sceneIndexPath,
                                                          locator);
    ...
    static const HdDataSourceLocator locator = HdMeshTopologySchema::GetDefaultLocator().Append(
      name);
    return UsdImagingDataSourceAttribute<VtIntArray>::New(_usdMesh.GetFaceVertexIndicesAttr(),
                                                          _stageGlobals,
                                                          _sceneIndexPath,
                                                          locator);
    ...
    static const HdDataSourceLocator locator = HdMeshTopologySchema::GetDefaultLocator().Append(
      name);
    return UsdImagingDataSourceAttribute<VtIntArray>::New(_usdMesh.GetHoleIndicesAttr(),
                                                          _stageGlobals,
                                                          _sceneIndexPath,
                                                          locator);
  } else if (name == HdMeshTopologySchemaTokens->orientation) {
    return UsdImagingDataSourceAttribute<TfToken>::New(_usdMesh.GetOrientationAttr(),
                                                       _stageGlobals);
  }
  return nullptr;
}
...
bool UsdImagingDataSourceMesh::Has(const TfToken &name)
{
  return name == HdMeshSchemaTokens->topology || name == HdMeshSchemaTokens->subdivisionScheme ||
         name == HdMeshSchemaTokens->doubleSided || name == HdMeshSchemaTokens->subdivisionTags;
  // XXX: TODO geomsubsets
}

TfTokenVector UsdImagingDataSourceMesh::GetNames()
{
  return {
...
HdDataSourceBaseHandle UsdImagingDataSourceMesh::Get(const TfToken &name)
{
  if (name == HdMeshSchemaTokens->topology) {
    return UsdImagingDataSourceMeshTopology::New(_sceneIndexPath, _usdMesh, _stageGlobals);
  }

  if (name == HdMeshSchemaTokens->subdivisionScheme) {
    return UsdImagingDataSourceAttribute<TfToken>::New(_usdMesh.GetSubdivisionSchemeAttr(),
                                                       _stageGlobals);
  }

  if (name == HdMeshSchemaTokens->doubleSided) {
    return UsdImagingDataSourceAttribute<bool>::New(_usdMesh.GetDoubleSidedAttr(), _stageGlobals);
  }

  if (name == HdMeshSchemaTokens->subdivisionTags) {
    return UsdImagingDataSourceSubdivisionTags::New(_usdMesh, _stageGlobals);
  }
...
bool UsdImagingDataSourceMeshPrim::Has(const TfToken &name)
{
...
TfTokenVector UsdImagingDataSourceMeshPrim::GetNames()
{
...
HdDataSourceBaseHandle UsdImagingDataSourceMeshPrim::Get(const TfToken &name)
{
  if (name == HdMeshSchemaTokens->mesh) {
    return UsdImagingDataSourceMesh::New(_GetSceneIndexPath(),
