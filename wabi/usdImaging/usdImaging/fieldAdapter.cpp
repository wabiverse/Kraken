...
bool UsdImagingFieldAdapter::IsSupported(UsdImagingIndexProxy const *index) const
{
  return index->IsBprimTypeSupported(GetPrimTypeToken());
}

SdfPath UsdImagingFieldAdapter::Populate(UsdPrim const &prim,
...
void UsdImagingFieldAdapter::_RemovePrim(SdfPath const &cachePath, UsdImagingIndexProxy *index)
{
...
void UsdImagingFieldAdapter::MarkDirty(UsdPrim const &prim,
                                       SdfPath const &cachePath,
                                       HdDirtyBits dirty,
                                       UsdImagingIndexProxy *index)
{
...
void UsdImagingFieldAdapter::MarkTransformDirty(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdImagingIndexProxy *index)
{
...
void UsdImagingFieldAdapter::MarkVisibilityDirty(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
                                                 UsdImagingIndexProxy *index)
{
  // TBD
...
VtValue UsdImagingFieldAdapter::Get(UsdPrim const &prim,
                                    SdfPath const &cachePath,
                                    TfToken const &key,
                                    UsdTimeCode time,
