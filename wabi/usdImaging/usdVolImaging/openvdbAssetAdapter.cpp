 ...
 */
#include "wabi/usdImaging/usdVolImaging/openvdbAssetAdapter.h"
...
VtValue UsdImagingOpenVDBAssetAdapter::Get(UsdPrim const &prim,
                                           ...
                                           VtIntArray *outIndices) const
{
  if (key == UsdVolTokens->filePath || key == UsdVolTokens->fieldName ||
      key == UsdVolTokens->fieldIndex || key == UsdVolTokens->fieldDataType ||
      key == UsdVolTokens->vectorDataRoleHint || key == UsdVolTokens->fieldClass) {
...
TfToken UsdImagingOpenVDBAssetAdapter::GetPrimTypeToken() const
{
