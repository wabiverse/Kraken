 ...
 */
#include "wabi/usdImaging/usdVolImaging/field3dAssetAdapter.h"
...
VtValue UsdImagingField3DAssetAdapter::Get(UsdPrim const &prim,
...
TfToken UsdImagingField3DAssetAdapter::GetPrimTypeToken() const
{
