...
#include "wabi/usdImaging/usdApollo/drawModeAdapter.h"
#include "wabi/usdImaging/usdApollo/package.h"
...
{
  typedef UsdApolloDrawModeAdapter Adapter;
...
bool UsdApolloDrawModeAdapter::CanPopulateUsdInstance() const
{
  return true;
}

bool UsdApolloDrawModeAdapter::IsSupported(UsdImagingIndexProxy const *index) const
{
  return true;
}

SdfPath UsdApolloDrawModeAdapter::Populate(UsdPrim const &prim,
                                           ...
                                           UsdImagingInstancerContext const *instancerContext)
{
  ...
  m_drawModeMap.insert(std::make_pair(cachePath, drawMode));

  return cachePath;
}

bool UsdApolloDrawModeAdapter::_IsMaterialPath(SdfPath const &path) const
{
...
void UsdApolloDrawModeAdapter::MarkDirty(UsdPrim const &prim,
...
void UsdApolloDrawModeAdapter::MarkTransformDirty(UsdPrim const &prim,
                                                  SdfPath const &cachePath,
                                                  UsdImagingIndexProxy *index)
{
  if (!_IsMaterialPath(cachePath)) {
...
void UsdApolloDrawModeAdapter::MarkVisibilityDirty(UsdPrim const &prim,
                                                   SdfPath const &cachePath,
                                                   UsdImagingIndexProxy *index)
{
  if (!_IsMaterialPath(cachePath)) {
...
void UsdApolloDrawModeAdapter::MarkMaterialDirty(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
                                                 UsdImagingIndexProxy *index)
{
  if (_IsMaterialPath(cachePath)) {
...
bool UsdApolloDrawModeAdapter::_HasVaryingExtent(UsdPrim const &prim) const
{
  UsdAttribute attr;
...
void UsdApolloDrawModeAdapter::_ComputeGeometryData(UsdPrim const &prim,
                                                    SdfPath const &cachePath,
                                                    UsdTimeCode time,
...
/*virtual*/
VtValue UsdApolloDrawModeAdapter::GetTopology(UsdPrim const &prim,
                                              SdfPath const &cachePath,
...
/*virtual*/
GfRange3d UsdApolloDrawModeAdapter::GetExtent(UsdPrim const &prim,
                                              SdfPath const &cachePath,
                                              UsdTimeCode time) const
{
  TRACE_FUNCTION();
...
/*virtual*/
bool UsdApolloDrawModeAdapter::GetDoubleSided(UsdPrim const &prim,
                                              SdfPath const &cachePath,
                                              UsdTimeCode time) const
{
  return false;
...
/*virtual*/
VtValue UsdApolloDrawModeAdapter::Get(UsdPrim const &prim,
                                      SdfPath const &cachePath,
                                      TfToken const &key,
                                      UsdTimeCode time,
...
/*virtual*/
SdfPath UsdApolloDrawModeAdapter::GetMaterialId(UsdPrim const &prim,
                                                SdfPath const &cachePath,
                                                UsdTimeCode time) const
{
...
/*virtual*/
VtValue UsdApolloDrawModeAdapter::GetMaterialResource(UsdPrim const &prim,
                                                      SdfPath const &cachePath,
                                                      UsdTimeCode time) const
{
  if (!_IsMaterialPath(cachePath)) {
  ...
  SdfAssetPath path(UsdApolloPackageDrawModeShader());
  ...
  if (model) {
    ...
    for (int i = 0; i < 6; ++i) {
      ...
      if (!textureFile.GetAssetPath().empty()) {
        ...
        /**
         * Insert connection between texture node and
...
void UsdApolloDrawModeAdapter::_CheckForTextureVariability(UsdPrim const &prim,
    ...
    UsdImagingInstancerContext const *instancerContext) const
{
  ...
  /**
   * We compute all of the below items together,
   * since their derivations aren't easily separable. */
...
HdDirtyBits UsdApolloDrawModeAdapter::ProcessPropertyChange(UsdPrim const &prim,
                                                            SdfPath const &cachePath,
...
void UsdApolloDrawModeAdapter::_GenerateOriginGeometry(VtValue *topo,
                                                       VtValue *points,
...
void UsdApolloDrawModeAdapter::_GenerateBoundsGeometry(VtValue *topo,
                                                       VtValue *points,
                                                       GfRange3d const &extents) const
{
  /**
...
void UsdApolloDrawModeAdapter::_GenerateCardsCrossGeometry(VtValue *topo,
                                                           VtValue *points,
...
void UsdApolloDrawModeAdapter::_SanityCheckFaceSizes(SdfPath const &cachePath,
                                                     GfRange3d const &extents,
                                                     uint8_t axes_mask) const
{
...
void UsdApolloDrawModeAdapter::_GenerateCardsBoxGeometry(VtValue *topo,
                                                         VtValue *points,
                                                         GfRange3d const &extents,
                                                         uint8_t axes_mask) const
{
...
void UsdApolloDrawModeAdapter::_GenerateCardsFromTextureGeometry(VtValue *topo,
                                                                 VtValue *points,
                                                                 VtValue *uv,
                                                                 VtValue *assign,
                                                                 GfRange3d *extents,
...
void UsdApolloDrawModeAdapter::_GenerateTextureCoordinates(VtValue *uv,
                                                           VtValue *assign,
                                                           uint8_t axes_mask) const
{
  /**
...
/*virtual*/
HdCullStyle UsdApolloDrawModeAdapter::GetCullStyle(UsdPrim const &prim,
                                                   SdfPath const &cachePath,
                                                   UsdTimeCode time) const
{
...
/*virtual*/
GfMatrix4d UsdApolloDrawModeAdapter::GetTransform(UsdPrim const &prim,
                                                  SdfPath const &cachePath,
                                                  UsdTimeCode time,
