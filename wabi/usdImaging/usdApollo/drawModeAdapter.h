...
#ifndef WABI_USD_IMAGING_USD_APOLLO_DRAW_MODE_ADAPTER_H
#define WABI_USD_IMAGING_USD_APOLLO_DRAW_MODE_ADAPTER_H
...
/**
 * @class UsdApolloDrawModeAdapter
 *
 * Delegate support for the drawMode attribute on UsdGeomModelAPI. */

class UsdApolloDrawModeAdapter : public UsdImagingPrimAdapter
{
 ...
 public:
  ...
  USDAPOLLO_API
  UsdApolloDrawModeAdapter();

  USDAPOLLO_API
  ~UsdApolloDrawModeAdapter() override;
 ...
 private:
  ...
  GfRange3d _ComputeExtent(UsdPrim const &prim, const UsdTimeCode &timecode) const;

  /**
   * Generate geometry for "origin" draw mode. */
  void _GenerateOriginGeometry(VtValue *topo, VtValue *points, GfRange3d const &extents) const;

  /**
   * Generate geometry for "bounds" draw mode. */
  void _GenerateBoundsGeometry(VtValue *topo, VtValue *points, GfRange3d const &extents) const;

  /**
   * Generate geometry for "cards" draw mode, with cardGeometry "cross". */
  void _GenerateCardsCrossGeometry(VtValue *topo,
                                   VtValue *points,
                                   GfRange3d const &extents,
                                   uint8_t axes_mask) const;
  ...
  void _GenerateCardsBoxGeometry(VtValue *topo,
                                 VtValue *points,
                                 GfRange3d const &extents,
                                 uint8_t axes_mask) const;
  ...
  void _GenerateCardsFromTextureGeometry(VtValue *topo,
                                         VtValue *points,
                                         VtValue *uv,
                                         VtValue *assign,
                                         GfRange3d *extents,
