 ...
 */
#ifndef WABI_USD_IMAGING_USD_IMAGING_GL_UNIT_TEST_GLDRAWING_H
#define WABI_USD_IMAGING_USD_IMAGING_GL_UNIT_TEST_GLDRAWING_H
...
class UsdImagingGL_UnitTestGLDrawing {
 public:
  ...
  bool IsEnabledTestLighting() const
  {
    return _testLighting;
  }
  bool IsEnabledSceneLights() const
  {
    return _sceneLights;
  }
  bool IsEnabledCameraLight() const
  {
    return _cameraLight;
  }
  bool IsEnabledIdRender() const
  {
    return _testIdRender;
  }
  ...
  bool IsShowRender() const
  {
    return _showRender;
  }
  bool IsShowProxy() const
  {
    return _showProxy;
  }
  bool ShouldClearOnce() const
  {
    return _clearOnce;
  }
  bool PresentDisabled() const
  {
    return _presentDisabled;
  }

  UsdImagingGLDrawMode GetDrawMode() const
  {
    return _drawMode;
  }

  std::string const &GetStageFilePath() const
  {
    return _stageFilePath;
  }
  std::string const &GetOutputFilePath() const
  {
    return _outputFilePath;
  }

  std::string const &GetCameraPath() const
  {
    return _cameraPath;
  }
  ...
  GfVec4f const &GetClearColor() const
  {
    return _clearColor;
  }
  GfVec3f const &GetTranslate() const
  {
    return _translate;
  }
  VtDictionary const &GetRenderSettings() const
  {
    return _renderSettings;
  }
  TfToken const &GetRendererAov() const
  {
    return _rendererAov;
  }
  std::string const &GetPerfStatsFile() const
  {
    return _perfStatsFile;
  }
  float GetPixelAspectRatio() const
  {
    return _pixelAspectRatio;
  }
  GfRange2f const &GetDisplayWindow() const
  {
    return _displayWindow;
  }
  GfRect2i const &GetDataWindow() const
  {
    return _dataWindow;
  }
  UsdImagingGLCullStyle GetCullStyle() const
  {
    return _cullStyle;
  }
 ...
 protected:
  ...
  bool _ShouldFrameAll() const
  {
    return _shouldFrameAll;
  }
  TfToken _GetRenderer() const
  {
    return _renderer;
  }
  ...
  void _Render(UsdImagingGLEngine *engine, const UsdImagingGLRenderParams &params)
  {
...
#endif  // WABI_USD_IMAGING_USD_IMAGING_GL_UNIT_TEST_GLDRAWING_H
