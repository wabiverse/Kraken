...
{
  {
    scope engineScope = class_<UsdImagingGLEngine, boost::noncopyable>("Engine", "UsdImaging Renderer class")
                          .def(init<>())
  ...
  TfPyContainerConversions::from_python_sequence<std::vector<GlfSimpleLight>,
