 ...
 */
#ifndef WABI_BASE_ARCH_STACK_TRACE_H
#define WABI_BASE_ARCH_STACK_TRACE_H
...
ARCH_API
void ArchPrintStackFrames(std::ostream &out, const std::vector<uintptr_t> &frames);
...
#endif  // WABI_BASE_ARCH_STACK_TRACE_H
