...
struct _ArenaManager {
  ...
  inline tbb::task_arena *CheckOut()
  {
  ...
  inline void Return(tbb::task_arena *arena)
  {
...
_ArenaManager &GetTheArenaManager()
{
...
void WorkArenaDispatcher::Cancel()
{
...
tbb::task_arena *WorkArenaDispatcher::_GetArena() const
{
