...
static GfHalf NormalizeHelper(GfVec3h *vec, GfHalf eps = 0.001)
{
...
static bool OrthogonalizeBasisHelper(GfVec3h *v1,
                                     GfVec3h *v2,
                                     GfVec3h *v3,
                                     bool normalize,
...
static tuple BuildOrthonormalFrameHelper(const GfVec3h &self, double eps = 0.001)
{
  GfVec3h v1, v2;
...
static int __len__(const GfVec3h &self)
{
  return 3;
}
...
#if PY_MAJOR_VERSION == 2
static GfVec3h __truediv__(const GfVec3h &self, GfHalf value)
{
  return self / value;
}

static GfVec3h __itruediv__(GfVec3h &self, GfHalf value)
{
  return self /= value;
}
#endif
...
struct FromPythonTuple
{
  FromPythonTuple()
  {
    converter::registry::push_back(&_convertible, &_construct, boost::python::type_id<GfVec3h>());
  }
 ...
 private:
  ...
  {
    typedef GfHalf Scalar;
    void *storage = ((converter::rvalue_from_python_storage<GfVec3h> *)data)->storage.bytes;
    new (storage)
      GfVec3h(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1), _SequenceGetItem(obj_ptr, 2));
...
void wrapVec3h()
{
  ...
  to_python_converter<std::vector<GfVec3h>, TfPySequenceToPython<std::vector<GfVec3h>>>();
  ...
  TfPyContainerConversions::from_python_sequence<std::vector<GfVec3h>,
