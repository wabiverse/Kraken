...
void GfFrustum::SetPerspective(double fieldOfViewHeight,
                               double aspectRatio,
                               double nearDistance,
                               double farDistance)
{
...
void GfFrustum::SetPerspective(double fieldOfView,
                               bool isFovVertical,
                               double aspectRatio,
                               double nearDistance,
                               double farDistance)
...
bool GfFrustum::GetPerspective(bool isFovVertical,
                               double *fieldOfView,
                               double *aspectRatio,
                               double *nearDistance,
                               double *farDistance) const
...
double GfFrustum::GetFOV(bool isFovVertical /* = false */)
{
  double result = 0.0;
...
void GfFrustum::SetOrthographic(double left,
                                double right,
                                double bottom,
                                double top,
                                double nearPlane,
...
bool GfFrustum::GetOrthographic(double *left,
                                double *right,
                                double *bottom,
                                double *top,
                                double *nearPlane,
...
GfFrustum GfFrustum::ComputeNarrowedFrustum(const GfVec2d &point, const GfVec2d &halfSize) const
{
  ...
  GfVec2d windowPoint = _window.GetMin() + GfCompMult(scaledPoint, _window.GetSize());
...
static double _Rescale(double in, double inA, double inB, double outA, double outB)
{
...
GfRay GfFrustum::_ComputePickRayOffsetToNearPlane(const GfVec3d &camSpaceFrom,
...
bool GfFrustum::_SegmentIntersects(GfVec3d const &p0,
                                   uint32_t p0Mask,
                                   GfVec3d const &p1,
