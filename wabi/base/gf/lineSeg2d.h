 ...
 */
#ifndef WABI_BASE_GF_LINE_SEG2D_H
#define WABI_BASE_GF_LINE_SEG2D_H

/// \file gf/lineSeg2d.h
/// \ingroup group_gf_BasicGeometry

#include "wabi/base/gf/api.h"
#include "wabi/base/gf/line2d.h"
...
class GfLineSeg2d
{
 ...
 private:
  ...
  GF_API
  friend bool GfFindClosestPoints(const GfLine2d &,
                                  const GfLineSeg2d &,
                                  GfVec2d *,
                                  GfVec2d *,
                                  double *t1,
                                  double *t2);
  GF_API
  friend bool GfFindClosestPoints(const GfLineSeg2d &,
                                  const GfLineSeg2d &,
                                  GfVec2d *,
                                  GfVec2d *,
                                  double *,
...
#endif  // WABI_BASE_GF_LINE_SEG2D_H
