...
static int __len__(const GfVec3i &self)
{
  return 3;
}
...
struct FromPythonTuple {
 ...
 private:
  ...
  {
    typedef int Scalar;
    void *storage = ((converter::rvalue_from_python_storage<GfVec3i> *)data)->storage.bytes;
    new (storage)
      GfVec3i(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1), _SequenceGetItem(obj_ptr, 2));
...
void wrapVec3i()
{
  ...
  to_python_converter<std::vector<GfVec3i>, TfPySequenceToPython<std::vector<GfVec3i>>>();
  ...
  TfPyContainerConversions::from_python_sequence<std::vector<GfVec3i>,
