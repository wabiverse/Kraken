...
namespace
{
  ...
  {
    static char newline[] = ",\n            ";
    return TF_PY_REPR_PREFIX + "Matrix3f(" + TfPyRepr(self[0][0]) + ", " + TfPyRepr(self[0][1]) + ", " +
...
#if PY_MAJOR_VERSION == 2
  static GfMatrix3f __truediv__(const GfMatrix3f &self, GfMatrix3f value)
  {
    return self / value;
  }
#endif
  ...
  static size_t __hash__(GfMatrix3f const &m)
  {
    return hash_value(m);
  }
...
void wrapMatrix3f()
{
  ...
  def("IsClose", (bool (*)(const GfMatrix3f &m1, const GfMatrix3f &m2, double))GfIsClose);

  class_<This> cls("Matrix3f", no_init);
  cls.def_pickle(GfMatrix3f_Pickle_Suite())
    ...
    .def("Set",
         (This & (This::*)(float, float, float, float, float, float, float, float, float)) & This::Set,
         return_self<>())
    ...
    .def("SetDiagonal", (This & (This::*)(const GfVec3f &)) & This::SetDiagonal, return_self<>())
