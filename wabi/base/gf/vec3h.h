...
#ifndef WABI_BASE_GF_VEC3H_H
#define WABI_BASE_GF_VEC3H_H
...
class GfVec3h
{
 public:
  ...
  /// will return false.
  GF_API
  static bool OrthogonalizeBasis(GfVec3h *tx,
                                 GfVec3h *ty,
                                 GfVec3h *tz,
...
{
  return GfVec3h(v1[1] * v2[2] - v1[2] * v2[1],
                 v1[2] * v2[0] - v1[0] * v2[2],
                 v1[0] * v2[1] - v1[1] * v2[0]);
}
