...
{ % block classDocs % }  /// <h3>3D Transformations</h3>
                         ...
                         /// interpret a {{ MAT }} as a 3D transformation. By convention, vectors
...
{ % block customConstructors % }  /// Constructor. Initialize matrix from rotation.
GF_API{{MAT}}(const GfRotation &rot);
