...
#ifndef WABI_BASE_GF_VEC4F_H
#define WABI_BASE_GF_VEC4F_H
...
template<> struct GfIsGfVec<class GfVec4f> {
...
class GfVec4f {
 public:
  ...
  template<class Scl> constexpr explicit GfVec4f(Scl const *p) : _data{p[0], p[1], p[2], p[3]}
  {}
