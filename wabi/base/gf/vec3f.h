...
#ifndef WABI_BASE_GF_VEC3F_H
#define WABI_BASE_GF_VEC3F_H
...
class GfVec3f
{
 public:
  ...
  /// will return false.
  GF_API
  static bool OrthogonalizeBasis(GfVec3f *tx,
                                 GfVec3f *ty,
                                 GfVec3f *tz,
...
GF_API bool GfOrthogonalizeBasis(GfVec3f *tx,
                                 GfVec3f *ty,
                                 GfVec3f *tz,
                                 bool normalize,
                                 double eps = GF_MIN_ORTHO_TOLERANCE);

GF_API void GfBuildOrthonormalFrame(GfVec3f const &v0,
                                    GfVec3f *v1,
                                    GfVec3f *v2,
...
{
  return GfVec3f(v1[1] * v2[2] - v1[2] * v2[1],
                 v1[2] * v2[0] - v1[0] * v2[2],
                 v1[0] * v2[1] - v1[1] * v2[0]);
}
