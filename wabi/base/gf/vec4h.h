...
#ifndef WABI_BASE_GF_VEC4H_H
#define WABI_BASE_GF_VEC4H_H
...
template<> struct GfIsGfVec<class GfVec4h>
{
...
class GfVec4h
{
 public:
  ...
  template<class Scl> constexpr explicit GfVec4h(Scl const *p) : _data{p[0], p[1], p[2], p[3]} {}
