...
#ifndef WABI_BASE_GF_VEC4I_H
#define WABI_BASE_GF_VEC4I_H
...
template<> struct GfIsGfVec<class GfVec4i>
{
...
class GfVec4i
{
 public:
  ...
  template<class Scl> constexpr explicit GfVec4i(Scl const *p) : _data{p[0], p[1], p[2], p[3]} {}
