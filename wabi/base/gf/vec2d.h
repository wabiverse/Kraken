...
#ifndef WABI_BASE_GF_VEC2D_H
#define WABI_BASE_GF_VEC2D_H
...
template<> struct GfIsGfVec<class GfVec2d>
{
...
class GfVec2d
{
 public:
  ...
  template<class Scl> constexpr explicit GfVec2d(Scl const *p) : _data{p[0], p[1]} {}
