...
static int __len__(const GfVec4i &self)
{
  return 4;
}
...
struct FromPythonTuple {
 ...
 private:
  ...
  {
    typedef int Scalar;
    void *storage = ((converter::rvalue_from_python_storage<GfVec4i> *)data)->storage.bytes;
    new (storage) GfVec4i(_SequenceGetItem(obj_ptr, 0),
...
void wrapVec4i()
{
  ...
  to_python_converter<std::vector<GfVec4i>, TfPySequenceToPython<std::vector<GfVec4i>>>();
