 ...
 */
#ifndef WABI_BASE_GF_LINE_SEG_H
#define WABI_BASE_GF_LINE_SEG_H

/// \file gf/lineSeg.h
/// \ingroup group_gf_BasicGeometry

#include "wabi/base/gf/api.h"
#include "wabi/base/gf/line.h"
...
class GfLineSeg {
 ...
 private:
  ...
  friend bool GfFindClosestPoints(const GfLine &,
                                  ...
                                  double *);
  GF_API
  friend bool GfFindClosestPoints(const GfLineSeg &,
                                  const GfLineSeg &,
                                  GfVec3d *,
                                  GfVec3d *,
                                  double *,
