...
#ifndef WABI_BASE_TRACE_TRACE_H
#define WABI_BASE_TRACE_TRACE_H
...
#  define _TRACE_FUNCTION_DYNAMIC_INSTANCE(instance, fnName, fnPrettyName, name) \
    WABI_NS::TraceAuto TF_PP_CAT(TraceAuto_, instance)(fnName, fnPrettyName, name)
...
struct TraceAuto {
 ...
 private:
  static std::string _CreateKeyString(const char *funcName,
