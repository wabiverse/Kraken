...
#ifndef WABI_BASE_TRACE_REPORTER_DATA_SOURCE_COLLECTION_H
#define WABI_BASE_TRACE_REPORTER_DATA_SOURCE_COLLECTION_H
...
#endif  // WABI_BASE_TRACE_REPORTER_DATA_SOURCE_COLLECTION_H