...
#ifndef WABI_BASE_TRACE_COLLECTOR_H
#define WABI_BASE_TRACE_COLLECTOR_H

#include "wabi/wabi.h"

#include "wabi/base/trace/api.h"
#include "wabi/base/trace/collection.h"
#include "wabi/base/trace/concurrentList.h"
#include "wabi/base/trace/event.h"
#include "wabi/base/trace/key.h"
...
class TraceCollector : public TfWeakBase
{
 public:
  ...
  void Scope(const TraceKey &key, TimeStamp start)
  {
    ...
    _PerThreadData *threadData = _GetThreadData();
    threadData->EmplaceEvent(TraceEvent::Timespan, key, start, Category::GetId());
  }
 ...
 private:
  ...
  void _StoreDataRec(_PerThreadData *threadData,
                     TraceCategoryId cat,
                     K &&key,
                     const T &value,
                     Args &&... args)
...
#endif  // WABI_BASE_TRACE_COLLECTOR_H
