...
#define VTOPERATOR_WRAP_PYTYPE(op, lmethod, tuple, T) \
  VTOPERATOR_WRAP_PYTYPE_BASE(op, lmethod, tuple, T, (vec[i] op(T) extract<T>(obj[i])))

// wrap pytype op Array (for noncommutative ops like subtraction)
#define VTOPERATOR_WRAP_PYTYPE_R(op, lmethod, tuple, T) \
  VTOPERATOR_WRAP_PYTYPE_BASE(op, lmethod, tuple, T, ((T)extract<T>(obj[i]) op vec[i]))
...
#define VTOPERATOR_WRAPDECLARE_BOOL(func)                                                     \
  def(#func, (VtArray<bool>(*)(VtArray<Type> const &, VtArray<Type> const &))Vt##func<Type>); \
  def(#func, (VtArray<bool>(*)(Type const &, VtArray<Type> const &))Vt##func<Type>);          \
  def(#func, (VtArray<bool>(*)(VtArray<Type> const &, Type const &))Vt##func<Type>);          \
  def(#func, (VtArray<bool>(*)(VtArray<Type> const &, tuple const &))Vt##func<Type>);         \
  def(#func, (VtArray<bool>(*)(tuple const &, VtArray<Type> const &))Vt##func<Type>);         \
  def(#func, (VtArray<bool>(*)(VtArray<Type> const &, list const &))Vt##func<Type>);          \
  def(#func, (VtArray<bool>(*)(list const &, VtArray<Type> const &))Vt##func<Type>);
