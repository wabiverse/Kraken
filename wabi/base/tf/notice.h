...
//
#ifndef WABI_BASE_TF_NOTICE_H
#define WABI_BASE_TF_NOTICE_H
...
class TfNotice
{
 private:
                                        ...
                                        SPtr const &sender)
  {
    ...
    return new _DelivererWithSender<LPtr,
                                    DeliveredSPtr,
  ...
  static _DelivererBase *_MakeDeliverer(LPtr const &listener,
                                        ...
                                        SPtr const &sender)
  {
    return new _Deliverer<LPtr, SPtr, void (L::*)(const Notice &), Notice>(listener,
                                                                           method,
                                                                           sender);
  }
  ...
  static _DelivererBase *_MakeDeliverer(LPtr const &listener,
                                        ...
                                        SPtr const &sender)
  {
    return new _Deliverer<LPtr, SPtr, void (L::*)(const Notice &) const, Notice>(listener,
                                                                                 method,
                                                                                 sender);
  }
                                        ...
                                        TfAnyWeakPtr const &sender)
  {
    return new _RawDeliverer<LPtr,
                             void (L::*)(const TfNotice &,
                                         const TfType &,
                                         TfWeakBase *,
                                         const void *,
                                         const std::type_info &)>(listener,
                                                                  method,
                                                                  sender,
                                                                  noticeType);
  }
...
template<typename SenderPtr> size_t TfNotice::Send(SenderPtr const &s) const
{
  ...
  return _Send(senderWeakBase,
               senderWeakBase ? s.GetUniqueIdentifier() : 0,
               senderWeakBase ? typeid(typename SenderPtr::DataType) : typeid(void));
}

WABI_NAMESPACE_END

#endif  // WABI_BASE_TF_NOTICE_H
