...
//
#ifndef WABI_BASE_TF_DIAGNOSTIC_MGR_H
#define WABI_BASE_TF_DIAGNOSTIC_MGR_H
...
class TfDiagnosticMgr : public TfWeakBase
{
 public:
  ...
  TF_API
  void PostFatal(TfCallContext const &context, TfEnum statusCode, std::string const &msg) const;
...
#endif  // WABI_BASE_TF_DIAGNOSTIC_MGR_H
