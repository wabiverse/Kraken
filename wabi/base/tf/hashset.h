...
#ifndef WABI_BASE_TF_HASHSET_H
#define WABI_BASE_TF_HASHSET_H
...
#    define USE_DEPRECATED_GNU_HASH_SET
...
#if !defined(USE_DEPRECATED_GNU_HASH_SET)
...
#else /* USE_DEPRECATED_GNU_HASH_SET */
...
template<class Key, class HashFn, class EqualKey, class Alloc>
inline void swap(TfHashMultiSet<Key, HashFn, EqualKey, Alloc> &lhs,
