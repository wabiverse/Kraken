...
#  ifndef WABI_BASE_TF_MAKE_PY_CONSTRUCTOR_H
#    define WABI_BASE_TF_MAKE_PY_CONSTRUCTOR_H
  ...
  const std::string &doc = std::string())
{
  ...
  return Tf_MakePyConstructor::InitVisitor<Tf_MakePyConstructor::InitCtor<T>>(doc);
}

template<typename T>
Tf_MakePyConstructor::InitVisitor<typename Tf_MakePyConstructor::InitCtorWithBackReference<T>>
...
template<typename T>
Tf_MakePyConstructor::InitVisitor<typename Tf_MakePyConstructor::InitCtorWithVarArgs<T>>
TfMakePyConstructorWithVarArgs(T *func, const std::string &doc = std::string())
{
  ...
  return Tf_MakePyConstructor::InitVisitor<Tf_MakePyConstructor::InitCtorWithVarArgs<T>>(doc);
}
  ...
  const std::string &doc = std::string())
{
  ...
  return Tf_MakePyConstructor::NewVisitor<Tf_MakePyConstructor::NewCtor<T>>(doc);
}

template<typename T>
Tf_MakePyConstructor::NewVisitor<typename Tf_MakePyConstructor::NewCtorWithClassReference<T>>
...
#  endif  // WABI_BASE_TF_MAKE_PY_CONSTRUCTOR_H
...
#  define VAR_SIGNATURE \
    R(BOOST_PP_ENUM_PARAMS(N, A) BOOST_PP_COMMA_IF(N) const bp::tuple &, const bp::dict &)
...
struct InitCtorWithVarArgs<VAR_SIGNATURE> : CtorBase<VAR_SIGNATURE>
{
  ...
  static bp::object init_callable(Options &options)
  {
    ...
    return bp::raw_function(bp::make_function(__init__<CLS>, options.policies()),
                            /* min_args = */ 1);
  }
