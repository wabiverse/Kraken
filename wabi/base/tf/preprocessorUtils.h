 ...
 */
#ifndef WABI_BASE_TF_PREPROCESSOR_UTILS_H
#define WABI_BASE_TF_PREPROCESSOR_UTILS_H
...
#  define _TF_NUM_ARGS_CHECK(...) \
    BOOST_PP_IIF( \
        _TF_EXPAND(TF_ARG_2 BOOST_PP_LPAREN() BOOST_PP_CAT( \
            _TF_NUM_ARGS_00, \
...
/// \hideinitializer
#if defined(ARCH_COMPILER_MSVC)
#  define TF_PP_IS_TUPLE(sequence) BOOST_VMD_IS_TUPLE(sequence)
#else
...
/// \ingroup group_tf_Preprocessor
/// \hideinitializer
#define TF_PP_TUPLE_SIZE(tuple) BOOST_PP_EXPAND(TF_NUM_ARGS tuple)
...
/// \ingroup group_tf_Preprocessor
/// \hideinitializer
#define TF_MAKE_PP_ARRAY(...) (TF_NUM_ARGS(__VA_ARGS__), (__VA_ARGS__))

/// Create a preprocessor list.
/// \ingroup group_tf_Preprocessor
/// \hideinitializer
#define TF_MAKE_PP_LIST(...) TF_PP_TUPLE_TO_LIST((__VA_ARGS__))

/// Create a preprocessor sequence.
/// \ingroup group_tf_Preprocessor
/// \hideinitializer
#define TF_MAKE_PP_SEQ(...) TF_PP_TUPLE_TO_SEQ((__VA_ARGS__))
...
#endif /* WABI_BASE_TF_PREPROCESSOR_UTILS_H */
