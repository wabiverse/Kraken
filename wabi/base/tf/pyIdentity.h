...
//
#ifndef WABI_BASE_TF_PY_IDENTITY_H
#define WABI_BASE_TF_PY_IDENTITY_H
...
// TfWeakPtrFacade
template<template<class> class X, class Y> struct pointee<WABI_NS::TfWeakPtrFacade<X, Y>> {
  typedef Y type;
};

// TfRefPtr
template<typename T> struct pointee<WABI_NS::TfRefPtr<T>> {
  typedef T type;
};
...
#endif  // WABI_BASE_TF_PY_IDENTITY_H
