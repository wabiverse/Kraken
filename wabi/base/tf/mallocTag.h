...
//
#ifndef WABI_BASE_TF_MALLOC_TAG_H
#define WABI_BASE_TF_MALLOC_TAG_H
...
class TfMallocTag {
 ...
 private:
  ...
  static inline Tf_MallocPathNode *_GetCurrentPathNodeNoLock(const _ThreadData *threadData);
