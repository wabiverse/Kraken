...
class TfType {
 ...
 public:
  ...
  /// an associative map.
  inline bool operator==(const TfType &t) const
  {
 ...
 private:
  ...
  void _AddBases(const std::vector<TfType> &bases, std::vector<std::string> *errorToEmit) const;
...
#include "wabi/base/tf/type_Impl.h"

#endif  // WABI_BASE_TF_TYPE_H
