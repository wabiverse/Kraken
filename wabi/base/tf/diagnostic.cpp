...
TF_REGISTRY_FUNCTION(TfEnum)
{
  ...
  TF_ADD_ENUM_NAME(TF_DIAGNOSTIC_RUNTIME_MSG_TYPE, "Info");
  TF_ADD_ENUM_NAME(TF_DIAGNOSTIC_RUNTIME_ERROR_MSG_TYPE, "Error");
  TF_ADD_ENUM_NAME(TF_DIAGNOSTIC_RUNTIME_SUCCESS_MSG_TYPE, "Success");
...
#endif
{
...

  {
    ...
    ArchLogPostMortem(msg, /*message=*/nullptr, descStackReport.GetMessage());
  }
