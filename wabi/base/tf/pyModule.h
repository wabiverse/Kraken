...
//
extern "C" ARCH_EXPORT void BOOST_PP_CAT(init_, MFB_PACKAGE_NAME)()
{
  WABI_NAMESPACE_USING
  boost::python::detail::init_module(TF_PP_STRINGIZE(BOOST_PP_CAT(_, MFB_PACKAGE_NAME)),
...
//
extern "C" ARCH_EXPORT void BOOST_PP_CAT(initlib, MFB_PACKAGE_NAME)()
{
  WABI_NAMESPACE_USING
  boost::python::detail::init_module(TF_PP_STRINGIZE(BOOST_PP_CAT(lib, MFB_PACKAGE_NAME)),
                                     TF_PP_CAT(&init_module_, MFB_PACKAGE_NAME));
}
