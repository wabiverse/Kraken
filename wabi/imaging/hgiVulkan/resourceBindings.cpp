  ...
  std::string const &debugName)
{
  ...
  TF_VERIFY(vkCreateDescriptorSetLayout(device->GetVulkanDevice(),
                                        &setCreateInfo,
                                        HgiVulkanAllocator(),
                                        &layout) == VK_SUCCESS);
    ...
    _vkDescriptorSet(nullptr)
{
  ...
  TF_VERIFY(vkAllocateDescriptorSets(_device->GetVulkanDevice(),
                                     &allocateInfo,
...
{
  vkDestroyDescriptorSetLayout(_device->GetVulkanDevice(),
