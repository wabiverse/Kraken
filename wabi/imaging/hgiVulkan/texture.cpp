    ...
    _cpuStagingAddress(nullptr)
{
  ...
  if (!_CheckFormatSupport(device->GetVulkanPhysicalDevice(),
...
size_t HgiVulkanTexture::GetByteSizeOfResource() const
{
  return _GetByteSizeOfResource(_descriptor);
}

uint64_t HgiVulkanTexture::GetRawResource() const
{
...
bool HgiVulkanTexture::IsCPUStagingAddress(const void *address) const
{
  return (address == _cpuStagingAddress);
}

HgiVulkanBuffer *HgiVulkanTexture::GetStagingBuffer() const
{
  return _stagingBuffer;
}

VkImage HgiVulkanTexture::GetImage() const
{
  return _vkImage;
}

VkImageView HgiVulkanTexture::GetImageView() const
{
  return _vkImageView;
}

VkImageLayout HgiVulkanTexture::GetImageLayout() const
{
  return _vkImageLayout;
}

HgiVulkanDevice *HgiVulkanTexture::GetDevice() const
{
  return _device;
}

uint64_t &HgiVulkanTexture::GetInflightBits()
{
  return _inflightBits;
}

void HgiVulkanTexture::CopyBufferToTexture(HgiVulkanCommandBuffer *cb,
                                           ...
                                           int mipLevel)
{
  ...
  vkCmdCopyBufferToImage(cb->GetVulkanCommandBuffer(),
