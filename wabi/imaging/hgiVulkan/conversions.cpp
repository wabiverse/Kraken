...
static const uint32_t _StoreOpTable[HgiAttachmentStoreOpCount][2] = {
...
static const uint32_t _SampleCountTable[][2] = {{HgiSampleCount1, VK_SAMPLE_COUNT_1_BIT},
...
static const uint32_t _FormatFeatureTable[][2] = {
...
static const uint32_t _BufferUsageTable[][2] = {
...
static const uint32_t _PolygonModeTable[HgiPolygonModeCount][2] = {
...
static const uint32_t _WindingTable[HgiWindingCount][2] = {
...
static const uint32_t _BindResourceTypeTable[HgiBindResourceTypeCount][2] = {
...
static const uint32_t _blendEquationTable[HgiBlendOpCount][2] = {
...
static const uint32_t _blendFactorTable[HgiBlendFactorCount][2] = {
...
static const uint32_t _CompareOpTable[HgiCompareFunctionCount][2] = {
...
static const uint32_t _textureTypeTable[HgiTextureTypeCount][2] = {
...
static const uint32_t _textureViewTypeTable[HgiTextureTypeCount][2] = {
...
static const uint32_t _samplerAddressModeTable[HgiSamplerAddressModeCount][2] = {
...
static const uint32_t _samplerFilterTable[HgiSamplerFilterCount][2] = {
    {HgiSamplerFilterNearest, VK_FILTER_NEAREST},
    {HgiSamplerFilterLinear, VK_FILTER_LINEAR}};
static_assert(HgiSamplerFilterCount == 2, "");

static const uint32_t _mipFilterTable[HgiMipFilterCount][2] = {
...
VkAttachmentLoadOp HgiVulkanConversions::GetLoadOp(HgiAttachmentLoadOp op)
{
  return VkAttachmentLoadOp(_LoadOpTable[op][1]);
}

VkAttachmentStoreOp HgiVulkanConversions::GetStoreOp(HgiAttachmentStoreOp op)
{
...
VkCullModeFlags HgiVulkanConversions::GetCullMode(HgiCullMode cm)
{
  return VkCullModeFlags(_CullModeTable[cm][1]);
}

VkPolygonMode HgiVulkanConversions::GetPolygonMode(HgiPolygonMode pm)
{
  return VkPolygonMode(_PolygonModeTable[pm][1]);
}

VkFrontFace HgiVulkanConversions::GetWinding(HgiWinding wd)
{
  return VkFrontFace(_WindingTable[wd][1]);
}

VkDescriptorType HgiVulkanConversions::GetDescriptorType(HgiBindResourceType rt)
{
  return VkDescriptorType(_BindResourceTypeTable[rt][1]);
}

VkBlendFactor HgiVulkanConversions::GetBlendFactor(HgiBlendFactor bf)
{
  return VkBlendFactor(_blendFactorTable[bf][1]);
}

VkBlendOp HgiVulkanConversions::GetBlendEquation(HgiBlendOp bo)
{
  return VkBlendOp(_blendEquationTable[bo][1]);
}

VkCompareOp HgiVulkanConversions::GetDepthCompareFunction(HgiCompareFunction cf)
{
  return VkCompareOp(_CompareOpTable[cf][1]);
}

VkImageType HgiVulkanConversions::GetTextureType(HgiTextureType tt)
{
  return VkImageType(_textureTypeTable[tt][1]);
}

VkImageViewType HgiVulkanConversions::GetTextureViewType(HgiTextureType tt)
{
  return VkImageViewType(_textureViewTypeTable[tt][1]);
}

VkSamplerAddressMode HgiVulkanConversions::GetSamplerAddressMode(HgiSamplerAddressMode a)
{
  return VkSamplerAddressMode(_samplerAddressModeTable[a][1]);
}

VkFilter HgiVulkanConversions::GetMinMagFilter(HgiSamplerFilter mf)
{
  return VkFilter(_samplerFilterTable[mf][1]);
}

VkSamplerMipmapMode HgiVulkanConversions::GetMipFilter(HgiMipFilter mf)
{
