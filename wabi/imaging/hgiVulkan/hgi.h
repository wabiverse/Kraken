 ...
 */
#ifndef WABI_IMAGING_HGIVULKAN_HGI_H
#define WABI_IMAGING_HGIVULKAN_HGI_H
...
class HgiVulkan final : public Hgi
{
 public:
  ...
  /**
   * Allows client applications to set their own Vulkan
   * instance. This also ensures HgiVulkan and the client
   * application share the same underlying Vulkan Instance.
   *
   * @param existingInst pointer to a HgiVulkan Instance. */
  HGIVULKAN_API
  HgiVulkan(HgiVulkanInstance *existingInst);
