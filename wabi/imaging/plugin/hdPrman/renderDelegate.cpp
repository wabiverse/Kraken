...
#include "wabi/imaging/plugin/hdPrman/basisCurves.h"
...
#include "wabi/imaging/plugin/hdPrman/lightFilter.h"
#include "wabi/imaging/plugin/hdPrman/material.h"
#include "wabi/imaging/plugin/hdPrman/mesh.h"
#include "wabi/imaging/plugin/hdPrman/points.h"
...
void HdPrmanRenderDelegate::_Initialize()
{
  ...
  // to path tracing
  _settingDescriptors[2] = {std::string("Interactive Integrator Timeout (ms)"),
...
void HdPrmanRenderDelegate::CommitResources(HdChangeTracker *tracker)
{
  // Do nothing
}
...
void HdPrmanRenderDelegate::DestroyInstancer(HdInstancer *instancer)
{
  delete instancer;
}
...
void HdPrmanRenderDelegate::DestroyRprim(HdRprim *rPrim)
{
  delete rPrim;
}
...
void HdPrmanRenderDelegate::DestroyBprim(HdBprim *bPrim)
{
  delete bPrim;
}
...
void HdPrmanRenderDelegate::SetRenderSetting(TfToken const &key, VtValue const &value)
{
