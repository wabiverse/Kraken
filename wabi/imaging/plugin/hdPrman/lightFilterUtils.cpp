...
TF_DEFINE_PRIVATE_TOKENS(
  ...
  ((analyticApex, "inputs:analytic:apex"))((analyticDensityExponent, "inputs:analytic:density:exponent"))((analyticDensityFarDistance, "inputs:analytic:density:farDistance"))((analyticDensityFarValue, "inputs:analytic:density:farValue"))((analyticDensityNearDistance, "inputs:analytic:density:nearDistance"))((analyticDensityNearValue, "inputs:analytic:density:nearValue"))((analyticDirectional, "inputs:analytic:directional"))((analyticShearX, "inputs:analytic:shearX"))((analyticShearY, "inputs:analytic:shearY"))((analyticUseLightDirection, "inputs:analytic:useLightDirection"))((barnMode, "inputs:barnMode"))((colorRampColors, "inputs:colorRamp:colors"))((colorRampInterpolation, "inputs:colorRamp:interpolation"))((colorRampKnots, "inputs:colorRamp:knots"))((colorSaturation, "inputs:color:saturation"))((depth, "inputs:depth"))((edgeScaleBack, "inputs:edgeScale:back"))((edgeScaleBottom, "inputs:edgeScale:bottom"))((edgeScaleFront, "inputs:edgeScale:front"))((edgeScaleLeft, "inputs:edgeScale:left"))((edgeScaleRight, "inputs:edgeScale:right"))((edgeScaleTop, "inputs:edgeScale:top"))((edgeThickness, "inputs:edgeThickness"))((falloffFloats, "inputs:falloff:floats"))((falloffInterpolation, "inputs:falloff:interpolation"))((falloffKnots, "inputs:falloff:knots"))((height, "inputs:height"))((preBarnEffect, "inputs:preBarnEffect"))((radius, "inputs:radius"))((refineBack, "inputs:refine:back"))((refineBottom, "inputs:refine:bottom"))((refineFront, "inputs:refine:front"))((refineLeft, "inputs:refine:left"))((refineRight, "inputs:refine:right"))((refineTop, "inputs:refine:top"))((riCombineMode, "inputs:ri:combineMode"))((riDensity, "inputs:ri:density"))((riDiffuse, "inputs:ri:diffuse"))((riExposure, "inputs:ri:exposure"))((riIntensity, "inputs:ri:intensity"))((riInvert, "inputs:ri:invert"))((riSpecular, "inputs:ri:specular"))((scaleDepth, "inputs:scale:depth"))((scaleHeight, "inputs:scale:height"))((scaleWidth, "inputs:scale:width"))((width, "inputs:width"))

    (analytic)(cone)(noEffect)(noLight)(physical)

      (PxrIntMultLightFilter)(PxrBarnLightFilter)(PxrRodLightFilter));
