...
HdPrman_BasisCurves::HdPrman_BasisCurves(SdfPath const &id) : BASE(id)
{}
...
RtParamList HdPrman_BasisCurves::_ConvertGeometry(HdPrman_Context *context,
                                                  ...
                                                  std::vector<HdGeomSubset> *geomSubsets)
{
  ...
  *primType = RixStr.k_Ri_Curves;
  ...
  RtParamList primvars(numCurves,           /* uniform */
  ...
  primvars.SetIntegerDetail(RixStr.k_Ri_nvertices, nverticesData, RtDetailType::k_uniform);
  // Points
