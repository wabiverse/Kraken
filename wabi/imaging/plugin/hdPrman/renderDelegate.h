...
//
#ifndef EXT_RMANPKG_23_0_PLUGIN_RENDERMAN_PLUGIN_HD_PRMAN_RENDER_DELEGATE_H
#define EXT_RMANPKG_23_0_PLUGIN_RENDERMAN_PLUGIN_HD_PRMAN_RENDER_DELEGATE_H
...
class HdPrmanRenderDelegate : public HdRenderDelegate
{
 public:
  ...
  HDPRMAN_API virtual const TfTokenVector &GetSupportedRprimTypes() const override;
  HDPRMAN_API virtual const TfTokenVector &GetSupportedSprimTypes() const override;
  HDPRMAN_API virtual const TfTokenVector &GetSupportedBprimTypes() const override;
  HDPRMAN_API virtual HdResourceRegistrySharedPtr GetResourceRegistry() const override;

  /// Returns a list of user-configurable render settings.
  HDPRMAN_API virtual HdRenderSettingDescriptorList GetRenderSettingDescriptors() const override;
  ...
  HDPRMAN_API virtual HdSprim *CreateSprim(TfToken const &typeId, SdfPath const &sprimId) override;
  HDPRMAN_API virtual HdSprim *CreateFallbackSprim(TfToken const &typeId) override;
  HDPRMAN_API virtual void DestroySprim(HdSprim *sPrim) override;
  HDPRMAN_API virtual HdBprim *CreateBprim(TfToken const &typeId, SdfPath const &bprimId) override;
  HDPRMAN_API virtual HdBprim *CreateFallbackBprim(TfToken const &typeId) override;
...
#endif  // EXT_RMANPKG_23_0_PLUGIN_RENDERMAN_PLUGIN_HD_PRMAN_RENDER_DELEGATE_H
