...
TF_DEFINE_ENV_SETTING(HDARNOLD_log_flags_console,
                      -1,
                      "Override logging flags for console output, if non-negative.");

TF_DEFINE_ENV_SETTING(HDARNOLD_log_flags_file,
                      -1,
                      "Override logging flags for file output, if non-negative.");
...
TF_DEFINE_ENV_SETTING(HDARNOLD_progressive_min_AA_samples,
                      -4,
                      "Minimum AA samples for progressive rendering.");
...
TF_DEFINE_ENV_SETTING(HDARNOLD_interactive_target_fps,
                      "30.0",
                      "Interactive target fps for progressive rendering.");

TF_DEFINE_ENV_SETTING(HDARNOLD_interactive_target_fps_min,
                      "20.0",
...
{
  return TfSingleton<HdArnoldConfig>::GetInstance();
}
