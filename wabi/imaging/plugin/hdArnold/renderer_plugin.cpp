...
{
  HdRendererPluginRegistry::Define<HdArnoldRendererPlugin>();
}
...
void HdArnoldRendererPlugin::DeleteRenderDelegate(HdRenderDelegate *renderDelegate)
{
  delete renderDelegate;
}

bool HdArnoldRendererPlugin::IsSupported() const
{
  return true;
}
