 ...
 */
#include "wabi/imaging/plugin/hdEmbree/meshSamplers.h"
...
void HdEmbreeRTCBufferAllocator::Free(int bufferIndex)
{
  _bitset.reset(bufferIndex);
}

unsigned int HdEmbreeRTCBufferAllocator::NumBuffers()
{
...
bool HdEmbreeConstantSampler::Sample(unsigned int element,
                                     float u,
                                     float v,
                                     void *value,
...
bool HdEmbreeUniformSampler::Sample(unsigned int element,
                                    float u,
                                    float v,
                                    void *value,
                                    HdTupleType dataType) const
...
bool HdEmbreeTriangleVertexSampler::Sample(unsigned int element,
                                           float u,
                                           float v,
                                           void *value,
                                           HdTupleType dataType) const
...
bool HdEmbreeTriangleFaceVaryingSampler::Sample(unsigned int element,
                                                float u,
                                                float v,
                                                void *value,
                                                HdTupleType dataType) const
...
/* static */ VtValue HdEmbreeTriangleFaceVaryingSampler::_Triangulate(TfToken const &name,
                                                                      VtValue const &value,
                                                                      HdMeshUtil &meshUtil)
{
...
bool HdEmbreeSubdivVertexSampler::Sample(unsigned int element,
                                         float u,
                                         float v,
                                         void *value,
                                         HdTupleType dataType) const
{
  ...
  rtcInterpolate1(rtcGetGeometry(_meshScene, _meshId),  /* RTCGeometry geometry */
