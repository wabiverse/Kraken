 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_RENDERER_PLUGIN_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_RENDERER_PLUGIN_H
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_RENDERER_PLUGIN_H
