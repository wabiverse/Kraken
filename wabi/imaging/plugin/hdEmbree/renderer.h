 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_RENDERER_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_RENDERER_H
...
class HdEmbreeRenderer final {
 ...
 private:
  ...
  bool _ComputePrimvar(RTCRayHit const &rayHit, TfToken const &primvar, GfVec3f *value);
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_RENDERER_H
