 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_MESH_SAMPLERS_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_MESH_SAMPLERS_H
...
class HdEmbreeRTCBufferAllocator
{
 public:
  ...
  static constexpr int WABI_MAX_USER_VERTEX_BUFFERS = 16;

 private:

  std::bitset<WABI_MAX_USER_VERTEX_BUFFERS> _bitset;
};
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_MESH_SAMPLERS_H
