 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_MESH_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_MESH_H
...
class HdEmbreeMesh final : public HdMesh {
 ...
 private:
  ...
  void _CreatePrimvarSampler(TfToken const &name,
                             VtValue const &data,
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_MESH_H
