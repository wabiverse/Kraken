 ...
 */
#include "wabi/imaging/plugin/hdEmbree/rendererPlugin.h"
...
void HdEmbreeRendererPlugin::DeleteRenderDelegate(HdRenderDelegate *renderDelegate)
{
  delete renderDelegate;
}

bool HdEmbreeRendererPlugin::IsSupported() const
{
