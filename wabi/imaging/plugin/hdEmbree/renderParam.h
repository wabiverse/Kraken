 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_PARAM_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_PARAM_H
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_PARAM_H
