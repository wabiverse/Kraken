 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_DELEGATE_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_DELEGATE_H
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_DELEGATE_H
