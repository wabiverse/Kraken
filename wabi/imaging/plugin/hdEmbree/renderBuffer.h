 ...
 */
#ifndef WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_BUFFER_H
#define WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_BUFFER_H
...
#endif  // WABI_IMAGING_PLUGIN_HD_EMBREE_RENDER_BUFFER_H
