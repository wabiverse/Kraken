...
#include "wabi/imaging/plugin/hdPhoenix/rendererPlugin.h"
#include "wabi/wabi.h"
...
{
  HdRendererPluginRegistry::Define<HdPhoenixRendererPlugin>();
}
...
void HdPhoenixRendererPlugin::DeleteRenderDelegate(HdRenderDelegate *renderDelegate)
{
  delete renderDelegate;
}

bool HdPhoenixRendererPlugin::IsSupported() const
{
  return HdPhRenderDelegate::IsSupported();
}
