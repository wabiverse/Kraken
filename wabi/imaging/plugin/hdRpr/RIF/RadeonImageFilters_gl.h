...
extern RIF_API_ENTRY rif_int rifCreateContextSharedWithOpenGl(rif_uint64 api_version,
                                                              rif_int device_id,
                                                              rif_char const *cache_path,
                                                              rif_context *out_context);
extern RIF_API_ENTRY rif_int rifContextCreateImageFromOpenGlTexture(rif_context context,
                                                                    unsigned int target,
                                                                    int miplevel,
