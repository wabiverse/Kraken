...
namespace rif
{
  ...
  namespace
  {
    ...
    {
      // setup inputs
      RIF_ERROR_CHECK_THROW(rifImageFilterSetParameterImage(m_rifFilter,
                                                            "normalsImg",
    ...
    void FilterEaw::AttachFilter(rif_image inputImage)
    {
      ...
      m_rifContext->AttachFilter(m_auxFilters[Mlaa],
                                 m_auxImages[DenoisedOutputImage]->GetHandle(),
                                 m_outputImage);
    }
