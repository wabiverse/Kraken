...
#include "material.h"
#include "wabi/imaging/rprUsd/materialNodes/rpr/materialXNode.h"
...
{
  // possibly we can use it to reload .mtlx definition if it's changed but I don't know when and
  // how Reload is actually called
}
