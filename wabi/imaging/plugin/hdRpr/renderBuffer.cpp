...
{
  // There is no point to lock this read because HdRenderBuffer user has no idea about internal
  // synchronization. Calling this function to check if they need to unmap a render buffer is just
