...
class HdCyclesMesh final : public HdMesh
{
 public:
   ...
   */
  HdCyclesMesh(HdCyclesRenderDelegate *renderDelegate, const SdfPath &id);
 ...
 protected:
   ...
   * @param interpolation
   */
  void _PopulateColors(const TfToken &name,
                       const TfToken &role,
                       const VtValue &data,
                       ccl::Scene *scene,
                       HdInterpolation interpolation,
 ...
 private:
  ...
  void _PopulateMaterials(HdSceneDelegate *sceneDelegate,
  ...
  void _PopulatePrimvars(HdSceneDelegate *sceneDelegate,
                         ccl::Scene *scene,
                         const SdfPath &id,
                         HdDirtyBits *dirtyBits);
