...
class HdCyclesMeshRefiner {
 public:
  ...
  const HdMeshTopology &GetTriangulatedTopology() const
  {
    return m_triangulated_topology;
  }
...
class HdBbMeshTopology : public HdMeshTopology {
 public:
  ...
  const HdCyclesMeshRefiner *GetRefiner() const
  {
...
inline VtValue HdCyclesMeshRefiner::Refine(const TfToken &name,
                                           const TfToken &role,
                                           const VtValue &value,
                                           const HdInterpolation &interpolation) const
{
