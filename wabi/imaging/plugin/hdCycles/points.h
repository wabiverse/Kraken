...
class HdCyclesPoints final : public HdPoints {
 public:
   ...
   */
  HdCyclesPoints(HdCyclesRenderDelegate *renderDelegate, const SdfPath &id);
  /**
 ...
 protected:
   ...
   */
  void _PopulateWidths(HdSceneDelegate *sceneDelegate,
                       const SdfPath &id,
   ...
   */
  void _PopulateColors(HdSceneDelegate *sceneDelegate,
                       const SdfPath &id,
                       const HdInterpolation &interpolation,
                       VtValue value);
   ...
   */
  void _PopulateOpacities(HdSceneDelegate *sceneDelegate,
                          const SdfPath &id,
                          const HdInterpolation &interpolation,
                          VtValue value);
   ...
   */
  void _PopulateNormals(HdSceneDelegate *sceneDelegate,
                        const SdfPath &id,
                        const HdInterpolation &interpolation,
                        VtValue value);
   ...
   * @brief Fill in the point normals
   */
  void _PopulateVelocities(HdSceneDelegate *sceneDelegate,
                           const SdfPath &id,
                           const HdInterpolation &interpolation,
                           VtValue value);
   ...
   */
  void _PopulateAccelerations(HdSceneDelegate *sceneDelegate,
                              const SdfPath &id,
                              const HdInterpolation &interpolation,
                              VtValue value);
  ...
  void _PopulateMaterial(HdSceneDelegate *sceneDelegate,
