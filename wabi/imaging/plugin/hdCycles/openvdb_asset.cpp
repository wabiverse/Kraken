...
void HdCyclesOpenvdbAsset::Sync(HdSceneDelegate *a_sceneDelegate,
...
HdDirtyBits HdCyclesOpenvdbAsset::GetInitialDirtyBitsMask() const
{
  return HdField::AllDirty;
}

// This will be called from multiple threads.
void HdCyclesOpenvdbAsset::TrackVolumePrimitive(const SdfPath &id)
{
