...
HdCyclesTokensType::HdCyclesTokensType()
    : cpu("cpu", TfToken::Immortal),
      ...
      volume_sampling_multiple_importance("volume_sampling_multiple_importance",
                                          TfToken::Immortal),
      ...
      primvarsCyclesObjectTransformSamples("primvars:cycles:object:transform:samples",
                                           TfToken::Immortal),
      primvarsCyclesObjectDeformSamples("primvars:cycles:object:deform:samples",
                                        TfToken::Immortal),
      ...
      cyclesIntegratorCausticsReflective("cycles:integrator:caustics_reflective",
                                         TfToken::Immortal),
      cyclesIntegratorCausticsRefractive("cycles:integrator:caustics_refractive",
                                         TfToken::Immortal),
      cyclesIntegratorFilterGlossy("cycles:integrator:filter_glossy", TfToken::Immortal),
      cyclesIntegratorSampleClampDirect("cycles:integrator:sample_clamp_direct",
                                        TfToken::Immortal),
