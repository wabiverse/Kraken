...
void HdCyclesRenderPassState::Prepare(const HdResourceRegistrySharedPtr &resourceRegistry)
{
  ...
  //       We can continue committing camera changes from here. That means no need to cast away
  //       const correctness for the camera. The camera render parameters are set through
  //       HdxRenderSetupTask::PrepareCamera. All code related to camera update should be moved
  //       here, and committed to resource registry as pending source.
}
