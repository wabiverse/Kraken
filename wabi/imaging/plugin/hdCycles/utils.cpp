...
ccl::float4 vec1f_to_float4(const float &a_val)
{
  return ccl::make_float4(a_val, a_val, a_val, a_val);
}

ccl::float4 vec2f_to_float4(const GfVec2f &a_vec, float a_z, float a_alpha)
{
  return ccl::make_float4(a_vec[0], a_vec[1], a_z, a_alpha);
}

ccl::float4 vec3f_to_float4(const GfVec3f &a_vec, float a_alpha)
{
...
ccl::float4 vec4i_to_float4(const GfVec4i &a_vec)
{
  return ccl::make_float4(static_cast<float>(a_vec[0]),
                          static_cast<float>(a_vec[1]),
                          static_cast<float>(a_vec[2]),
                          static_cast<float>(a_vec[3]));
}

ccl::float4 vec4d_to_float4(const GfVec4d &a_vec)
{
  return ccl::make_float4(static_cast<float>(a_vec[0]),
                          static_cast<float>(a_vec[1]),
                          static_cast<float>(a_vec[2]),
