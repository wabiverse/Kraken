...
namespace
{
    ...
    const HdTimeSampleArray<TYPE, CAPACITY> &samples)
  {
    ...
    std::unordered_set<HdCyclesIndexedTimeSample> unique{2 *
                                                         HdCyclesIndexedTimeSample::resolution};
...
HdCyclesTransformSource::HdCyclesTransformSource(ccl::Object *object,
...
bool HdCyclesTransformSource::Resolve()
{
  ...
  // Hd outputs duplicated time samples, remove all duplicates and keep time samples in ascending
  // order
