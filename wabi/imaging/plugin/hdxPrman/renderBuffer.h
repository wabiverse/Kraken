...
//
#ifndef EXT_RMANPKG_23_0_PLUGIN_RENDERMAN_PLUGIN_HDX_PRMAN_RENDER_BUFFER_H
#define EXT_RMANPKG_23_0_PLUGIN_RENDERMAN_PLUGIN_HDX_PRMAN_RENDER_BUFFER_H
...
class HdxPrmanRenderBuffer : public HdRenderBuffer {
 public:
  ...
  virtual bool Allocate(GfVec3i const &dimensions, HdFormat format, bool multiSampled) override;
...
#endif  // EXT_RMANPKG_23_0_PLUGIN_RENDERMAN_PLUGIN_HDX_PRMAN_RENDER_BUFFER_H
