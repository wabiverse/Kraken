...
static bool _ConvertWrapMode(HioAddressMode hioWrapMode,
                             RixMessages *msgs,
...
int RtxHioImagePlugin::Open(TextureCtx &tCtx)
{
...
int RtxHioImagePlugin::Fill(TextureCtx &tCtx, FillRequest &fillReq)
{
