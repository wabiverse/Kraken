...
static void _ConvertDX3DTextureToOpenGL(HgiDX3D *hgiDX3D,
                                        HgiTextureHandle const &src,
                                        uint32_t *glDest)
{}

HgiInteropDX3D::HgiInteropDX3D(Hgi *hgiDX3D)
  : _hgiDX3D(static_cast<HgiDX3D *>(hgiDX3D)),
    _vs(0),
    _fsNoDepth(0),
    _fsDepth(0),
    _prgNoDepth(0),
...
void HgiInteropDX3D::CompositeToInterop(HgiTextureHandle const &color,
                                        ...
                                        GfVec4i const &compRegion)
{
  ...
  /**
   * Convert textures from DirectX to GL. */
  _ConvertDX3DTextureToOpenGL(_hgiDX3D, color, &_glColorTex);
  _ConvertDX3DTextureToOpenGL(_hgiDX3D, depth, &_glDepthTex);
