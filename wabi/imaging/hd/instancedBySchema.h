...
#ifndef WABI_IMAGING_HD_INSTANCED_BY_SCHEMA_H
#define WABI_IMAGING_HD_INSTANCED_BY_SCHEMA_H
...
#define HDINSTANCEDBY_SCHEMA_TOKENS (instancedBy)(paths)
...
class HdInstancedBySchema : public HdSchema
{
 public:
  ...
  HD_API
  static HdContainerDataSourceHandle BuildRetained(const HdPathArrayDataSourceHandle &paths);
