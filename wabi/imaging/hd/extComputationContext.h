...
//
#ifndef WABI_IMAGING_HD_EXT_COMPUTATION_CONTEXT_H
#define WABI_IMAGING_HD_EXT_COMPUTATION_CONTEXT_H
...
class HdExtComputationContext
{
 ...
 private:
  ...
  HdExtComputationContext &operator=(const HdExtComputationContext &) = delete;
};

WABI_NAMESPACE_END

#endif  // WABI_IMAGING_HD_EXT_COMPUTATION_CONTEXT_H
