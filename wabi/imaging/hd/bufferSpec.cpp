...
/*static*/
HdBufferSpecVector HdBufferSpec::ComputeUnion(HdBufferSpecVector const &specs1,
...
/*static*/
HdBufferSpecVector HdBufferSpec::ComputeDifference(HdBufferSpecVector const &specs1,
                                                   HdBufferSpecVector const &specs2)
{
  HD_TRACE_FUNCTION();
...
size_t HdBufferSpec::Hash() const
{
  return TfHash()(*this);
}
