 ...
 */
#ifndef WABI_IMAGING_HD_EXT_COMP_PRIMVAR_BUFFER_SOURCE_H
#define WABI_IMAGING_HD_EXT_COMP_PRIMVAR_BUFFER_SOURCE_H
...
#endif  // WABI_IMAGING_HD_EXT_COMP_PRIMVAR_BUFFER_SOURCE_H
