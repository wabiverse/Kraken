...
HdContainerDataSourceHandle HdCategoriesSchema::BuildRetained(size_t includedNameCount,
  ...
  const HdContainerDataSourceHandle &fromParentContainer)
{
  return HdCategoriesSchema(
    fromParentContainer ?
      HdContainerDataSource::Cast(fromParentContainer->Get(HdCategoriesSchemaTokens->categories)) :
      nullptr);
}
...
{
  static const HdDataSourceLocator locator(HdCategoriesSchemaTokens->categories);
  return locator;
}
WABI_NAMESPACE_END