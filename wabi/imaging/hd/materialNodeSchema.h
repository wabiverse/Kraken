...
#ifndef WABI_IMAGING_HD_MATERIAL_NODE_SCHEMA_H
#define WABI_IMAGING_HD_MATERIAL_NODE_SCHEMA_H
...
#define HDMATERIALNODE_SCHEMA_TOKENS (parameters)(inputConnections)(nodeIdentifier)
