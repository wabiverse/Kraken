...
HdPathArrayDataSourceHandle HdInstancerTopologySchema::GetPrototypes()
{
  return _GetTypedDataSource<HdPathArrayDataSource>(HdInstancerTopologySchemaTokens->prototypes);
}

HdVectorDataSourceHandle HdInstancerTopologySchema::GetInstanceIndices()
{
  return _GetTypedDataSource<HdVectorDataSource>(HdInstancerTopologySchemaTokens->instanceIndices);
}

HdBoolArrayDataSourceHandle HdInstancerTopologySchema::GetMask()
{
  return _GetTypedDataSource<HdBoolArrayDataSource>(HdInstancerTopologySchemaTokens->mask);
}

HdPathArrayDataSourceHandle HdInstancerTopologySchema::GetInstanceLocations()
{
...
{
  static const HdDataSourceLocator locator(HdInstancerTopologySchemaTokens->instancerTopology);
  return locator;
}
...
{
  return HdInstancerTopologySchema::BuildRetained(_prototypes,
                                                  _instanceIndices,
                                                  _mask,
                                                  _instanceLocations);
}
