...
//
#ifndef WABI_IMAGING_HD_CONTAINER_DATA_SOURCE_EDITOR_H
#define WABI_IMAGING_HD_CONTAINER_DATA_SOURCE_EDITOR_H
...
class HdContainerDataSourceEditor
{
 public:
  ...
  HdContainerDataSourceEditor &Set(const HdDataSourceLocator &locator,
