...
#ifndef WABI_IMAGING_HD_INSTANCER_TOPOLOGY_SCHEMA_H
#define WABI_IMAGING_HD_INSTANCER_TOPOLOGY_SCHEMA_H
...
#define HDINSTANCERTOPOLOGY_SCHEMA_TOKENS \
  (instancerTopology)(prototypes)(instanceIndices)(mask)(instanceLocations)
...
class HdInstancerTopologySchema : public HdSchema
{
 public:
  ...
  HdInstancerTopologySchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  class Builder
  {
   public:
    ...
    HD_API
    Builder &SetPrototypes(const HdPathArrayDataSourceHandle &prototypes);
    HD_API
    Builder &SetInstanceIndices(const HdVectorDataSourceHandle &instanceIndices);
    HD_API
    Builder &SetMask(const HdBoolArrayDataSourceHandle &mask);
    HD_API
    Builder &SetInstanceLocations(const HdPathArrayDataSourceHandle &instanceLocations);
