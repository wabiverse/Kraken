...
//
#ifndef WABI_IMAGING_HD_DATA_SOURCE_LEGACY_PRIM_H
#define WABI_IMAGING_HD_DATA_SOURCE_LEGACY_PRIM_H
...
class HdDataSourceLegacyPrim : public HdContainerDataSource
{
 ...
 private:
  ...
  HdDataSourceLegacyPrim(SdfPath id, TfToken type, HdSceneDelegate *sceneDelegate);
