...
#ifndef WABI_IMAGING_HD_INSTANCE_SCHEMA_H
#define WABI_IMAGING_HD_INSTANCE_SCHEMA_H
...
#define HDINSTANCE_SCHEMA_TOKENS (instancer)(path)
...
class HdInstanceSchema : public HdSchema
{
 public:
  ...
  HD_API
  static HdContainerDataSourceHandle BuildRetained(const HdPathArrayDataSourceHandle &path);
  ...
  class Builder
  {
   public:
    ...
    HD_API
    Builder &SetPath(const HdPathArrayDataSourceHandle &path);
