...
void Hd_SortedIds::Insert(const SdfPath &id)
{
  _ids.push_back(id);
  _afterLastDeletePoint = INVALID_DELETE_POINT;
}

void Hd_SortedIds::Remove(const SdfPath &id)
{
...
void Hd_SortedIds::_FullSort()
{
  std::sort(_ids.begin(), _ids.end());
}

void Hd_SortedIds::_Sort()
{
  HD_TRACE_FUNCTION();
