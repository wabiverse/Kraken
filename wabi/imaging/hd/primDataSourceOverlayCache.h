...
//
#ifndef WABI_IMAGING_HD_PRIM_DATA_SOURCE_OVERLAY_CACHE_H
#define WABI_IMAGING_HD_PRIM_DATA_SOURCE_OVERLAY_CACHE_H
  ...
  : public std::enable_shared_from_this<HdPrimDataSourceOverlayCache>
{
 public:
  ...
  void HandlePrimsAdded(const HdSceneIndexObserver::AddedPrimEntries &entries,
                        const HdSceneIndexBaseRefPtr &source);
  void HandlePrimsRemoved(const HdSceneIndexObserver::RemovedPrimEntries &entries);
  void HandlePrimsDirtied(const HdSceneIndexObserver::DirtiedPrimEntries &entries,
 ...
 protected:
  ...
  {
    _OverlayDependencies() : onPrim(), onParent(), dependenciesOptional(false) {}
 ...
 private:
  ...
  class _HdPrimDataSourceOverlay : public HdContainerDataSource
  {
   public:
    ...
    _HdPrimDataSourceOverlay(HdContainerDataSourceHandle inputDataSource,
