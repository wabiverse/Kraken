...
size_t HdDrawItem::GetBufferArraysHash() const
{
  return TfHash()(*this);
}

size_t HdDrawItem::GetElementOffsetsHash() const
{
  size_t hash = TfHash::Combine(_GetElementOffset(GetTopologyRange()),
...
HD_API
std::ostream &operator<<(std::ostream &out, const HdDrawItem &self)
{
  out << "Draw Item:\n";
...
size_t HdDrawItem::_GetBufferArraysHash() const
{
  return 0;
}

size_t HdDrawItem::_GetElementOffsetsHash() const
{
  return 0;
}
