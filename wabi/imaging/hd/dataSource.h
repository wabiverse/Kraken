...
//
#ifndef WABI_IMAGING_HD_DATASOURCE_H
#define WABI_IMAGING_HD_DATASOURCE_H
...
class HdContainerDataSource : public HdDataSourceBase
{
 public:
  ...
  HD_API
  static HdDataSourceBaseHandle Get(const Handle &container, const HdDataSourceLocator &locator);
};
...
///
template<typename T> class HdTypedSampledDataSource : public HdSampledDataSource
{
 public:
...
void HdDebugPrintDataSource(std::ostream &, HdDataSourceBaseHandle, int indentLevel = 0);
...
#endif  // WABI_IMAGING_HD_DATASOURCE_H
