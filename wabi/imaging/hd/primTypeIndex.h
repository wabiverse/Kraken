...
template<class PrimType> class Hd_PrimTypeIndex {
 ...
 private:
  ...
  static void _TrackerRemovePrim(HdChangeTracker &tracker, const SdfPath &path);
  ...
  static void _RenderDelegateDestroyPrim(HdRenderDelegate *renderDelegate, PrimType *prim);
...
#endif  // WABI_IMAGING_HD_PRIM_TYPE_INDEX_H
