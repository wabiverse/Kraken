...
HdRprimCollection HdRprimCollection::CreateInverseCollection() const
{
...
SdfPathVector const &HdRprimCollection::GetRootPaths() const
{
  return _rootPaths;
}
...
SdfPathVector const &HdRprimCollection::GetExcludePaths() const
{
  return _excludePaths;
}

void HdRprimCollection::SetMaterialTag(TfToken const &tag)
{
  _materialTag = tag;
}

TfToken const &HdRprimCollection::GetMaterialTag() const
{
  return _materialTag;
}

size_t HdRprimCollection::ComputeHash() const
{
  return TfHash()(*this);
}
