...
#ifndef WABI_IMAGING_HD_CAMERA_SCHEMA_H
#define WABI_IMAGING_HD_CAMERA_SCHEMA_H
...
#define HDCAMERA_SCHEMA_TOKENS \
  (camera)(projection)(        \
    horizontalAperture)(verticalAperture)(horizontalApertureOffset)(verticalApertureOffset)(focalLength)(clippingRange)(perspective)(orthographic)
