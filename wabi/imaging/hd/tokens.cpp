...
bool HdPrimTypeIsLight(TfToken const &primType)
{
  return (primType == HdPrimTypeTokens->simpleLight ||
          primType == HdPrimTypeTokens->cylinderLight || primType == HdPrimTypeTokens->diskLight ||
          primType == HdPrimTypeTokens->distantLight || primType == HdPrimTypeTokens->domeLight ||
          primType == HdPrimTypeTokens->light || primType == HdPrimTypeTokens->pluginLight ||
          primType == HdPrimTypeTokens->rectLight || primType == HdPrimTypeTokens->sphereLight);
}
