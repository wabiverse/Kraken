...
HdPathArrayDataSourceHandle HdInstancedBySchema::GetPaths()
{
...
{
  static const HdDataSourceLocator locator(HdInstancedBySchemaTokens->instancedBy);
  return locator;
}
...
{
  return HdInstancedBySchema::BuildRetained(_paths);
}
