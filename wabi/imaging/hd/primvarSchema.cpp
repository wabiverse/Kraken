...
{
  if (_container) {
    return (_container->Has(HdPrimvarSchemaTokens->indexedPrimvarValue) &&
  ...
  class _HdDataSourceFlattenedPrimvarValue : public HdSampledDataSource
  {
   public:
                                               ...
                                               std::vector<Time> *outSampleTimes) override
    {
      ...
      const bool indexVarying = _indices->GetContributingSampleTimesForInterval(startTime,
                                                                                endTime,
                                                                                &indexSampleTimes);
  ...
  if (_container) {
    if (_container->Has(HdPrimvarSchemaTokens->primvarValue)) {
      ...
      return _HdDataSourceFlattenedPrimvarValue::New(
        _GetTypedDataSource<HdSampledDataSource>(HdPrimvarSchemaTokens->indexedPrimvarValue),
...
{
  return HdPrimvarSchema::BuildRetained(_primvarValue,
