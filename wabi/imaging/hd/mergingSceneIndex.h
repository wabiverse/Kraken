...
//
#ifndef WABI_IMAGING_HD_MERGING_SCENE_H
#define WABI_IMAGING_HD_MERGING_SCENE_H
...
class HdMergingSceneIndex : public HdFilteringSceneIndexBase
{
 public:
  ...
  HD_API
  void AddInputScene(const HdSceneIndexBaseRefPtr &inputScene,
 ...
 private:
  ...
  class _Observer : public HdSceneIndexObserver
  {
   public:
    ...
    _Observer(HdMergingSceneIndex *owner) : _owner(owner) {}
  ...
  struct _InputEntry
  {
    ...
    _InputEntry(const HdSceneIndexBaseRefPtr &sceneIndex, const SdfPath &sceneRoot)
...
#endif  // WABI_IMAGING_HD_MERGING_SCENE_H
