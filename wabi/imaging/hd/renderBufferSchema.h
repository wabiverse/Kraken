...
#ifndef WABI_IMAGING_HD_RENDER_BUFFER_SCHEMA_H
#define WABI_IMAGING_HD_RENDER_BUFFER_SCHEMA_H
...
#define HDRENDERBUFFER_SCHEMA_TOKENS (renderBuffer)(dimensions)(format)(multiSampled)
