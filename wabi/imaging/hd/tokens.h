...
#define HD_TOKENS  \
  (accelerations)( \
    adjacency)(bboxLocalMin)(bboxLocalMax)(bbox)(bezier)(bSpline)(blurScale)(camera)(catmullRom)(collection)(computeShader)(coordSysBindings)(cubic)(cullStyle)(doubleSided)(dispatchCount)(displayColor)(displayOpacity)(displayStyle)(drawDispatch)(drawingShader)(drawingCoord0)(drawingCoord1)(drawingCoord2)(drawingCoordI)(drivers)(edgeIndices)(elementCount)(elementsVisibility)(extent)(faceColors)(filters)(full)(geometry)(hermite)(hullIndices)(indices)(isFlipped)(itemsDrawn)(layout)(leftHanded)(linear)(lightLink)(lightFilterLink)(materialParams)(nonlinearSampleCount)(nonperiodic)(normals)(params)(patchParam)(periodic)(pinned)(points)(pointsIndices)(power)(preview)(pointsVisibility)(primvar)(primID)(primitiveParam)(tessFactors)(quadInfo)(renderTags)(rightHanded)(segmented)(shadowLink)(subdivTags)(taskState)(taskParams)(topology)(topologyVisibility)(totalItemCount)(transform)(transformInverse)(velocities)(visibility)(widths)
...
#define HD_CULLSTYLE_TOKENS \
  (dontCare)(nothing)(back)(front)(backUnlessDoubleSided)(frontUnlessDoubleSided)
...
#define HD_SHADER_TOKENS        \
  (alphaThreshold)(clipPlanes)( \
    commonShaderSource)(computeShader)(cullStyle)(drawRange)(environmentMap)(displacementShader)(fragmentShader)(geometryShader)(imageToWorldMatrix)(indicatorColor)(lightingBlendAmount)(overrideColor)(maskColor)(projectionMatrix)(pointColor)(pointSize)(pointSelectedSize)(materialTag)(tessControlShader)(tessEvalShader)(postTessControlShader)(postTessVertexShader)(tessLevel)(viewport)(vertexShader)(wireframeColor)(worldToViewMatrix)(worldToViewInverseMatrix)(stepSize)(stepSizeLighting)
...
#define HD_PRIMTYPE_TOKENS                                                                                                                                 \
  ...
  (mesh)(basisCurves)(points)(volume)                                                                                                                      \
                                                                                                                                                           \
    /* Sprims */                                                                                                                                           \
    (camera)(drawTarget)(material)(coordSys)(instancer)(instance) /* Sprims Lights */                                                                      \
