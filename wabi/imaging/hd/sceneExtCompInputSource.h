...
//
#ifndef WABI_IMAGING_HD_SCENE_EXT_COMP_INPUT_SOURCE_H
#define WABI_IMAGING_HD_SCENE_EXT_COMP_INPUT_SOURCE_H
...
#endif  // WABI_IMAGING_HD_SCENE_EXT_COMP_INPUT_SOURCE_H
