...
{
  static const HdDataSourceLocator locator(HdVolumeFieldSchemaTokens->volumeField);
  return locator;
}
...
{
  return HdVolumeFieldSchema::BuildRetained(_filePath,
                                            _fieldName,
                                            _fieldIndex,
                                            _fieldDataType,
                                            _vectorDataRoleHint);
