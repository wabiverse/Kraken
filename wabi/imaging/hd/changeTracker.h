...
//
#ifndef WABI_IMAGING_HD_CHANGE_TRACKER_H
#define WABI_IMAGING_HD_CHANGE_TRACKER_H
...
class HdChangeTracker
{
 public:
  ...
  /// id is for perflog.
  HD_API
  static bool IsPrimvarDirty(HdDirtyBits dirtyBits, SdfPath const &id, TfToken const &name);
  ...
  /// DirtyInstancer.
  HD_API
  void AddInstancerRprimDependency(SdfPath const &instancerId, SdfPath const &rprimId);

  /// Remove a dependency between \p rprimId and parent instancer
  /// \p instancerId.
  HD_API
  void RemoveInstancerRprimDependency(SdfPath const &instancerId, SdfPath const &rprimId);
  ...
  /// \p parentSprimId.
  HD_API
  void AddSprimSprimDependency(SdfPath const &parentSprimId, SdfPath const &sprimId);

  /// Remove a dependency between \p sprimId and parent sprim
  /// \p parentSprimId.
  HD_API
  void RemoveSprimSprimDependency(SdfPath const &parentSprimId, SdfPath const &sprimId);
 ...
 private:
  ...
  static void _LogCacheAccess(TfToken const &cacheName, SdfPath const &id, bool hit);
  ...
  typedef tbb::concurrent_hash_map<SdfPath, SdfPathSet, _PathHashCompare> _DependencyMap;
  ...
  void _AddDependency(_DependencyMap &depMap, SdfPath const &parent, SdfPath const &child);
  void _RemoveDependency(_DependencyMap &depMap, SdfPath const &parent, SdfPath const &child);
...
#endif  // WABI_IMAGING_HD_CHANGE_TRACKER_H
