...
void HdChangeTracker::_LogCacheAccess(TfToken const &cacheName, SdfPath const &id, bool hit)
{
  if (hit) {
...
void HdChangeTracker::RprimInserted(SdfPath const &id, HdDirtyBits initialDirtyState)
{
...
void HdChangeTracker::RprimRemoved(SdfPath const &id)
{
...
void HdChangeTracker::MarkRprimDirty(SdfPath const &id, HdDirtyBits bits)
{
  ...
  if (_emulationSceneIndex) {
    ...
    const HdDirtyBits internalDirtyBits = HdChangeTracker::InitRepr | HdChangeTracker::Varying |
    ...
    if (!locators.IsEmpty()) {
      _emulationSceneIndex->DirtyPrims({
        {id, locators}
      });
    }
  } else {
...
void HdChangeTracker::ResetVaryingState()
{
  TRACE_FUNCTION();

  TF_DEBUG(HD_VARYING_STATE)
    .Msg("Resetting Rprim Varying State: varyingStateVersion (%d -> %d)\n",
         _varyingStateVersion,
         _varyingStateVersion + 1);
...
void HdChangeTracker::ResetRprimVaryingState(SdfPath const &id)
{
...
void HdChangeTracker::MarkRprimClean(SdfPath const &id, HdDirtyBits newBits)
{
...
void HdChangeTracker::InstancerInserted(SdfPath const &id, HdDirtyBits initialDirtyState)
{
...
void HdChangeTracker::InstancerRemoved(SdfPath const &id)
{
...
void HdChangeTracker::AddSprimSprimDependency(SdfPath const &parentSprimId, SdfPath const &sprimId)
{
...
void HdChangeTracker::RemoveSprimSprimDependency(SdfPath const &parentSprimId,
...
void HdChangeTracker::RemoveSprimFromSprimSprimDependencies(SdfPath const &sprimId)
{
  ...
  // Remove sprim as parent
  {
    ...
    if (_sprimSprimTargetDependencies.find(a, sprimId)) {
      ...
      for (const SdfPath &childPath : a->second) {
        ...
        _RemoveDependency(_sprimSprimSourceDependencies, childPath, sprimId);
      }
  ...
  // Remove sprim as child
  {
    ...
    if (_sprimSprimSourceDependencies.find(a, sprimId)) {
      for (const SdfPath &parentPath : a->second) {
        _RemoveDependency(_sprimSprimTargetDependencies, parentPath, sprimId);
      }
...
void HdChangeTracker::_AddDependency(HdChangeTracker::_DependencyMap &depMap,
                                     SdfPath const &parent,
                                     SdfPath const &child)
{
  _DependencyMap::accessor a;
...
void HdChangeTracker::_RemoveDependency(HdChangeTracker::_DependencyMap &depMap,
                                        SdfPath const &parent,
                                        SdfPath const &child)
{
  _DependencyMap::accessor a;
...
void HdChangeTracker::TaskInserted(SdfPath const &id, HdDirtyBits initialDirtyState)
{
...
void HdChangeTracker::TaskRemoved(SdfPath const &id)
{
...
void HdChangeTracker::MarkTaskDirty(SdfPath const &id, HdDirtyBits bits)
{
  if (ARCH_UNLIKELY(bits == HdChangeTracker::Clean)) {
...
HdDirtyBits HdChangeTracker::GetTaskDirtyBits(SdfPath const &id)
{
  _IDStateMap::iterator it = _taskState.find(id);
...
void HdChangeTracker::MarkTaskClean(SdfPath const &id, HdDirtyBits newBits)
{
  _IDStateMap::iterator it = _taskState.find(id);
  if (!TF_VERIFY(it != _taskState.end()))
    return;
...
unsigned HdChangeTracker::GetRenderTagVersion() const
{
  return _rprimRenderTagVersion;
}

unsigned HdChangeTracker::GetTaskRenderTagsVersion() const
{
...
HdDirtyBits HdChangeTracker::GetInstancerDirtyBits(SdfPath const &id)
{
...
void HdChangeTracker::MarkInstancerDirty(SdfPath const &id, HdDirtyBits bits)
{
  if (ARCH_UNLIKELY(bits == HdChangeTracker::Clean)) {
  ...
  if (_emulationSceneIndex) {
    ...
    HdSceneIndexPrim prim = _emulationSceneIndex->GetPrim(id);
    HdDataSourceLocatorSet locators;
    HdDirtyBitsTranslator::InstancerDirtyBitsToLocatorSet(prim.primType, bits, &locators);
    if (!locators.IsEmpty()) {
      _emulationSceneIndex->DirtyPrims({
        {id, locators}
      });
...
void HdChangeTracker::_MarkInstancerDirty(SdfPath const &id, HdDirtyBits bits)
{
  _IDStateMap::iterator it = _instancerState.find(id);
  if (!TF_VERIFY(it != _instancerState.end()))
    return;
...
void HdChangeTracker::MarkInstancerClean(SdfPath const &id, HdDirtyBits newBits)
{
...
void HdChangeTracker::SprimInserted(SdfPath const &id, HdDirtyBits initialDirtyState)
{
...
void HdChangeTracker::SprimRemoved(SdfPath const &id)
{
...
HdDirtyBits HdChangeTracker::GetSprimDirtyBits(SdfPath const &id)
{
...
void HdChangeTracker::MarkSprimDirty(SdfPath const &id, HdDirtyBits bits)
{
  if (ARCH_UNLIKELY(bits == HdChangeTracker::Clean)) {
...
void HdChangeTracker::_MarkSprimDirty(SdfPath const &id, HdDirtyBits bits)
{
  _IDStateMap::iterator it = _sprimState.find(id);
  if (!TF_VERIFY(it != _sprimState.end()))
    return;
...
void HdChangeTracker::MarkSprimClean(SdfPath const &id, HdDirtyBits newBits)
{
  _IDStateMap::iterator it = _sprimState.find(id);
  if (!TF_VERIFY(it != _sprimState.end()))
    return;
...
void HdChangeTracker::BprimInserted(SdfPath const &id, HdDirtyBits initialDirtyState)
{
...
void HdChangeTracker::BprimRemoved(SdfPath const &id)
{
...
HdDirtyBits HdChangeTracker::GetBprimDirtyBits(SdfPath const &id)
{
...
void HdChangeTracker::MarkBprimDirty(SdfPath const &id, HdDirtyBits bits)
{
  if (ARCH_UNLIKELY(bits == HdChangeTracker::Clean)) {
  ...
  if (_emulationSceneIndex) {
    ...
    HdSceneIndexPrim prim = _emulationSceneIndex->GetPrim(id);
    HdDataSourceLocatorSet locators;
    HdDirtyBitsTranslator::BprimDirtyBitsToLocatorSet(prim.primType, bits, &locators);
    if (!locators.IsEmpty()) {
      _emulationSceneIndex->DirtyPrims({
        {id, locators}
      });
...
void HdChangeTracker::_MarkBprimDirty(SdfPath const &id, HdDirtyBits bits)
{
  _IDStateMap::iterator it = _bprimState.find(id);
  if (!TF_VERIFY(it != _bprimState.end()))
    return;
...
void HdChangeTracker::MarkBprimClean(SdfPath const &id, HdDirtyBits newBits)
{
  _IDStateMap::iterator it = _bprimState.find(id);
  if (!TF_VERIFY(it != _bprimState.end()))
    return;
...
bool HdChangeTracker::IsRprimDirty(SdfPath const &id)
{
  return IsDirty(GetRprimDirtyBits(id));
}

bool HdChangeTracker::IsTopologyDirty(SdfPath const &id)
{
  return IsTopologyDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsDoubleSidedDirty(SdfPath const &id)
{
  return IsDoubleSidedDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsCullStyleDirty(SdfPath const &id)
{
  return IsCullStyleDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsDisplayStyleDirty(SdfPath const &id)
{
  return IsDisplayStyleDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsSubdivTagsDirty(SdfPath const &id)
{
  return IsSubdivTagsDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsTransformDirty(SdfPath const &id)
{
  return IsTransformDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsVisibilityDirty(SdfPath const &id)
{
  return IsVisibilityDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsExtentDirty(SdfPath const &id)
{
  return IsExtentDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsPrimIdDirty(SdfPath const &id)
{
  return IsPrimIdDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsAnyPrimvarDirty(SdfPath const &id)
{
  return IsAnyPrimvarDirty(GetRprimDirtyBits(id), id);
}

bool HdChangeTracker::IsPrimvarDirty(SdfPath const &id, TfToken const &name)
{
  return IsPrimvarDirty(GetRprimDirtyBits(id), id, name);
}

/*static*/
bool HdChangeTracker::IsTopologyDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsDoubleSidedDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsCullStyleDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsDisplayStyleDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsSubdivTagsDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsTransformDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsVisibilityDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsExtentDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsPrimIdDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsInstancerDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsInstanceIndexDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
...
/*static*/
bool HdChangeTracker::IsAnyPrimvarDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
  bool isDirty = (dirtyBits & (DirtyPoints | DirtyNormals | DirtyWidths | DirtyPrimvar)) != 0;
  _LogCacheAccess(HdTokens->primvar, id, !isDirty);
  return isDirty;
}

/*static*/
bool HdChangeTracker::IsPrimvarDirty(HdDirtyBits dirtyBits, SdfPath const &id, TfToken const &name)
{
  bool isDirty = false;
...
/*static*/
bool HdChangeTracker::IsReprDirty(HdDirtyBits dirtyBits, SdfPath const &id)
{
  bool isDirty = (dirtyBits & DirtyRepr) != 0;
  return isDirty;
}

void HdChangeTracker::MarkPrimvarDirty(SdfPath const &id, TfToken const &name)
{
...
void HdChangeTracker::MarkAllRprimsDirty(HdDirtyBits bits)
{
  HD_TRACE_FUNCTION();
  ...
  if (_emulationSceneIndex) {
    ...
    for (_IDStateMap::iterator it = _rprimState.begin(); it != _rprimState.end(); ++it) {
...
/*static*/
void HdChangeTracker::MarkPrimvarDirty(HdDirtyBits *dirtyBits, TfToken const &name)
{
...
HdDirtyBits HdChangeTracker::GetRprimDirtyBits(SdfPath const &id) const
{
...
void HdChangeTracker::AddCollection(TfToken const &collectionName)
{
  HD_TRACE_FUNCTION();
...
void HdChangeTracker::MarkCollectionDirty(TfToken const &collectionName)
{
  HD_TRACE_FUNCTION();
...
unsigned HdChangeTracker::GetCollectionVersion(TfToken const &collectionName) const
{
  _CollectionStateMap::const_iterator it = _collectionState.find(collectionName);
  if (!(it != _collectionState.end())) {
    TF_CODING_ERROR("Change Tracker unable to find collection %s", collectionName.GetText());
    return _rprimIndexVersion;
  }
  return it->second + _rprimIndexVersion;
}

unsigned HdChangeTracker::GetVisibilityChangeCount() const
{
  return _visChangeCount;
}

void HdChangeTracker::AddState(TfToken const &name)
{
...
void HdChangeTracker::MarkStateDirty(TfToken const &name)
{
  _GeneralStateMap::iterator it = _generalState.find(name);
  if (it != _generalState.end()) {
    ++it->second;
...
unsigned HdChangeTracker::GetStateVersion(TfToken const &name) const
{
...
/*static*/
std::string HdChangeTracker::StringifyDirtyBits(HdDirtyBits dirtyBits)
{
...
/*static*/
void HdChangeTracker::DumpDirtyBits(HdDirtyBits dirtyBits)
{
  std::cerr << "DirtyBits:" << HdChangeTracker::StringifyDirtyBits(dirtyBits) << "\n";
}

void HdChangeTracker::_SetTargetSceneIndex(HdRetainedSceneIndex *emulationSceneIndex)
{
