...
struct HdMaterialConnection2
{
  ...
  {
    return upstreamNode == rhs.upstreamNode && upstreamOutputName == rhs.upstreamOutputName;
  }
};
...
struct HdMaterialNetwork2
{
  ...
  {
    return nodes == rhs.nodes && terminals == rhs.terminals && primvars == rhs.primvars;
  }
};
...
#endif  // WABI_IMAGING_HD_MATERIAL_H
