...
namespace
{
  ...
  template<size_t T>
  class Hd_SmallRetainedContainerDataSource : public HdRetainedContainerDataSource
  {
   public:
   ...
   private:
    ...
    Hd_SmallRetainedContainerDataSource(size_t count,
                                        const TfToken *names,
                                        const HdDataSourceBaseHandle *values)
    {
      if (count > capacity) {
        TF_CODING_ERROR("Count %zu is greater than capacity %zu. Truncating", count, capacity);
        count = capacity;
      }
  ...
  template<size_t T>
  class Hd_MappedRetainedContainerDataSource : public HdRetainedContainerDataSource
  {
   public:
   ...
   private:
    ...
    Hd_MappedRetainedContainerDataSource(size_t count,
                                         const TfToken *names,
                                         const HdDataSourceBaseHandle *values)
    {
...
HdRetainedContainerDataSource::Handle HdRetainedContainerDataSource::New(
  size_t count,
  const TfToken *names,
  const HdDataSourceBaseHandle *values)
{
  switch (count) {
    ...
    case 1:
      return Hd_SmallRetainedContainerDataSource<1>::New(count, names, values);
    case 2:
      return Hd_SmallRetainedContainerDataSource<2>::New(count, names, values);
    case 3:
      return Hd_SmallRetainedContainerDataSource<3>::New(count, names, values);
    case 4:
      return Hd_SmallRetainedContainerDataSource<4>::New(count, names, values);
    case 5:
      return Hd_SmallRetainedContainerDataSource<5>::New(count, names, values);
    case 6:
      return Hd_SmallRetainedContainerDataSource<6>::New(count, names, values);
    case 7:
      return Hd_SmallRetainedContainerDataSource<7>::New(count, names, values);
    case 8:
      return Hd_SmallRetainedContainerDataSource<8>::New(count, names, values);
    case 9:
      return Hd_SmallRetainedContainerDataSource<9>::New(count, names, values);
    case 10:
      return Hd_SmallRetainedContainerDataSource<10>::New(count, names, values);
    case 11:
      return Hd_SmallRetainedContainerDataSource<11>::New(count, names, values);
    case 12:
      return Hd_SmallRetainedContainerDataSource<12>::New(count, names, values);
    case 13:
      return Hd_SmallRetainedContainerDataSource<13>::New(count, names, values);
    case 14:
      return Hd_SmallRetainedContainerDataSource<14>::New(count, names, values);
    case 15:
      return Hd_SmallRetainedContainerDataSource<15>::New(count, names, values);
    case 16:
      return Hd_SmallRetainedContainerDataSource<16>::New(count, names, values);
    default:
      // any-sized via dense hash map
      return Hd_MappedRetainedContainerDataSource<32>::New(count, names, values);
  }
}
  ...
  const HdDataSourceBaseHandle &value5)
{
  ...
  HdDataSourceBaseHandle values[] = {value1, value2, value3, value4, value5};
  ...
  const HdDataSourceBaseHandle &value6)
{
  ...
  HdDataSourceBaseHandle values[] = {value1, value2, value3, value4, value5, value6};
  return New(6, names, values);
}

// ----------------------------------------------------------------------------

HdRetainedSmallVectorDataSource::HdRetainedSmallVectorDataSource(size_t count,
...
size_t HdRetainedSmallVectorDataSource::GetNumElements()
{
  return _values.size();
}

HdDataSourceBaseHandle HdRetainedSmallVectorDataSource::GetElement(size_t element)
{
...
HdSampledDataSource::Handle HdCreateTypedRetainedDataSource(VtValue const &v)
{
  if (v.IsHolding<int>()) {
    return HdRetainedTypedSampledDataSource<int>::New(v.UncheckedGet<int>());
  } else if (v.IsHolding<VtArray<int>>()) {
    return HdRetainedTypedSampledDataSource<VtArray<int>>::New(v.UncheckedGet<VtArray<int>>());
  } else if (v.IsHolding<float>()) {
    return HdRetainedTypedSampledDataSource<float>::New(v.UncheckedGet<float>());
  } else if (v.IsHolding<VtArray<float>>()) {
    return HdRetainedTypedSampledDataSource<VtArray<float>>::New(v.UncheckedGet<VtArray<float>>());
  } else if (v.IsHolding<double>()) {
    return HdRetainedTypedSampledDataSource<double>::New(v.UncheckedGet<double>());
    ...
    return HdRetainedTypedSampledDataSource<bool>::New(v.UncheckedGet<bool>());
  } else if (v.IsHolding<VtArray<bool>>()) {
    return HdRetainedTypedSampledDataSource<VtArray<bool>>::New(v.UncheckedGet<VtArray<bool>>());
  } else if (v.IsHolding<TfToken>()) {
    return HdRetainedTypedSampledDataSource<TfToken>::New(v.UncheckedGet<TfToken>());
    ...
    return HdRetainedTypedSampledDataSource<SdfPath>::New(v.UncheckedGet<SdfPath>());
    ...
    return HdRetainedTypedSampledDataSource<SdfAssetPath>::New(v.UncheckedGet<SdfAssetPath>());
    ...
    return HdRetainedTypedSampledDataSource<GfVec2f>::New(v.UncheckedGet<GfVec2f>());
    ...
    return HdRetainedTypedSampledDataSource<GfVec3f>::New(v.UncheckedGet<GfVec3f>());
    ...
    return HdRetainedTypedSampledDataSource<GfVec3d>::New(v.UncheckedGet<GfVec3d>());
    ...
    return HdRetainedTypedSampledDataSource<GfMatrix4d>::New(v.UncheckedGet<GfMatrix4d>());
    ...
    return HdRetainedTypedSampledDataSource<std::string>::New(v.UncheckedGet<std::string>());
  } else if (v.IsEmpty()) {
...
template<>
HD_API HdRetainedTypedSampledDataSource<bool>::Handle HdRetainedTypedSampledDataSource<bool>::New(
  const bool &value)
{
  if (value) {
