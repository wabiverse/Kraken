...
class HdDrawItem {
 public:
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetConstantPrimvarIndex());
  }
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetInstancePrimvarIndex(level));
  }
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetInstanceIndexIndex());
  }
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetElementPrimvarIndex());
  }
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetTopologyIndex());
  }

  HD_API
  HdBufferArrayRangeSharedPtr const &GetTopologyVisibilityRange() const
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetTopologyVisibilityIndex());
  }
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetVertexPrimvarIndex());
  }
  ...
  {
    return _sharedData->barContainer.Get(_drawingCoord.GetFaceVaryingPrimvarIndex());
  }
...
#endif  // WABI_IMAGING_HD_DRAW_ITEM_H
