...
Hd_FlatNormalsComputation::Hd_FlatNormalsComputation(HdMeshTopology const *topology,
...
void Hd_FlatNormalsComputation::GetBufferSpecs(HdBufferSpecVector *specs) const
{
...
bool Hd_FlatNormalsComputation::_CheckValid() const
{
