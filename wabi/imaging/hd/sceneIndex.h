...
//
#ifndef WABI_IMAGING_HD_SCENE_INDEX_H
#define WABI_IMAGING_HD_SCENE_INDEX_H
...
#include "wabi/imaging/hd/sceneIndexObserver.h"
...
class HdSceneIndexBase : public TfRefBase, public TfWeakBase
{
 public:
  ...
  {
    return HdContainerDataSource::Get(GetPrim(primPath).dataSource, locator);
  }
...
///
class HdSceneIndexNameRegistry : public TfSingleton<HdSceneIndexNameRegistry>
{
 ...
 public:
  ...
  ///
  HD_API
  void RegisterNamedSceneIndex(const std::string &name, HdSceneIndexBasePtr instance);
 ...
 private:
  ...
  using _NamedInstanceMap = std::unordered_map<std::string, HdSceneIndexBasePtr>;
...
#endif  // WABI_IMAGING_HD_SCENE_INDEX_H
