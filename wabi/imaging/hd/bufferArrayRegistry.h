...
class HdBufferArrayRegistry {
 public:
  ...
  /// Thread-Safe
  HD_API
  HdBufferArrayRangeSharedPtr AllocateRange(HdAggregationStrategy *strategy,
                                            TfToken const &role,
  ...
  HD_API
  size_t GetResourceAllocation(HdAggregationStrategy *strategy, VtDictionary &result) const;
...
#endif  // WABI_IMAGING_HD_BUFFER_ARRAY_REGISTRY_H
