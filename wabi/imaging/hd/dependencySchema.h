...
#ifndef WABI_IMAGING_HD_DEPENDENCY_SCHEMA_H
#define WABI_IMAGING_HD_DEPENDENCY_SCHEMA_H
...
TF_DECLARE_PUBLIC_TOKENS(HdDependencySchemaTokens, HD_API, HDDEPENDENCY_SCHEMA_TOKENS);
