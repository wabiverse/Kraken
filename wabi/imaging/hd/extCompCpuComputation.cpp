...
TfToken const &HdExtCompCpuComputation::GetName() const
{
  return _id.GetToken();
}

bool HdExtCompCpuComputation::Resolve()
{
...
size_t HdExtCompCpuComputation::GetNumElements() const
{
  return _numElements;
}
...
const VtValue &HdExtCompCpuComputation::GetOutputByIndex(size_t index) const
{
  return _outputValues[index];
}

bool HdExtCompCpuComputation::_CheckValid() const
{
