...
#ifndef WABI_IMAGING_HD_MATERIAL_BINDING_SCHEMA_H
#define WABI_IMAGING_HD_MATERIAL_BINDING_SCHEMA_H
...
#define HDMATERIALBINDING_SCHEMA_TOKENS (materialBinding)((allPurpose, ""))
