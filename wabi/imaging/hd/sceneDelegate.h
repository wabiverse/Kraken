...
struct HdPrimvarDescriptor {
  ...
  {
    return name == rhs.name && role == rhs.role && interpolation == rhs.interpolation;
  }
  bool operator!=(HdPrimvarDescriptor const &rhs) const
  {
    return !(*this == rhs);
...
struct HdExtComputationInputDescriptor {
  ...
  {
    return name == rhs.name && sourceComputationId == rhs.sourceComputationId &&
...
struct HdExtComputationOutputDescriptor {
  ...
  {
    return name == rhs.name && valueType == rhs.valueType;
  }
  bool operator!=(HdExtComputationOutputDescriptor const &rhs) const
  {
    return !(*this == rhs);
...
class HdSceneDelegate {
 public:
  ...
  HD_API
  virtual VtValue GetIndexedPrimvar(SdfPath const &id, TfToken const &key, VtIntArray *outIndices);
  ...
  HD_API
  virtual std::vector<VtArray<TfToken>> GetInstanceCategories(SdfPath const &instancerId);
  ...
  template<unsigned int CAPACITY>
  void SampleIndexedPrimvar(SdfPath const &id,
                            TfToken const &key,
  ...
  ///
  HD_API
  virtual VtIntArray GetInstanceIndices(SdfPath const &instancerId, SdfPath const &prototypeId);
  ...
  HD_API
  virtual VtValue GetLightParamValue(SdfPath const &id, TfToken const &paramName);
  ...
  HD_API
  virtual VtValue GetCameraParamValue(SdfPath const &cameraId, TfToken const &paramName);
  ...
  HD_API
  virtual HdVolumeFieldDescriptorVector GetVolumeFieldDescriptors(SdfPath const &volumeId);
  ...
  HD_API
  virtual TfTokenVector GetExtComputationSceneInputNames(SdfPath const &computationId);
  ...
  HD_API
  virtual VtValue GetExtComputationInput(SdfPath const &computationId, TfToken const &input);
...
#endif  // WABI_IMAGING_HD_SCENE_DELEGATE_H
