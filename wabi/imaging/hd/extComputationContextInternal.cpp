...
#include "wabi/imaging/hd/extComputationContextInternal.h"
...
bool Hd_ExtComputationContextInternal::GetOutputValue(const TfToken &name, VtValue *output) const
{
...
bool Hd_ExtComputationContextInternal::HasComputationError()
{
  return m_compuationError;
}

void Hd_ExtComputationContextInternal::RaiseComputationError()
{
  m_compuationError = true;
}

const VtValue &Hd_ExtComputationContextInternal::GetInputValue(const TfToken &name) const
{
...
void Hd_ExtComputationContextInternal::SetOutputValue(const TfToken &name, const VtValue &input)
{
