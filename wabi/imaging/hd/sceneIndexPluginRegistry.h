...
//
#ifndef WABI_IMAGING_HD_SCENE_INDEX_PLUGIN_REGISTRY_H
#define WABI_IMAGING_HD_SCENE_INDEX_PLUGIN_REGISTRY_H
...
class HdSceneIndexPluginRegistry final : public HfPluginRegistry
{
 public:
  ...
  HD_API
  HdSceneIndexBaseRefPtr AppendSceneIndicesForRenderer(const std::string &rendererDisplayName,
                                                       const HdSceneIndexBaseRefPtr &inputScene);
...
#endif  // WABI_IMAGING_HD_SCENE_INDEX_PLUGIN_REGISTRY_H
