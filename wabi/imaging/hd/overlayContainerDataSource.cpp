...
HdOverlayContainerDataSource::HdOverlayContainerDataSource(size_t count,
...
bool HdOverlayContainerDataSource::Has(const TfToken &name)
{
...
TfTokenVector HdOverlayContainerDataSource::GetNames()
{
...
HdDataSourceBaseHandle HdOverlayContainerDataSource::Get(const TfToken &name)
{
