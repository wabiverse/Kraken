...
int GlfBindingMap::GetSamplerUnit(std::string const &name)
{
...
int GlfBindingMap::GetAttributeIndex(std::string const &name)
{
...
int GlfBindingMap::GetUniformBinding(std::string const &name)
{
...
bool GlfBindingMap::HasUniformBinding(std::string const &name) const
{
  return HasUniformBinding(TfToken(name));
}

bool GlfBindingMap::HasUniformBinding(TfToken const &name) const
{
...
void GlfBindingMap::AddCustomBindings(GLuint program)
{
...
void GlfBindingMap::_AddActiveAttributeBindings(GLuint program)
{
...
void GlfBindingMap::_AddActiveUniformBindings(GLuint program)
{
  GLint numUniforms = 0;
...
void GlfBindingMap::_AddActiveUniformBlockBindings(GLuint program)
{
...
void GlfBindingMap::Debug() const
{
