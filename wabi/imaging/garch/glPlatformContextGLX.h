 ...
 */
#ifndef WABI_IMAGING_GARCH_GL_PLATFORM_CONTEXT_GLX_H
#define WABI_IMAGING_GARCH_GL_PLATFORM_CONTEXT_GLX_H
...
#endif  // WABI_IMAGING_GARCH_GL_PLATFORM_CONTEXT_GLX_H
