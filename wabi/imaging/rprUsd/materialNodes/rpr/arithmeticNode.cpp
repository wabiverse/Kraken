...
TF_DEFINE_PRIVATE_TOKENS(_tokens, (color0)(color1)(color2)(color3));

template<typename T>
RprUsd_MaterialNode *RprUsd_CreateRprNode(RprUsd_MaterialBuilderContext *ctx,
 ...
 public:
  ...
  template<typename T> void Register(rpr::MaterialNodeArithmeticOperation op)
  {
    ...
    RprUsdMaterialRegistry::GetInstance().Register(
        TfToken(desc.info->name), desc.factory, desc.info);
  }
