...
#define RPRUSD_MATERIAL_NODE_INPUT_TOKENS \
  (color)( \
      color0)(color1)(normal)(uv)(data)(roughness)(ior)(roughness_x)(roughness_y)(rotation)(weight)(op)(invec)(uv_scale)(value)(reflectance)(scale)(scattering)(absorption)(emission)(g)(multiscatter)(color2)(color3)(anisotropic)(frontface)(backface)(origin)(zaxis)(xaxis)(threshold)(offset)(uv_type)(radius)(side)(caustics)(transmission_color)(thickness)(( \
      input0, "0"))((input1, "1"))(( \
      input2, "2"))((input3, \
                     "3"))((input4, \
...
#define RPRUSD_MATERIAL_INPUT_MODE_TOKENS \
  ...
  ((pbr, "PBR"))((metalness, "Metalness"))                         /* Emission mode */ \
      ...
      ((uv, "UV"))((normal, "Normal"))((position, "Position"))((invec, \
      ...
      ((planar, "Flat Plane"))((cylindical, "Cylinder (in xy direction)"))(( \
          spherical, "Spherical"))((project, "Projected from a camera position"))
