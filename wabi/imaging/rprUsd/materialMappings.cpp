...
bool ToRpr(TfToken const &id, rpr::MaterialNodeType *out, bool pedantic)
{
  static const std::map<TfToken, rpr::MaterialNodeType> s_mapping = {
      ...
      {RprUsdMaterialNodeTypeTokens->microfacet_refraction,
      ...
      {RprUsdMaterialNodeTypeTokens->microfacet_anisotropic_reflection,
       RPR_MATERIAL_NODE_MICROFACET_ANISOTROPIC_REFLECTION},
      {RprUsdMaterialNodeTypeTokens->microfacet_anisotropic_refraction,
...
bool ToRpr(TfToken const &id, rpr::MaterialNodeInput *out, bool pedantic)
{
  static const std::map<TfToken, rpr::MaterialNodeInput> s_mapping = {
      ...
      {RprUsdMaterialNodeInputTokens->schlick_approximation,
      ...
      {RprUsdMaterialNodeInputTokens->uber_diffuse_roughness,
      ...
      {RprUsdMaterialNodeInputTokens->uber_reflection_color,
       RPR_MATERIAL_INPUT_UBER_REFLECTION_COLOR},
      {RprUsdMaterialNodeInputTokens->uber_reflection_weight,
       RPR_MATERIAL_INPUT_UBER_REFLECTION_WEIGHT},
      {RprUsdMaterialNodeInputTokens->uber_reflection_roughness,
       RPR_MATERIAL_INPUT_UBER_REFLECTION_ROUGHNESS},
      {RprUsdMaterialNodeInputTokens->uber_reflection_anisotropy,
       RPR_MATERIAL_INPUT_UBER_REFLECTION_ANISOTROPY},
      {RprUsdMaterialNodeInputTokens->uber_reflection_anisotropy_rotation,
       RPR_MATERIAL_INPUT_UBER_REFLECTION_ANISOTROPY_ROTATION},
      {RprUsdMaterialNodeInputTokens->uber_reflection_mode,
       RPR_MATERIAL_INPUT_UBER_REFLECTION_MODE},
      {RprUsdMaterialNodeInputTokens->uber_reflection_ior, RPR_MATERIAL_INPUT_UBER_REFLECTION_IOR},
      {RprUsdMaterialNodeInputTokens->uber_reflection_metalness,
      ...
      {RprUsdMaterialNodeInputTokens->uber_refraction_color,
       RPR_MATERIAL_INPUT_UBER_REFRACTION_COLOR},
      {RprUsdMaterialNodeInputTokens->uber_refraction_weight,
       RPR_MATERIAL_INPUT_UBER_REFRACTION_WEIGHT},
      {RprUsdMaterialNodeInputTokens->uber_refraction_roughness,
      ...
      {RprUsdMaterialNodeInputTokens->uber_refraction_normal,
       RPR_MATERIAL_INPUT_UBER_REFRACTION_NORMAL},
      {RprUsdMaterialNodeInputTokens->uber_refraction_thin_surface,
       RPR_MATERIAL_INPUT_UBER_REFRACTION_THIN_SURFACE},
      {RprUsdMaterialNodeInputTokens->uber_refraction_absorption_color,
       RPR_MATERIAL_INPUT_UBER_REFRACTION_ABSORPTION_COLOR},
      {RprUsdMaterialNodeInputTokens->uber_refraction_absorption_distance,
       RPR_MATERIAL_INPUT_UBER_REFRACTION_ABSORPTION_DISTANCE},
      {RprUsdMaterialNodeInputTokens->uber_refraction_caustics,
      ...
      {RprUsdMaterialNodeInputTokens->uber_coating_roughness,
      ...
      {RprUsdMaterialNodeInputTokens->uber_coating_metalness,
      ...
      {RprUsdMaterialNodeInputTokens->uber_coating_transmission_color,
       RPR_MATERIAL_INPUT_UBER_COATING_TRANSMISSION_COLOR},
      {RprUsdMaterialNodeInputTokens->uber_coating_thickness,
       RPR_MATERIAL_INPUT_UBER_COATING_THICKNESS},
      ...
      {RprUsdMaterialNodeInputTokens->uber_emission_weight,
      ...
      {RprUsdMaterialNodeInputTokens->uber_sss_scatter_color,
       RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_COLOR},
      {RprUsdMaterialNodeInputTokens->uber_sss_scatter_distance,
       RPR_MATERIAL_INPUT_UBER_SSS_SCATTER_DISTANCE},
      {RprUsdMaterialNodeInputTokens->uber_sss_scatter_direction,
      ...
      {RprUsdMaterialNodeInputTokens->uber_sss_multiscatter,
       RPR_MATERIAL_INPUT_UBER_SSS_MULTISCATTER},
      {RprUsdMaterialNodeInputTokens->uber_backscatter_weight,
       RPR_MATERIAL_INPUT_UBER_BACKSCATTER_WEIGHT},
      {RprUsdMaterialNodeInputTokens->uber_backscatter_color,
       RPR_MATERIAL_INPUT_UBER_BACKSCATTER_COLOR},
      {RprUsdMaterialNodeInputTokens->uber_fresnel_schlick_approximation,
...
bool ToRpr(TfToken const &id, uint32_t *out, bool pedantic)
{
  static const std::map<TfToken, uint32_t> s_mapping = {
      ...
      {RprUsdMaterialInputModeTokens->shapeRandomColor,
       RPR_MATERIAL_NODE_LOOKUP_SHAPE_RANDOM_COLOR},
