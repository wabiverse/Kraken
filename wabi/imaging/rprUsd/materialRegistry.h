...
class RprUsdMaterialRegistry
{
 public:
  ...
  RPRUSD_API
  RPRMtlxLoader *GetMtlxLoader() const
  {
    return m_mtlxLoader.get();
  }

  /// Register implementation of the Node with \p id
  RPRUSD_API
  void Register(TfToken const &id,
                RprUsdMaterialNodeFactoryFnc factory,
...
class RprUsdMaterialNodeInfo
{
 public:
  ...
  virtual const char *GetUIFolder() const
  {
    return nullptr;
  };
};
...
inline void RprUsdMaterialRegistry::Register(TfToken const &id,
                                             RprUsdMaterialNodeFactoryFnc factory,
                                             RprUsdMaterialNodeInfo const *info)
{
