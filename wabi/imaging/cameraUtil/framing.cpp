...
{
  return (!dataWindow.IsEmpty()) && (!displayWindow.IsEmpty()) && pixelAspectRatio != 0.0f;
}

bool CameraUtilFraming::operator==(const CameraUtilFraming &other) const
{
  return displayWindow == other.displayWindow && dataWindow == other.dataWindow &&
