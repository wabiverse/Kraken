...
void HgiShaderGenerator::Execute(std::ostream &ss)
{
  // Use the protected version which can be overridden
  _Execute(ss, _originalShader);
}

const std::string &HgiShaderGenerator::_GetOriginalShader() const
{
...
const std::string &HgiShaderGenerator::_GetVersion() const
{
  return _version;
}
