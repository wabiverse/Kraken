...
#ifndef WABI_IMAGING_HGI_SHADERGENERATOR_H
#define WABI_IMAGING_HGI_SHADERGENERATOR_H
...
class HgiShaderGenerator
{
 ...
 protected:
  ...
  HGI_API
  virtual void _Execute(std::ostream &ss, const std::string &originalShaderCode) = 0;
