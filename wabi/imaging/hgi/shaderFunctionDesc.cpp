...
{
  return lhs.nameInShader == rhs.nameInShader && lhs.type == rhs.type && lhs.role == rhs.role &&
         lhs.attribute == rhs.attribute && lhs.attributeIndex == rhs.attributeIndex;
}
...
void HgiShaderFunctionAddTexture(HgiShaderFunctionDesc *const desc,
...
void HgiShaderFunctionAddBuffer(HgiShaderFunctionDesc *const desc,
                                const std::string &nameInShader,
...
void HgiShaderFunctionAddConstantParam(HgiShaderFunctionDesc *const desc,
                                       const std::string &nameInShader,
                                       const std::string &type,
...
void HgiShaderFunctionAddStageInput(HgiShaderFunctionDesc *const desc,
                                    const std::string &nameInShader,
                                    const std::string &type,
                                    const std::string &role,
                                    const std::string &attribute,
...
void HgiShaderFunctionAddStageOutput(HgiShaderFunctionDesc *const desc,
                                     const std::string &nameInShader,
                                     const std::string &type,
                                     const std::string &role,
                                     const std::string &attribute,
