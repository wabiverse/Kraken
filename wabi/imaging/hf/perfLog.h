 ...
 */
#ifndef WABI_IMAGING_HF_PERF_LOG_H
#define WABI_IMAGING_HF_PERF_LOG_H
...
#define HF_MALLOC_TAG_FUNCTION() \
  TfAutoMallocTag2 tagFunc(TF_PP_STRINGIZE(MFB_PACKAGE_NAME), __ARCH_PRETTY_FUNCTION__);
...
#endif  // WABI_IMAGING_HF_PERF_LOG_H
