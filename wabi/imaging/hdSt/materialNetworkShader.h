...
//
#ifndef WABI_IMAGING_HD_ST_MATERIAL_NETWORK_SHADER_H
#define WABI_IMAGING_HD_ST_MATERIAL_NETWORK_SHADER_H
...
#endif //WABI_IMAGING_HD_ST_MATERIAL_NETWORK_SHADER_H
