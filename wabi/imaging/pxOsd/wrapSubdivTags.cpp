...
static std::string _ReprSubdivTags(const PxOsdSubdivTags &tags)
{
...
void wrapSubdivTags()
{
  ...
  class_<This>("SubdivTags", init<>())
    ...
    .def("GetFaceVaryingInterpolationRule", &This::GetFaceVaryingInterpolationRule)
    .def("SetFaceVaryingInterpolationRule", &This::SetFaceVaryingInterpolationRule)
    ...
    .def("GetCreaseIndices", &This::GetCreaseIndices, return_value_policy<copy_const_reference>())
    .def("SetCreaseIndices", &This::SetCreaseIndices)
    .def("GetCreaseLengths", &This::GetCreaseLengths, return_value_policy<copy_const_reference>())
    .def("SetCreaseLengths", &This::SetCreaseLengths)
    .def("GetCreaseWeights", &This::GetCreaseWeights, return_value_policy<copy_const_reference>())
    .def("SetCreaseWeights", &This::SetCreaseWeights)
    .def("GetCornerIndices", &This::GetCornerIndices, return_value_policy<copy_const_reference>())
    .def("SetCornerIndices", &This::SetCornerIndices)
    .def("GetCornerWeights", &This::GetCornerWeights, return_value_policy<copy_const_reference>())
