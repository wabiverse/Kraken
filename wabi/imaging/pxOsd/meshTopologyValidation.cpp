...
TF_REGISTRY_FUNCTION(TfEnum)
{
  ...
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidTriangleSubdivision);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidVertexInterpolationRule);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidFaceVaryingInterpolationRule);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCreaseMethod);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCreaseLengthElement);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCreaseIndicesSize);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCreaseIndicesElement);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCreaseWeightsSize);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::NegativeCreaseWeights);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCornerIndicesElement);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::NegativeCornerWeights);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidCornerWeightsSize);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidFaceVertexCountsElement);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidFaceVertexIndicesElement);
  TF_ADD_ENUM_NAME(PxOsdMeshTopologyValidation::Code::InvalidFaceVertexIndicesSize);
};

PxOsdMeshTopologyValidation::PxOsdMeshTopologyValidation(PxOsdMeshTopology const &topology)
{
  TRACE_FUNCTION();
...
template<size_t S>
void PxOsdMeshTopologyValidation::_ValidateToken(PxOsdMeshTopologyValidation::Code code,
                                                 const char *name,
                                                 const TfToken &token,
...
void PxOsdMeshTopologyValidation::_ValidateOrientation(PxOsdMeshTopology const &topology)
{
  ...
  _ValidateToken(Code::InvalidOrientation,
                 "orientation",
...
void PxOsdMeshTopologyValidation::_ValidateCreaseMethod(PxOsdMeshTopology const &topology)
{
  static const TfToken empty;
...
void PxOsdMeshTopologyValidation::_ValidateHoles(PxOsdMeshTopology const &topology)
{
...
void PxOsdMeshTopologyValidation::_ValidateFaceVertexCounts(PxOsdMeshTopology const &topology)
{
...
void PxOsdMeshTopologyValidation::_ValidateFaceVertexIndices(PxOsdMeshTopology const &topology)
{
