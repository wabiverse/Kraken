...
//
#ifndef WABI_IMAGING_HDX_FULLSCREENSHADER_H
#define WABI_IMAGING_HDX_FULLSCREENSHADER_H
...
class HdxFullscreenShader
{
 public:
  ...
  HDX_API
  void SetProgram(TfToken const &glslfx,
  ...
  HDX_API
  void BindTextures(TfTokenVector const &names, HgiTextureHandleVector const &textures);
  ...
  HDX_API
  void SetShaderConstants(uint32_t byteSize, const void *data);
...
#endif  // WABI_IMAGING_HDX_FULLSCREENSHADER_H
