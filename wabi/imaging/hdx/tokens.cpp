...
TF_DEFINE_PUBLIC_TOKENS(HdxColorChannelTokens, HDX_COLOR_CHANNEL_TOKENS);
TF_DEFINE_PUBLIC_TOKENS(HdxAovTokens, HDX_AOV_TOKENS);
TF_DEFINE_PUBLIC_TOKENS(HdxSimpleLightTaskTokens, HDX_SIMPLELIGHTTASK_TOKENS);
