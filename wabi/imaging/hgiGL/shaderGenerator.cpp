...
void HgiGLShaderGenerator::_WriteVersion(std::ostream &ss)
{
...
void HgiGLShaderGenerator::_WriteMacros(std::ostream &ss)
{
  ...
  const std::string &qualifier)
{
  for (const HgiShaderFunctionParamBlockDesc &p : parameterBlocks) {
    ...
    CreateShaderSection<HgiGLInterstageBlockShaderSection>(p.blockName,
                                                           p.instanceName,
                                                           qualifier,
                                                           p.arraySize,
                                                           members);
...
void HgiGLShaderGenerator::_Execute(std::ostream &ss)
{
