...
void HgiGLShaderSection::WriteDeclaration(std::ostream &ss) const
{
...
bool HgiGLShaderSection::VisitGlobalIncludes(std::ostream &ss)
{
  return false;
}

bool HgiGLShaderSection::VisitGlobalMacros(std::ostream &ss)
{
  return false;
}

bool HgiGLShaderSection::VisitGlobalStructs(std::ostream &ss)
{
  return false;
}
...
bool HgiGLShaderSection::VisitGlobalFunctionDefinitions(std::ostream &ss)
{
  return false;
}
...
bool HgiGLMacroShaderSection::VisitGlobalMacros(std::ostream &ss)
{
  WriteIdentifier(ss);
  return true;
}
...
void HgiGLMemberShaderSection::WriteType(std::ostream &ss) const
{
  ss << _typeName;
}
...
bool HgiGLBlockShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  ss << "layout(std140, binding = " << _bindingNo << ") "
     << "uniform"
     << " ";
  WriteIdentifier(ss);
  ss << "\n";
...
bool HgiGLTextureShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  WriteDeclaration(ss);
  return true;
}
...
void HgiGLBufferShaderSection::WriteType(std::ostream &ss) const
{
  ss << _type;
}

bool HgiGLBufferShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  // If it has attributes, write them with corresponding layout
  // identifiers and indicies
  const HgiShaderSectionAttributeVector &attributes = GetAttributes();
...
void HgiGLKeywordShaderSection::WriteType(std::ostream &ss) const
{
  ss << _type;
}

bool HgiGLKeywordShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  WriteType(ss);
  ss << " ";
  WriteIdentifier(ss);
