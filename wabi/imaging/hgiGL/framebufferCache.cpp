...
static void _CreateFramebuffer(const _FramebufferDesc &desc, uint32_t *const framebuffer)
{
  // Create framebuffer
...
static HgiGLDescriptorCacheItem *_CreateDescriptorCacheItem(const _FramebufferDesc &desc)
{
  TRACE_FUNCTION();
...
static void _DestroyDescriptorCacheItem(HgiGLDescriptorCacheItem *dci)
{
  TRACE_FUNCTION();
...
uint32_t HgiGLFramebufferCache::AcquireFramebuffer(HgiGraphicsCmdsDesc const &graphicsCmdsDesc,
                                                   const bool resolved)
{
  TRACE_FUNCTION();
