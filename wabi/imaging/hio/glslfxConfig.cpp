...
static VtValue _GetDefaultValue(const std::string &attributeName,
                                ...
                                std::string *const errorStr)
{
  ...
  const bool hasDefaultValue = TfMapLookup(attributeDataDict, _tokens->defVal, &defaultValue);
  ...
  if (!hasTypeNameValue)
  {
    ...
    *errorStr = TfStringPrintf("No type or default value for %s", attributeName.c_str());
  ...
  *errorStr = TfStringPrintf("Invalid type and no default value for %s", attributeName.c_str());
  return VtValue(std::vector<float>(4, 0.0f));
}

HioGlslfxConfig *HioGlslfxConfig::Read(TfToken const &technique,
                                       string const &input,
                                       string const &filename,
                                       string *errorStr)
{
  return new HioGlslfxConfig(technique, Hio_GetDictionaryFromInput(input, filename, errorStr), errorStr);
}

HioGlslfxConfig::HioGlslfxConfig(TfToken const &technique, VtDictionary const &dict, string *errors)
  : _technique(technique)
{
  _Init(dict, errors);
}

void HioGlslfxConfig::_Init(VtDictionary const &dict, string *errors)
{
  TRACE_FUNCTION();
...
HioGlslfxConfig::SourceKeys HioGlslfxConfig::GetSourceKeys(TfToken const &shaderStageKey) const
{
...
HioGlslfxConfig::_SourceKeyMap HioGlslfxConfig::_GetSourceKeyMap(VtDictionary const &dict,
...
static HioGlslfxConfig::Role _GetRoleFromString(string const &roleString, string *errorStr)
{
  ...
  *errorStr = TfStringPrintf("Unknown role specification: %s", roleString.c_str());
...
HioGlslfxConfig::Parameters HioGlslfxConfig::_GetParameters(VtDictionary const &dict, string *errorStr) const
{
  Parameters ret;
...
HioGlslfxConfig::Textures HioGlslfxConfig::_GetTextures(VtDictionary const &dict, string *errorStr) const
{
  Textures ret;
...
HioGlslfxConfig::Attributes HioGlslfxConfig::GetAttributes() const
{
  return _attributes;
}

HioGlslfxConfig::Attributes HioGlslfxConfig::_GetAttributes(VtDictionary const &dict, string *errorStr) const
{
  Attributes ret;
  ...
  for (const std::pair<std::string, VtValue> &p : attributesDict)
  {
    ...
    ret.push_back(
      Attribute(attributeName, _GetDefaultValue(attributeName, attributeDataDict, errorStr), docString));
  }

  return ret;
}

HioGlslfxConfig::MetadataDictionary HioGlslfxConfig::GetMetadata() const
{
  return _metadata;
}

HioGlslfxConfig::MetadataDictionary HioGlslfxConfig::_GetMetadata(VtDictionary const &dict,
                                                                  string *errorStr) const
{
