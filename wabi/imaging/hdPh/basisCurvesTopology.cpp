...
HdBufferSourceSharedPtr HdPh_BasisCurvesTopology::GetPointsIndexBuilderComputation()
{
  ...
  return HdBufferSourceSharedPtr(new HdVtBufferSource(HdTokens->indices, VtValue(finalIndices)));
}

HdBufferSourceSharedPtr HdPh_BasisCurvesTopology::GetIndexBuilderComputation(bool forceLines)
{
  return HdBufferSourceSharedPtr(new HdPh_BasisCurvesIndexBuilderComputation(this, forceLines));
}
