...
enum _ColorSpaceTransform { _SRGBToLinear, _LinearToSRGB };
...
void _PremultiplyAlpha(const void *const src, const size_t numTexels, void *const dst)
{
  TRACE_FUNCTION();
...
template<typename T>
void _PremultiplyAlphaFloat(const void *const src, const size_t numTexels, void *const dst)
{
  TRACE_FUNCTION();
  ...
  switch (hioFormat) {
    ...
    case HioFormatSNorm8Vec4:
      ...
      return {HgiFormatSNorm8Vec4,
              premultiplyAlpha ? _PremultiplyAlpha<signed char, /* isSRGB = */ false> : nullptr};
    ...
    case HioFormatFloat16Vec4:
      return {HgiFormatFloat16Vec4, premultiplyAlpha ? _PremultiplyAlphaFloat<GfHalf> : nullptr};
    ...
    case HioFormatFloat32Vec4:
      return {HgiFormatFloat32Vec4, premultiplyAlpha ? _PremultiplyAlphaFloat<float> : nullptr};
    ...
    case HioFormatDouble64Vec4:
      TF_WARN("Double texture formats not supported by Phoenix");
    ...
    case HioFormatUInt16Vec4:
      ...
      return {HgiFormatUInt16Vec4,
              premultiplyAlpha ? _PremultiplyAlpha<uint16_t, /* isSRGB = */ false> : nullptr};
    ...
    case HioFormatInt32Vec4:
      ...
      return {HgiFormatInt32Vec4,
              premultiplyAlpha ? _PremultiplyAlpha<int32_t, /* isSRGB = */ false> : nullptr};
...
HgiFormat HdPhTextureUtils::GetHgiFormat(HioFormat hioFormat, const bool premultiplyAlpha)
{
...
static GfVec3i _GetDimensions(HioImageSharedPtr const &image)
{
...
bool HdPhTextureUtils::ReadAndConvertImage(HioImageSharedPtr const &image,
                                           const bool flipped,
                                           const bool premultiplyAlpha,
