 ...
 */
#ifndef WABI_IMAGING_HD_PH_EXT_COMP_GPU_COMPUTATION_RESOURCE_H
#define WABI_IMAGING_HD_PH_EXT_COMP_GPU_COMPUTATION_RESOURCE_H
...
#endif  // WABI_IMAGING_HD_PH_EXT_COMP_GPU_COMPUTATION_RESOURCE_H
