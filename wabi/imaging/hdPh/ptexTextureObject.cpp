...
bool HdPhIsSupportedPtexTexture(std::string const &imageFilePath)
{
#ifdef WITH_PTEX
...
void HdPhPtexTextureObject::_Load()
{
  TRACE_FUNCTION();

  _DestroyTextures();

  TRACE_SCOPE("HdPhPtexTextureObject::_Load() (read ptex)");
  ...
  TRACE_SCOPE("HdPhPtexTextureObject::_Load() (generate texture)");
...
void HdPhPtexTextureObject::_Commit()
{
  TRACE_FUNCTION();
...
bool HdPhPtexTextureObject::IsValid() const
{
  return _format != HgiFormatInvalid;
}

HdTextureType HdPhPtexTextureObject::GetTextureType() const
{
