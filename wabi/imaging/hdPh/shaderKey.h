...
//
#ifndef WABI_IMAGING_HD_ST_SHADER_KEY_H
#define WABI_IMAGING_HD_ST_SHADER_KEY_H

#include "wabi/base/tf/token.h"
#include "wabi/imaging/hd/enums.h"
#include "wabi/imaging/hd/version.h"
#include "wabi/imaging/hdPh/api.h"
#include "wabi/imaging/hdPh/geometricShader.h"  // XXX: for PrimitiveType
#include "wabi/wabi.h"
...
struct HdPh_ShaderKey
{
  ...
  HDPH_API
  virtual HdPh_GeometricShader::FvarPatchType GetFvarPatchType() const;
};

WABI_NAMESPACE_END

#endif  // WABI_IMAGING_HD_ST_SHADER_KEY_H
