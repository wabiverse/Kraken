...
bool HdPhIsSupportedUdimTexture(std::string const &imageFilePath)
{
...
void HdPhUdimTextureObject::_Load()
{
  ...
  _dimensions = HdPhTextureUtils::ComputeDimensionsFromTargetMemory(firstImageMips,
                                                                    _hgiFormat,
                                                                    _tileCount,
                                                                    GetTargetMemory());
...
bool HdPhUdimTextureObject::IsValid() const
{
  // Checking whether ptex texture is valid not supported yet.
  return true;
}

HdTextureType HdPhUdimTextureObject::GetTextureType() const
{
