...
//
#ifndef WABI_IMAGING_HD_ST_MESH_SHADER_KEY_H
#define WABI_IMAGING_HD_ST_MESH_SHADER_KEY_H
...
struct HdPh_MeshShaderKey : public HdPh_ShaderKey {
  ...
  HdPh_GeometricShader::FvarPatchType GetFvarPatchType() const override
  {
...
#endif  // WABI_IMAGING_HD_ST_MESH_SHADER_KEY_H
