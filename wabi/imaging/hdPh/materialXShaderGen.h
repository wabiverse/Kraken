...
//
#ifndef WABI_IMAGING_HD_ST_MATERIALX_SHADER_GEN_H
#define WABI_IMAGING_HD_ST_MATERIALX_SHADER_GEN_H
...
class HdPhMaterialXShaderGen : public MaterialX::GlslShaderGenerator
{
 public:
  ...
  {
    return std::make_shared<HdPhMaterialXShaderGen>(mxHdInfo);
  }
