...
//
#ifndef HDPH_PTEX_MIPMAP_TEXTURE_LOADER_H
#define HDPH_PTEX_MIPMAP_TEXTURE_LOADER_H
...
class HdPhPtexMipmapTextureLoader final
{
 ...
 private:
  ...
  struct Block
  {
    ...
    void guttering(HdPhPtexMipmapTextureLoader *loader,
                   PtexTexture *ptex,
                   int level,
                   int width,
                   int height,
...
#endif  // HDPH_PTEX_MIPMAP_TEXTURE_LOADER_H
