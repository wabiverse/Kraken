...
void HdPhDrawTargetRenderPassState::SetDepthPriority(HdDepthPriority priority)
{
  _depthPriority = priority;
}

void HdPhDrawTargetRenderPassState::SetCamera(const SdfPath &cameraId)
{
  _cameraId = cameraId;
}

void HdPhDrawTargetRenderPassState::SetRprimCollection(HdRprimCollection const &col)
{
  _rprimCollection = col;
  ++_rprimCollectionVersion;
}

void HdPhDrawTargetRenderPassState::SetAovBindings(const HdRenderPassAovBindingVector &aovBindings)
{
