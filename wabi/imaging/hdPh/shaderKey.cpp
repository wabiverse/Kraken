...
/*virtual*/
HdPh_ShaderKey::~HdPh_ShaderKey()
{
  /*NOTHING*/
}

HdPh_ShaderKey::ID HdPh_ShaderKey::ComputeHash() const
{
...
static std::string _JoinTokens(const char *stage, TfToken const *tokens, bool *firstStage)
{
...
std::string HdPh_ShaderKey::GetGlslfxString() const
{
  std::stringstream ss;
  ...
  if (!GetGlslfxFilename().IsEmpty())
    ss << "#import $TOOLS/hdPh/shaders/" << GetGlslfxFilename().GetText() << "\n";
...
/*virtual*/
TfToken const *HdPh_ShaderKey::GetVS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdPh_ShaderKey::GetTCS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdPh_ShaderKey::GetTES() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdPh_ShaderKey::GetGS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdPh_ShaderKey::GetFS() const
{
  return nullptr;
}

/*virtual*/
bool HdPh_ShaderKey::IsFrustumCullingPass() const
{
  return false;
}

/*virtual*/
HdCullStyle HdPh_ShaderKey::GetCullStyle() const
{
  return HdCullStyleDontCare;
}

/*virtual*/
bool HdPh_ShaderKey::UseHardwareFaceCulling() const
{
  return false;
}

/*virtual*/
bool HdPh_ShaderKey::HasMirroredTransform() const
{
  return false;
}

/*virtual*/
bool HdPh_ShaderKey::IsDoubleSided() const
{
  return false;
}

/*virtual*/
HdPolygonMode HdPh_ShaderKey::GetPolygonMode() const
{
  return HdPolygonModeFill;
}

/*virtual*/
float HdPh_ShaderKey::GetLineWidth() const
{
  return 0.0f;
}

/*virtual*/
HdPh_GeometricShader::FvarPatchType HdPh_ShaderKey::GetFvarPatchType() const
{
  return HdPh_GeometricShader::FvarPatchType::PATCH_NONE;
}
