 ...
 */
#ifndef WABI_IMAGING_HD_PH_VBO_SIMPLE_MEMORY_MANAGER_H
#define WABI_IMAGING_HD_PH_VBO_SIMPLE_MEMORY_MANAGER_H
...
#endif  // WABI_IMAGING_HD_PH_VBO_SIMPLE_MEMORY_MANAGER_H
