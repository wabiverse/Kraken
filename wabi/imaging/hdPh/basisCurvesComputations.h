...
//
#ifndef WABI_IMAGING_HD_ST_BASIS_CURVES_COMPUTATIONS_H
#define WABI_IMAGING_HD_ST_BASIS_CURVES_COMPUTATIONS_H
...
class HdPh_BasisCurvesPrimvarInterpolaterComputation : public HdComputedBufferSource {
 public:
  ...
  virtual bool Resolve() override
  {
    ...
    _SetResult(std::make_shared<HdVtBufferSource>(_name, VtValue(primvars)));
...
#endif  // WABI_IMAGING_HD_ST_BASIS_CURVES_COMPUTATIONS_H
