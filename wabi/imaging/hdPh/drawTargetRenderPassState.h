 ...
 */
#ifndef WABI_IMAGING_HD_PH_DRAW_TARGET_RENDER_PASS_STATE_H
#define WABI_IMAGING_HD_PH_DRAW_TARGET_RENDER_PASS_STATE_H
...
#endif  // WABI_IMAGING_HD_PH_DRAW_TARGET_RENDER_PASS_STATE_H
