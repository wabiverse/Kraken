 ...
 */
#ifndef WABI_IMAGING_HD_PH_FALLBACK_LIGHTING_SHADER_H
#define WABI_IMAGING_HD_PH_FALLBACK_LIGHTING_SHADER_H
...
#endif  // WABI_IMAGING_HD_PH_FALLBACK_LIGHTING_SHADER_H
