      ...
      _wrapInfo{HdWrapNoOpinion, HdWrapNoOpinion}
{
  ...
  _textureDesc.debugName = filePath + " - flipVertically=" +
                           ...
                           " - premultiplyAlpha=" + std::to_string(int(premultiplyAlpha)) +
                           " - sourceColorSpace=" + _ToString(sourceColorSpace);
...
HdPhAssetUvTextureCpuData::~HdPhAssetUvTextureCpuData() = default;
...
const HgiTextureDesc &HdPhAssetUvTextureCpuData::GetTextureDesc() const
{
  return _textureDesc;
}

bool HdPhAssetUvTextureCpuData::GetGenerateMipmaps() const
{
  return _generateMipmaps;
}

bool HdPhAssetUvTextureCpuData::IsValid() const
{
