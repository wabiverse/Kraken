 ...
 */
#include "wabi/imaging/hdPh/glfTextureCpuData.h"

#include "wabi/imaging/hdPh/textureUtils.h"

#include "wabi/imaging/glf/baseTextureData.h"
...
HgiTextureType _GetTextureType(const int numDimensions)
{
...
bool _IsValid(GlfBaseTextureDataConstRefPtr const &textureData)
{
...
HdPhGlfTextureCpuData::HdPhGlfTextureCpuData(GlfBaseTextureDataConstRefPtr const &textureData,
    ...
    : _generateMipmaps(false)
{
  ...
  HdPhTextureUtils::ConversionFunction conversionFunction = nullptr;
  _textureDesc.format = HdPhTextureUtils::GetHgiFormat(hioFormat,
                                                       premultiplyAlpha,
...
HdPhGlfTextureCpuData::~HdPhGlfTextureCpuData() = default;

const HgiTextureDesc &HdPhGlfTextureCpuData::GetTextureDesc() const
{
  return _textureDesc;
}

bool HdPhGlfTextureCpuData::GetGenerateMipmaps() const
{
  return _generateMipmaps;
}

bool HdPhGlfTextureCpuData::IsValid() const
{
