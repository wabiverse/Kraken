...
{
  return HdFormatCount == 25 && HdFormatUNorm8 == 0 && HgiFormatUNorm8 == 0 &&
         HdFormatFloat16Vec4 == 11 && HgiFormatFloat16Vec4 == 9 && HdFormatFloat32Vec4 == 15 &&
         HgiFormatFloat32Vec4 == 13 && HdFormatUInt16Vec4 == 19 && HgiFormatUInt16Vec4 == 17 &&
...
const _WrapDesc WRAP_DESC[] = {{HdWrapClamp, HgiSamplerAddressModeClampToEdge},
...
{
  return HdWrapClamp == 0 && HdWrapLegacyNoOpinionFallbackRepeat == 5;
}
...
const _MagDesc MAG_DESC[] = {{HdMagFilterNearest, HgiSamplerFilterNearest},
                             {HdMagFilterLinear, HgiSamplerFilterLinear}};

constexpr bool _CompileTimeValidateMagTable()
{
  return HdMagFilterNearest == 0 && HdMagFilterLinear == 1;
}
...
const _MinDesc MIN_DESC[] = {
    {HdMinFilterNearest, HgiSamplerFilterNearest, HgiMipFilterNotMipmapped},
    {HdMinFilterLinear, HgiSamplerFilterLinear, HgiMipFilterNotMipmapped},
    {HdMinFilterNearestMipmapNearest, HgiSamplerFilterNearest, HgiMipFilterNearest},
    {HdMinFilterLinearMipmapNearest, HgiSamplerFilterLinear, HgiMipFilterNearest},
    {HdMinFilterNearestMipmapLinear, HgiSamplerFilterNearest, HgiMipFilterLinear},
    {HdMinFilterLinearMipmapLinear, HgiSamplerFilterLinear, HgiMipFilterLinear}};
...
void HdPhHgiConversions::GetHgiMinAndMipFilter(const HdMinFilter hdMinFilter,
