...
//
#ifndef WABI_IMAGING_HD_ST_MATERIALX_FILTER_H
#define WABI_IMAGING_HD_ST_MATERIALX_FILTER_H
...
std::string HdPh_GenMaterialXShaderCode(MaterialX::DocumentPtr const &mxDoc,
