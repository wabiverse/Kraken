 ...
 */
#ifndef WABI_IMAGING_HGI_METAL_GRAPHICS_CMDS_H
#define WABI_IMAGING_HGI_METAL_GRAPHICS_CMDS_H
...
class HgiMetalGraphicsCmds final : public HgiGraphicsCmds
{
 public:
  ...
  HGIMETAL_API
  void Draw(uint32_t vertexCount, uint32_t firstVertex, uint32_t instanceCount) override;
