...
HgiShaderFunctionHandleVector const &HgiMetalShaderProgram::GetShaderFunctions() const
{
  return _descriptor.shaderFunctions;
}

bool HgiMetalShaderProgram::IsValid() const
{
  return true;
}

std::string const &HgiMetalShaderProgram::GetCompileErrors()
{
  return _errors;
}
