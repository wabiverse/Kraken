...
void HgiMetalResourceBindings::BindResources(id<MTLRenderCommandEncoder> renderEncoder)
{
  //
...
void HgiMetalResourceBindings::BindResources(id<MTLComputeCommandEncoder> computeEncoder)
{
  //
  // Bind Textures and Samplers
  //
