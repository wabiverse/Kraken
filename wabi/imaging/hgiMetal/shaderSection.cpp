...
bool HgiMetalShaderSection::VisitScopeStructs(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitScopeFunctionDefinitions(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitScopeConstructorDeclarations(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitScopeConstructorInitialization(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitEntryPointParameterDeclarations(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitScopeConstructorInstantiation(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitEntryPointFunctionExecutions(std::ostream &ss,
                                                              const std::string &scopeInstanceName)
{
  return false;
}

void HgiMetalShaderSection::WriteAttributesWithIndex(std::ostream &ss) const
{
...
void HgiMetalMemberShaderSection::WriteType(std::ostream &ss) const
{
  ss << _type;
}

bool HgiMetalMemberShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
...
HgiMetalSamplerShaderSection::HgiMetalSamplerShaderSection(
  ...
  const HgiShaderSectionAttributeVector &attributes)
  : HgiMetalShaderSection("samplerBind_" + textureSharedIdentifier, attributes),
...
void HgiMetalSamplerShaderSection::WriteType(std::ostream &ss) const
{
...
void HgiMetalSamplerShaderSection::WriteParameter(std::ostream &ss) const
{
  if (_arrayOfSamplersSize > 0) {
    ss << "#define " << _textureSharedIdentifier << "_SIZE " << _arrayOfSamplersSize << "\n";
  }
  WriteType(ss);
  ss << " ";
  WriteIdentifier(ss);
...
bool HgiMetalSamplerShaderSection::VisitScopeConstructorDeclarations(std::ostream &ss)
{
  WriteType(ss);
  ss << " _";
  WriteIdentifier(ss);
...
bool HgiMetalSamplerShaderSection::VisitScopeConstructorInitialization(std::ostream &ss)
{
  WriteIdentifier(ss);
  ss << "(_";
  WriteIdentifier(ss);
...
bool HgiMetalSamplerShaderSection::VisitScopeConstructorInstantiation(std::ostream &ss)
{
...
bool HgiMetalSamplerShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
  WriteDeclaration(ss);
  ss << std::endl;
  return true;
...
HgiMetalTextureShaderSection::HgiMetalTextureShaderSection(
  ...
  : HgiMetalShaderSection("textureBind_" + samplerSharedIdentifier, attributes, defaultValue),
...
void HgiMetalTextureShaderSection::WriteType(std::ostream &ss) const
{
...
void HgiMetalTextureShaderSection::WriteParameter(std::ostream &ss) const
{
  WriteType(ss);
  ss << " ";
  WriteIdentifier(ss);
...
bool HgiMetalTextureShaderSection::VisitScopeConstructorDeclarations(std::ostream &ss)
{
  WriteType(ss);
  ss << " _";
  WriteIdentifier(ss);
...
bool HgiMetalTextureShaderSection::VisitScopeConstructorInitialization(std::ostream &ss)
{
  WriteIdentifier(ss);
  ss << "(_";
  WriteIdentifier(ss);
...
bool HgiMetalTextureShaderSection::VisitScopeConstructorInstantiation(std::ostream &ss)
{
  if (!_parentScopeIdentifier.empty()) {
    ss << _parentScopeIdentifier << "->";
  }
...
bool HgiMetalTextureShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
  WriteDeclaration(ss);
  ss << std::endl;
  return true;
...
bool HgiMetalTextureShaderSection::VisitScopeFunctionDefinitions(std::ostream &ss)
{
  const std::string defValue = _GetDefaultValue().empty() ? "0" : _GetDefaultValue();
  ...
  if (_arrayOfTexturesSize > 0) {
    ...
    ss << " HgiGetSampler_" << _samplerSharedIdentifier << "(uint index) {\n"
       << "    return ";
    WriteIdentifier(ss);
    ss << "[index];\n}\n";
  } else {
  ...
  const std::string intType = _dimensionsVar == 1 ? "int" :
  ...
  const std::string coordType = dimensions > 1 ? "vec" + std::to_string(dimensions) : "float";
  ...
  //     return result;
  // }
  const std::string intCoordType = dimensions > 1 ? "ivec" + std::to_string(dimensions) : "int";
  ...
  ss << "    " << returnType << " result = " << returnType << "(textureBind_"
  ...
  if (_shadow) {
    ...
    ss << ", float lod) {\n"
       << "    " << returnType << " result = " << returnType << "(textureBind_"
       << _samplerSharedIdentifier;
    if (_arrayOfTexturesSize > 0) {
      ss << "[index]";
    }
...
HgiMetalBufferShaderSection::HgiMetalBufferShaderSection(
  ...
  const bool writable,
  const HgiShaderSectionAttributeVector &attributes)
  : HgiMetalShaderSection(samplerSharedIdentifier, attributes, ""),
    _type(type),
    _binding(binding),
    _writable(writable),
    _unused(false),
...
void HgiMetalBufferShaderSection::WriteType(std::ostream &ss) const
{
  ss << _type;
}

void HgiMetalBufferShaderSection::WriteParameter(std::ostream &ss) const
{
  if (!_writable) {
    ss << "const ";
  }
...
bool HgiMetalBufferShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
  if (_unused)
    return false;
...
bool HgiMetalBufferShaderSection::VisitScopeConstructorDeclarations(std::ostream &ss)
{
  if (_unused)
    return false;
...
bool HgiMetalBufferShaderSection::VisitScopeConstructorInitialization(std::ostream &ss)
{
  if (_unused)
    return false;
...
bool HgiMetalBufferShaderSection::VisitScopeConstructorInstantiation(std::ostream &ss)
{
  if (_unused)
    return false;
...
void HgiMetalStructTypeDeclarationShaderSection::WriteType(std::ostream &ss) const
{
  ss << "struct";
}

void HgiMetalStructTypeDeclarationShaderSection::WriteDeclaration(std::ostream &ss) const
{
  WriteType(ss);
  ss << " ";
  WriteIdentifier(ss);
...
void HgiMetalStructTypeDeclarationShaderSection::WriteParameter(std::ostream &ss) const {}

void HgiMetalStructTypeDeclarationShaderSection::WriteTemplateWrapper(std::ostream &ss) const
{
...
const HgiMetalShaderSectionPtrVector &HgiMetalStructTypeDeclarationShaderSection::GetMembers()
  const
{
  return _members;
}
...
HgiMetalStructInstanceShaderSection::HgiMetalStructInstanceShaderSection(
  ...
  const std::string &defaultValue)
  : HgiMetalShaderSection(identifier, attributes, defaultValue),
    _structTypeDeclaration(structTypeDeclaration)
{}

void HgiMetalStructInstanceShaderSection::WriteType(std::ostream &ss) const
{
  _structTypeDeclaration->WriteIdentifier(ss);
}

const HgiMetalStructTypeDeclarationShaderSection *HgiMetalStructInstanceShaderSection::
...
HgiMetalParameterInputShaderSection::HgiMetalParameterInputShaderSection(
  ...
  HgiMetalStructTypeDeclarationShaderSection *structTypeDeclaration)
  : HgiMetalStructInstanceShaderSection(identifier, attributes, structTypeDeclaration),
    _addressSpace(addressSpace),
    _isPointer(isPointer)
{}

void HgiMetalParameterInputShaderSection::WriteParameter(std::ostream &ss) const
{
...
bool HgiMetalParameterInputShaderSection::VisitEntryPointParameterDeclarations(std::ostream &ss)
{
...
bool HgiMetalParameterInputShaderSection::VisitEntryPointFunctionExecutions(
  std::ostream &ss,
  const std::string &scopeInstanceName)
{
...
bool HgiMetalParameterInputShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
...
void HgiMetalArgumentBufferInputShaderSection::WriteParameter(std::ostream &ss) const
{
  WriteType(ss);
  ss << " ";
  if (_isPointer) {
...
bool HgiMetalArgumentBufferInputShaderSection::VisitEntryPointParameterDeclarations(
  std::ostream &ss)
{
  if (!_addressSpace.empty()) {
    ss << _addressSpace << " ";
...
bool HgiMetalArgumentBufferInputShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  GetStructTypeDeclaration()->WriteDeclaration(ss);
  ss << "\n";
  return true;
...
void HgiMetalKeywordInputShaderSection::WriteType(std::ostream &ss) const
{
  ss << _type;
}

bool HgiMetalKeywordInputShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
  WriteType(ss);
  ss << " ";
  WriteIdentifier(ss);
...
bool HgiMetalKeywordInputShaderSection::VisitEntryPointParameterDeclarations(std::ostream &ss)
{
  WriteType(ss);
  ss << " ";
  WriteIdentifier(ss);
...
bool HgiMetalKeywordInputShaderSection::VisitEntryPointFunctionExecutions(
  std::ostream &ss,
  const std::string &scopeInstanceName)
{
  ss << scopeInstanceName << ".";
...
HgiMetalStageOutputShaderSection::HgiMetalStageOutputShaderSection(
  const std::string &identifier,
  HgiMetalStructTypeDeclarationShaderSection *structTypeDeclaration)
  : HgiMetalStructInstanceShaderSection(identifier, {}, structTypeDeclaration)
{}
...
bool HgiMetalStageOutputShaderSection::VisitEntryPointFunctionExecutions(
  std::ostream &ss,
  const std::string &scopeInstanceName)
{
...
bool HgiMetalStageOutputShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  GetStructTypeDeclaration()->WriteDeclaration(ss);
  ss << "\n";
  return true;
...
bool HgiMetalShaderSection::VisitGlobalMacros(std::ostream &ss)
{
  return false;
}

bool HgiMetalShaderSection::VisitGlobalMemberDeclarations(std::ostream &ss)
{
  return false;
}

HgiMetalMacroShaderSection::HgiMetalMacroShaderSection(const std::string &macroDeclaration,
                                                       const std::string &macroComment)
  : HgiMetalShaderSection(macroDeclaration),
    _macroComment(macroComment)
{}

bool HgiMetalMacroShaderSection::VisitGlobalMacros(std::ostream &ss)
{
  WriteIdentifier(ss);
  return true;
}
...
HgiMetalInterstageBlockShaderSection::HgiMetalInterstageBlockShaderSection(
  ...
  : HgiMetalShaderSection(blockIdentifier,
...
const HgiMetalStructTypeDeclarationShaderSection *HgiMetalInterstageBlockShaderSection::
  GetStructTypeDeclaration() const
{
  return _structTypeDeclaration;
}

bool HgiMetalInterstageBlockShaderSection::VisitScopeStructs(std::ostream &ss)
{
  _structTypeDeclaration->WriteDeclaration(ss);
  return true;
}

bool HgiMetalInterstageBlockShaderSection::VisitScopeMemberDeclarations(std::ostream &ss)
{
  _structTypeDeclaration->WriteIdentifier(ss);
  ss << " ";
