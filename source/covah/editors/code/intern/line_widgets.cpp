...
NVec2f FloatSlider::GetSize() const
{
  ...
  return NVec2f((60.0f * m_dimension) + (m_sliderGap * (m_dimension - 1)),
                m_editor.GetDisplay().GetFont(ZepTextType::Text).GetPixelHeight() /
                  m_editor.GetDisplay().GetPixelScale().y);
}
