...
// Note:
// This is a very basic implementation of the common Vim commands that I use: the bare minimum I
// can live with. I do use more, and depending on how much pain I suffer, will add them over time.
// My aim is to make it easy to add commands, so if you want to put something in, please send me a
// PR. The buffer/display search and find support makes it easy to gather the info you need, and
// the basic insert/delete undo redo commands make it easy to find the locations in the buffer
// Important to note: I'm not trying to beat/better Vim here.  Just make an editor I can use in a
// viewport without feeling pain! See further down for what is implemented, and what's on my todo
// list
