...
// A scrollbar that is manually drawn and implemented.  This means it is independent of the backend
// and can be drawn the same in Qt and ANCHOR
namespace Zep
{
...
void Scroller::Display(ZepTheme &theme)
{
  ...
  display.DrawRectFilled(thumbRect,
                         thumbRect.Contains(mousePos) || m_scrollState == ScrollState::Drag ? activeColor :
                                                                                              inactiveColor);
}
