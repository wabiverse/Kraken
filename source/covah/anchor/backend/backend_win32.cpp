...
struct ANCHOR_ImplWin32_Data
{
    ...
    ANCHOR_ImplWin32_Data()      { memset(this, 0, sizeof(*this)); }
};
...
static bool ANCHOR_ImplWin32_UpdateMouseCursor()
{
    ...
    else
    {
        ...
        switch (imgui_cursor)
        {
        case ANCHOR_MouseCursor_Arrow:        win32_cursor = IDC_ARROW; break;
        case ANCHOR_MouseCursor_TextInput:    win32_cursor = IDC_IBEAM; break;
        case ANCHOR_MouseCursor_ResizeAll:    win32_cursor = IDC_SIZEALL; break;
        case ANCHOR_MouseCursor_ResizeEW:     win32_cursor = IDC_SIZEWE; break;
        case ANCHOR_MouseCursor_ResizeNS:     win32_cursor = IDC_SIZENS; break;
        case ANCHOR_MouseCursor_ResizeNESW:   win32_cursor = IDC_SIZENESW; break;
        case ANCHOR_MouseCursor_ResizeNWSE:   win32_cursor = IDC_SIZENWSE; break;
        case ANCHOR_MouseCursor_Hand:         win32_cursor = IDC_HAND; break;
        case ANCHOR_MouseCursor_NotAllowed:   win32_cursor = IDC_NO; break;
        }
