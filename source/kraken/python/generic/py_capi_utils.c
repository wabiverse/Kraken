...
/* -------------------------------------------------------------------- */
/** @name Access Current Frame File Name & Line Number
 * @{ */
...
/* -------------------------------------------------------------------- */
/** @name Name Space Creation/Manipulation
 * @{ */
...
/* -------------------------------------------------------------------- */
/** @name Run String (Evaluate to Primitive Types)
 * @{ */
