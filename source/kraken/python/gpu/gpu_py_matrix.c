...
static PyObject *pygpu_matrix_stack_context_enter(KPyGPU_MatrixStackContext *self);
static PyObject *pygpu_matrix_stack_context_exit(KPyGPU_MatrixStackContext *self, PyObject *args);
...
static PyTypeObject PyGPUMatrixStackContext_Type = {
  ...
  .tp_basicsize = sizeof(KPyGPU_MatrixStackContext),
...
static PyObject *pygpu_matrix_stack_context_exit(KPyGPU_MatrixStackContext *self,
...
{
  KPyGPU_MatrixStackContext *ret = PyObject_New(KPyGPU_MatrixStackContext,
...
static PyObject *pygpu_matrix_scale(PyObject *UNUSED(self), PyObject *value)
{
  ...
  // int len;
  // if ((len =
  //        mathutils_array_parse(scale, 2, 3, value, "gpu.matrix.scale(): invalid vector arg")) ==
  //     -1) {
  //   return NULL;
  // }
  // if (len == 2) {
...
static PyObject *pygpu_matrix_translate(PyObject *UNUSED(self), PyObject *value)
{
  // float offset[3];
  // int len;
  // if ((len = mathutils_array_parse(offset,
  //                                  2,
  //                                  3,
  //                                  value,
...
static struct PyMethodDef pygpu_matrix__tp_methods[] = {
 ...
 /* TODO */
  ...
  {"load_projection_matrix",
   ...
   METH_O,                                                                       pygpu_matrix_load_projection_matrix_doc},
 ...
 /* Read State */
  ...
  {"get_model_view_matrix",
   ...
   METH_NOARGS,                                                                  pygpu_matrix_get_model_view_matrix_doc },
  {"get_normal_matrix",
...
PyObject *kpygpu_matrix_init(void)
{
  PyObject *submodule;
