 ...
 */
void DRW_draw_view(const struct kContext *C);
/**
 ...
 */
void DRW_draw_render_loop_ex(struct Hydra *hydra,
                             struct RenderEngineType *engine_type,
                             struct ARegion *region,
                             struct View3D *v3d,
                             struct GPUViewport *viewport,
                             const struct kContext *evil_C);
void DRW_draw_render_loop(struct Hydra *hydra,
                          struct ARegion *region,
                          struct View3D *v3d,
                          struct GPUViewport *viewport);
/**
 ...
 */
void DRW_draw_render_loop_offscreen(struct Hydra *hydra,
                                    struct RenderEngineType *engine_type,
                                    struct ARegion *region,
                                    struct View3D *v3d,
                                    ...
                                    struct GPUViewport *viewport);
void DRW_draw_render_loop_2d_ex(struct Hydra *hydra,
                                struct ARegion *region,
                                struct GPUViewport *viewport,
                                const struct kContext *evil_C);
/**
 ...
 */
void DRW_draw_select_loop(struct Hydra *hydra,
                          struct ARegion *region,
                          struct View3D *v3d,
 ...
 */
void DRW_draw_depth_loop(struct Hydra *hydra,
                         struct ARegion *region,
                         struct View3D *v3d,
                         struct GPUViewport *viewport);
/**
 ...
 */
void DRW_draw_depth_loop_gpencil(struct Hydra *hydra,
                                 struct ARegion *region,
                                 struct View3D *v3d,
                                 struct GPUViewport *viewport);
/**
...
void DRW_draw_select_id(struct Hydra *hydra,
                        struct ARegion *region,
                        struct View3D *v3d,
                        const struct rcti *rect);
 ...
 */
bool DRW_render_check_grease_pencil(struct Hydra *hydra);
void DRW_render_gpencil(struct RenderEngine *engine, struct Hydra *hydra);
...
void DRW_cache_free_old_batches(struct Main *kmain);
...
/* Never use this. Only for closing kraken. */
 ...
 * @note This doesn't require the draw context to be in use.
 */
