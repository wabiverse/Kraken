...
KLI_STATIC_ASSERT_ALIGN(OVERLAY_GridData, 16)
...
KLI_STATIC_ASSERT(CURVE_HANDLE_SELECTED == 0, "Ensure value is sync");
KLI_STATIC_ASSERT(CURVE_HANDLE_ALL == 1, "Ensure value is sync");
KLI_STATIC_ASSERT(MOTIONPATH_VERT_SEL == (1 << 0), "Ensure value is sync");
KLI_STATIC_ASSERT(MOTIONPATH_VERT_KEY == (1 << 1), "Ensure value is sync");
#endif
