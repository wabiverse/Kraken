...
#pragma KRAKEN_REQUIRE(common_utiltex_lib.glsl)
#pragma KRAKEN_REQUIRE(lights_lib.glsl)
#pragma KRAKEN_REQUIRE(lightprobe_lib.glsl)
#pragma KRAKEN_REQUIRE(ambient_occlusion_lib.glsl)
#pragma KRAKEN_REQUIRE(bsdf_common_lib.glsl)
#pragma KRAKEN_REQUIRE(closure_eval_lib.glsl)
#pragma KRAKEN_REQUIRE(renderpass_lib.glsl)
