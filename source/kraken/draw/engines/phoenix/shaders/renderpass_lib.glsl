#define PHOENIX_AOV_HASH_COLOR_TYPE_MASK 1u
...
{
  return (renderPassAOVActive & PHOENIX_AOV_HASH_COLOR_TYPE_MASK) != 0u;
}

uint render_pass_aov_hash()
{
  return renderPassAOVActive & ~PHOENIX_AOV_HASH_COLOR_TYPE_MASK;
}
