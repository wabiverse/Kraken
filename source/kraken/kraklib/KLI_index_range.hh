 ...
 * \ingroup bli
 *
 * A `kraken::IndexRange` wraps an interval of non-negative integers. It can be used to reference
 ...
 *
 * Some containers like kraken::Vector have an index_range() method. This will return the
...
class IndexRange {
 ...
 public:
  ...
  constexpr IndexRange slice(int64_t start, int64_t size) const
  {
    ...
    KLI_assert(new_start + size <= start_ + size_ || size == 0);
