...
#  include "intern/KLI_math_base_inline.c"
#endif
...
#  define KLI_ASSERT_UNIT_V3_DB(v) \
    { \
      ...
      KLI_assert(!(fabs(_test_unit - 1.0) >= KLI_ASSERT_UNIT_EPSILON_DB) || \
                 !(fabs(_test_unit) >= KLI_ASSERT_UNIT_EPSILON_DB)); \
    } \
    (void)0
...
#  define KLI_ASSERT_UNIT_V3(v) (void)(v)
#  define KLI_ASSERT_UNIT_V3_DB(v) (void)(v)
#  define KLI_ASSERT_UNIT_QUAT(v) (void)(v)
#  define KLI_ASSERT_ZERO_M3(m) (void)(m)
#  define KLI_ASSERT_ZERO_M4(m) (void)(m)
#  define KLI_ASSERT_UNIT_M3(m) (void)(m)
#endif
