 ...
 */
char *KLI_strdupn(const char *str, size_t len) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
 ...
 * \retval Returns dst
 */
char *KLI_strncpy(char *__restrict dst, const char *__restrict src, size_t maxncpy) ATTR_NONNULL();

/**
 * Like KLI_strncpy but ensures dst is always padded by given char,
...
size_t KLI_strcpy_rlen(char *__restrict dst, const char *__restrict src) ATTR_WARN_UNUSED_RESULT
    ATTR_NONNULL();

/**
 * Return the range of the quoted string (excluding quotes) `str` after `prefix`.
 *
 * A version of #KLI_str_quoted_substrN that calculates the range
...
#if 0 /* UNUSED */
char *KLI_str_quoted_substrN(const char *__restrict str,
 ...
 * and returns it.
 *
 * @note A rather wasteful string-replacement utility, though this shall do for now.
 ...
 *
 * @note Larger tables should use a hash table.
 */
 ...
 * and return it.
 */
char *KLI_sprintfN(const char *__restrict format, ...) ATTR_WARN_UNUSED_RESULT
 ...
 *
 * @note This is used for creating animation paths in blend files.
 */
size_t KLI_str_escape(char *__restrict dst, const char *__restrict src, size_t dst_maxncpy)
    ATTR_NONNULL();
/**
 * This roughly matches C and Python's string escaping with double quotes - `"`.
 *
...
/**
 * See #KLI_str_unescape_ex doc-string.
 *
 * This function makes the assumption that `dst` always has
 * at least `src_maxncpy` bytes available.
 *
 * Use #KLI_str_unescape_ex if `dst` has a smaller fixed size.
 *
 * @note This is used for parsing animation paths in blend files (runs often).
 */
size_t KLI_str_unescape(char *__restrict dst, const char *__restrict src, size_t src_maxncpy)
    ATTR_NONNULL();
 ...
 */
const char *KLI_str_escape_find_quote(const char *str) ATTR_NONNULL();
 ...
 */
size_t KLI_str_format_int_grouped(char dst[16], int num) ATTR_NONNULL();
/**
 ...
 * \return The length of \a dst
 */
size_t KLI_str_format_uint64_grouped(char dst[16], uint64_t num) ATTR_NONNULL();
/**
 ...
 */
void KLI_str_format_byte_unit(char dst[15], long long int bytes, bool base_10) ATTR_NONNULL();
/**
 ...
 */
void KLI_str_format_decimal_unit(char dst[7], int number_to_format) ATTR_NONNULL();
/**
 * Compare two strings without regard to case.
 *
 * \retval True if the strings are equal, false otherwise.
 */
int KLI_strcaseeq(const char *a, const char *b) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
/**
...
/**
 * Variation of #KLI_strcasestr with string length limited to \a len
 */
char *KLI_strncasestr(const char *s, const char *find, size_t len) ATTR_WARN_UNUSED_RESULT
    ATTR_NONNULL();
 ...
 */
int KLI_strcmp_ignore_pad(const char *str1, const char *str2, char pad) ATTR_WARN_UNUSED_RESULT
    ATTR_NONNULL();

/**
 * Determine the length of a fixed-size string.
 */
size_t KLI_strnlen(const char *str, size_t maxlen) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();

/**
 * String case conversion, not affected by locale.
 */

void KLI_str_tolower_ascii(char *str, size_t len) ATTR_NONNULL();
void KLI_str_toupper_ascii(char *str, size_t len) ATTR_NONNULL();
 ...
 */
void KLI_str_rstrip(char *str) ATTR_NONNULL();
/**
 ...
 */
int KLI_str_rstrip_float_zero(char *str, char pad) ATTR_NONNULL();
 ...
 */
bool KLI_str_startswith(const char *__restrict str, const char *__restrict start) ATTR_NONNULL();
/**
 ...
 */
bool KLI_str_endswith(const char *__restrict str, const char *__restrict end) ATTR_NONNULL();
bool KLI_strn_endswith(const char *__restrict str, const char *__restrict end, size_t length)
    ATTR_NONNULL();
...
int KLI_string_max_possible_word_count(int str_len);
 ...
 */
int KLI_string_find_split_words(const char *str,
                                size_t len,
                                char delim,
                                int r_words[][2],
