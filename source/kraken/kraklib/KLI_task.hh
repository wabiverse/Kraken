...
namespace kraken::threading
{
  ...
  /**
   * Execute all of the provided functions. The functions might be executed in parallel or in
   * serial or some combination of both.
   */
   ...
   * the individual functions do very little work, there is a lot of overhead from starting
   * parallel tasks.
   */
  ...
  /** See #KLI_task_isolate for a description of what isolating a task means. */
