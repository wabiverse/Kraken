 ...
 */
int KLI_findstringindex(const struct ListBase *listbase,
                        const char *id,
 ...
 */
ListBase KLI_listbase_from_link(struct Link *some_link);
 ...
 */
void *KLI_findlinkfrom(struct Link *start, int number) ATTR_WARN_UNUSED_RESULT;
 ...
 */
void *KLI_findstring(const struct ListBase *listbase,
                     const char *id,
                     int offset) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL(1);
/**
 ...
 */
void *KLI_findstring_ptr(const struct ListBase *listbase,
                         const char *id,
                         int offset) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL(1);
/**
 ...
 */
void *KLI_findptr(const struct ListBase *listbase,
                  const void *ptr,
                  int offset) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL(1);
/**
 ...
 */
void *KLI_listbase_string_or_index_find(const struct ListBase *listbase,
                                        const char *string,
 ...
 * null-terminated string \a id at the specified offset, returning NULL if not found.
 */
void *KLI_rfindstring_ptr(const struct ListBase *listbase,
                          const char *id,
                          int offset) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL(1);
/**
 ...
 * at the specified offset, returning NULL if not found.
 */
void *KLI_rfindptr(const struct ListBase *listbase,
                   const void *ptr,
                   int offset) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL(1);
/**
 ...
 */
void KLI_freelistN(struct ListBase *listbase) ATTR_NONNULL(1);
/**
 * Appends \a vlink (assumed to begin with a Link) onto listbase.
 */
void KLI_addtail(struct ListBase *listbase, void *vlink) ATTR_NONNULL(1);
/**
 * Removes \a vlink from \a listbase. Assumes it is linked into there!
 */
void KLI_remlink(struct ListBase *listbase, void *vlink) ATTR_NONNULL(1);
/**
 * Checks that \a vlink is linked into listbase, removing it from there if so.
 */
bool KLI_remlink_safe(struct ListBase *listbase, void *vlink) ATTR_NONNULL(1);
/**
 * Removes the head from \a listbase and returns it.
 */
void *KLI_pophead(ListBase *listbase) ATTR_NONNULL(1);
/**
 * Removes the tail from \a listbase and returns it.
 */
void *KLI_poptail(ListBase *listbase) ATTR_NONNULL(1);

/**
 * Prepends \a vlink (assumed to begin with a Link) onto listbase.
 */
void KLI_addhead(struct ListBase *listbase, void *vlink) ATTR_NONNULL(1);
/**
 ...
 */
bool KLI_listbase_link_move(ListBase *listbase, void *vlink, int step) ATTR_NONNULL();
/**
 * Move the link at the index \a from to the position at index \a to.
 *
 * \return If the move was successful.
 */
bool KLI_listbase_move_index(ListBase *listbase, int from, int to) ATTR_NONNULL();
/**
 * Removes and disposes of the entire contents of listbase using direct free(3).
 */
void KLI_freelist(struct ListBase *listbase) ATTR_NONNULL(1);
/**
 ...
 */
int KLI_listbase_count(const struct ListBase *listbase) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL(1);
/**
 * Removes \a vlink from listbase and disposes of it. Assumes it is linked into there!
 */
void KLI_freelinkN(struct ListBase *listbase, void *vlink) ATTR_NONNULL(1);
 ...
 */
void KLI_listbases_swaplinks(struct ListBase *listbasea,
 ...
 */
void KLI_movelisttolist(struct ListBase *dst, struct ListBase *src) ATTR_NONNULL(1, 2);
/**
 * Moves the entire contents of \a src at the beginning of \a dst.
 */
void KLI_movelisttolist_reverse(struct ListBase *dst, struct ListBase *src) ATTR_NONNULL(1, 2);
/**
 ...
 */
KLI_INLINE bool KLI_listbase_is_single(const struct ListBase *lb)
{
  return (lb->first && lb->first == lb->last);
}
KLI_INLINE bool KLI_listbase_is_empty(const struct ListBase *lb)
{
  return (lb->first == (void *)0);
}
KLI_INLINE void KLI_listbase_clear(struct ListBase *lb)
{
 ...
 */
KLI_INLINE bool KLI_listbase_equal(const struct ListBase *a, const struct ListBase *b)
{
  if (a == NULL) {
    return b == NULL;
  }
 ...
 */
struct LinkData *KLI_genericNodeN(void *data);
...
#ifdef __cplusplus
KLI_INLINE bool operator==(const ListBase &a, const ListBase &b)
{
  return KLI_listbase_equal(&a, &b);
}
#endif
