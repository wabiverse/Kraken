...
namespace kraken::lazy_threading
{
  ...
  class HintReceiver
  {
   public:
     ...
     * \note The function has to stay alive after the call to the constructor. So one must not pass
     * a lambda directly into this constructor but store it in a separate variable on the stack
     * first.
     */
