 ...
 */
int KLI_exists(const char *path) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
int KLI_copy(const char *file, const char *to) ATTR_NONNULL();
/**
 * \return zero on success (matching 'rename' behavior).
 */
int KLI_rename(const char *from, const char *to) ATTR_NONNULL();
/**
 ...
 */
int KLI_delete(const char *file, bool dir, bool recursive) ATTR_NONNULL();
/**
 ...
 * \return zero on success (matching 'remove' behavior).
 */
int KLI_delete_soft(const char *file, const char **error_message) ATTR_NONNULL();
#if 0 /* Unused */
int KLI_move(const char *path, const char *to) ATTR_NONNULL();
int KLI_create_symlink(const char *path, const char *to) ATTR_NONNULL();
#endif

/* Keep in sync with the definition of struct `direntry` in `KLI_fileops_types.h`. */
#ifdef WIN32
#  if defined(_MSC_VER)
 ...
 */
bool KLI_is_dir(const char *path) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
/**
 * Does the specified path point to a non-directory?
 */
bool KLI_is_file(const char *path) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
/**
 * \return true on success (i.e. given path now exists on FS), false otherwise.
 */
bool KLI_dir_create_recursive(const char *dir) ATTR_NONNULL();
/**
 * Returns the number of free bytes on the volume containing the specified pathname.
 *
 * \note Not actually used anywhere.
 */
double KLI_dir_free_space(const char *dir) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
/**
 ...
 */
char *KLI_current_working_dir(char *dir, size_t maxncpy) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
eFileAttributes KLI_file_attributes(const char *path);
 ...
 */
unsigned int KLI_filelist_dir_contents(const char *dir, struct direntry **r_filelist);
/**
 * Deep-duplicate of a single direntry.
 */
void KLI_filelist_entry_duplicate(struct direntry *dst, const struct direntry *src);
/**
 * Deep-duplicate of a #direntry array including the array itself.
 */
void KLI_filelist_duplicate(struct direntry **dest_filelist,
 ...
 */
void KLI_filelist_free(struct direntry *filelist, unsigned int nrentries);

/**
 * Convert given entry's size into human-readable strings.
 */
void KLI_filelist_entry_size_to_string(const struct stat *st,
 ...
 */
void KLI_filelist_entry_mode_to_string(const struct stat *st,
                                       bool compact,
 ...
 */
void KLI_filelist_entry_owner_to_string(const struct stat *st,
                                        bool compact,
 ...
 */
void KLI_filelist_entry_datetime_to_string(const struct stat *st,
                                           int64_t ts,
                                           bool compact,
...
FILE *KLI_fopen(const char *filepath, const char *mode) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
void *KLI_gzopen(const char *filepath, const char *mode) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
int KLI_open(const char *filepath, int oflag, int pmode) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
int KLI_access(const char *filepath, int mode) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
 ...
 */
bool KLI_file_is_writable(const char *filepath) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
/**
 ...
 */
bool KLI_file_touch(const char *file) ATTR_NONNULL();
bool KLI_file_alias_target(const char *filepath, char *r_targetpath) ATTR_WARN_UNUSED_RESULT;

bool KLI_file_magic_is_gzip(const char header[4]);

size_t KLI_file_zstd_from_mem_at_pos(void *buf,
                                     size_t len,
                                     FILE *file,
                                     size_t file_offset,
                                     int compression_level) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
size_t KLI_file_unzstd_to_mem_at_pos(void *buf, size_t len, FILE *file, size_t file_offset)
  ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
bool KLI_file_magic_is_zstd(const char header[4]);

/**
 * Returns the file size of an opened file descriptor.
 */
size_t KLI_file_descriptor_size(int file) ATTR_WARN_UNUSED_RESULT;
/**
 * Returns the size of a file.
 */
size_t KLI_file_size(const char *path) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
 ...
 */
bool KLI_file_older(const char *file1, const char *file2) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
 ...
 */
struct LinkNode *KLI_file_read_as_lines(const char *file) ATTR_WARN_UNUSED_RESULT ATTR_NONNULL();
void *KLI_file_read_text_as_mem(const char *filepath, size_t pad_bytes, size_t *r_size);
/**
 ...
 *
 * This is an alternative to using #KLI_file_read_as_lines,
 ...
 * \code{.c}
 * size_t data_len;
 * char *data = KLI_file_read_text_as_mem_with_newline_as_nil(filepath, true, 1, &data_len);
 ...
 * \endcode
 */
void *KLI_file_read_text_as_mem_with_newline_as_nil(const char *filepath,
                                                    bool trim_trailing_space,
                                                    size_t pad_bytes,
                                                    size_t *r_size);
void *KLI_file_read_binary_as_mem(const char *filepath, size_t pad_bytes, size_t *r_size);
/**
 * Frees memory from a previous call to #KLI_file_read_as_lines.
 */
void KLI_file_free_lines(struct LinkNode *lines);
