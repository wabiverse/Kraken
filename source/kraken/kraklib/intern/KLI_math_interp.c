...
KLI_INLINE void bicubic_interpolation(const uchar *byte_buffer,
...
void KLI_bicubic_interpolation_fl(const float *buffer,
                                  float *output,
                                  int width,
                                  int height,
                                  int components,
...
void KLI_bicubic_interpolation_char(const uchar *buffer,
                                    uchar *output,
                                    int width,
                                    int height,
                                    int components,
...
KLI_INLINE void bilinear_interpolation(const uchar *byte_buffer,
                                       const float *float_buffer,
                                       uchar *byte_output,
                                       float *float_output,
                                       int width,
...
void KLI_bilinear_interpolation_fl(const float *buffer,
                                   float *output,
                                   int width,
                                   int height,
                                   int components,
...
void KLI_bilinear_interpolation_char(const uchar *buffer,
                                     uchar *output,
                                     int width,
                                     int height,
                                     int components,
...
void KLI_bilinear_interpolation_wrap_char(const uchar *buffer,
                                          uchar *output,
                                          int width,
                                          int height,
                                          int components,
...
void KLI_ewa_imp2radangle(float A,
                          float B,
                          float C,
                          float F,
                          float *a,
...
void KLI_ewa_filter(const int width,
                    const int height,
                    const bool intpol,
                    ...
                    float result[4])
{
  ...
  KLI_ewa_imp2radangle(A, B, C, F, &a, &b, &th, &ecc);
  if ((b2 = b * b) < rmin) {
    if ((a2 = a * a) < rmin) {
      B = 0.0f;
      A = C = rmin;
