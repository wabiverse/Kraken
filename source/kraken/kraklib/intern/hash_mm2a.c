...
#include "KLI_hash_mm2a.h" /* own include */
...
static void mm2a_mix_tail(KLI_HashMurmur2A *mm2, const uchar **data, size_t *len)
{
...
void KLI_hash_mm2a_add(KLI_HashMurmur2A *mm2, const uchar *data, size_t len)
{
...
{
  KLI_hash_mm2a_add(mm2, (const uchar *)&data, sizeof(data));
}
...
uint32_t KLI_hash_mm2(const uchar *data, size_t len, uint32_t seed)
{
