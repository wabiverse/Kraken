...
./kraken.bin \
    ...
    --image=./release/datafiles/kraken_icons16.png \
    --output=./release/datafiles/kraken_icons16
...
def image_from_file__bpy(filepath):
    ...
    image = kpy.data.images.load(filepath)
    image.reload()
...
def dice_icon_name(
    ...
    if name_style == 'UI_ICONS':
        ...
        if not _dice_icon_name_cache:
            ...
            ui_icons_h = os.path.join(SOURCE_DIR, "source", "kraken", "editors", "include", "UI_icons.h")
