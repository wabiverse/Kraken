...
#include "KLI_sys_types.h" /* size_t */
 ...
 */
#define UI_REGION_OVERLAP_MARGIN (UI_WIDGET_UNIT / 3)
 ...
 */
void UI_popup_menu_end(struct kContext *C, struct uiPopupMenu *pup);
bool UI_popup_menu_end_or_cancel(struct kContext *C, struct uiPopupMenu *pup);
...
int UI_popover_panel_invoke(struct kContext *C,
                            const char *idname,
                            bool keep_open,
 ...
 * Set the whole structure to work.
 */
void UI_popover_end(struct kContext *C, struct uiPopover *pup, struct wmKeyMap *keymap);
...
int UI_pie_menu_invoke(struct kContext *C, const char *idname, const struct wmEvent *event);
int UI_pie_menu_invoke_from_operator_enum(struct kContext *C,
                                          const char *title,
                                          const char *opname,
                                          const char *propname,
                                          const struct wmEvent *event);
int UI_pie_menu_invoke_from_rna_enum(struct kContext *C,
                                     const char *title,
                                     const char *path,
                                     const struct wmEvent *event);

struct uiPieMenu *UI_pie_menu_begin(struct kContext *C,
                                    const char *title,
                                    int icon,
                                    const struct wmEvent *event) ATTR_NONNULL();
void UI_pie_menu_end(struct kContext *C, uiPieMenu *pie);
...
void UI_popup_block_invoke_ex(struct kContext *C,
                              ...
                              uiFreeArgFunc arg_free,
                              bool can_refresh);
void UI_popup_block_ex(struct kContext *C,
                       uiBlockCreateFunc func,
 ...
 */
void UI_block_draw(const struct kContext *C, struct uiBlock *block);
void UI_blocklist_update_window_matrix(const struct kContext *C, const struct ListBase *lb);
void UI_blocklist_update_view_for_buttons(const struct kContext *C, const struct ListBase *lb);
 ...
 */
void UI_block_free(const struct kContext *C, uiBlock *block);
/**
 * Can be called with C==NULL.
 */
...
uiBut *UI_but_active_drop_name_button(const struct kContext *C);
/**
 * Returns true if highlighted button allows drop of names.
 * called in region context.
 */
bool UI_but_active_drop_name(const struct kContext *C);
bool UI_but_active_drop_color(struct kContext *C);
...
bool UI_but_online_manual_id_from_active(const struct kContext *C,
                                         char *r_str,
                                         size_t maxlength) ATTR_WARN_UNUSED_RESULT;
 ...
 */
void UI_but_tooltip_refresh(struct kContext *C, uiBut *but);
/**
...
void UI_popup_handlers_remove_all(struct kContext *C, struct ListBase *handlers);
 ...
 */
void uiTemplateShaderFx(uiLayout *layout, struct kContext *C);
/**
 ...
 */
void uiTemplateOperatorPropertyButs(const struct kContext *C,
                                    uiLayout *layout,
                                    struct wmOperator *op,
                                    eButLabelAlign label_align,
                                    short flag);
void uiTemplateHeader3D_mode(uiLayout *layout, struct kContext *C);
...
void UI_drop_color_copy(struct kContext *C, struct wmDrag *drag, struct wmDropBox *drop);
 ...
 * cases.
 */
uiBut *UI_context_active_but_get_respect_menu(const struct kContext *C);
/**
...
void UI_view_item_context_menu_build(struct kContext *C,
 ...
 */
bool UI_view_item_drag_start(struct kContext *C, const uiViewItemHandle *item_);
