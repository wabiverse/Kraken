...
/**
 * Sets the font color
 * (for anything fancy use UI_GetThemeColor[Fancy] then KRF_color).
 */
 ...
 * Get current theme.
 */
struct kTheme *UI_GetTheme(void);
 ...
 */
const unsigned char *UI_ThemeGetColorPtr(struct kTheme *btheme, int spacetype, int colorid);
