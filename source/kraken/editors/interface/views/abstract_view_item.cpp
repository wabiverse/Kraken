...
namespace kraken::ui
{
  ...
  {
    m_is_active = old.m_is_active;
    m_is_renaming = old.m_is_renaming;
  }
  ...
  void AbstractViewItem::begin_renaming()
  {
    ...
    std::copy(std::begin(initial_str),
              std::end(initial_str),
              std::begin(view.get_rename_buffer()));
  }
  ...
  static void rename_button_fn(kContext *UNUSED(C), void *arg, char *UNUSED(origstr))
  {
  ...
  void AbstractViewItem::add_rename_button(uiBlock &block)
  {
    ...
    const kContext *evil_C = reinterpret_cast<kContext *>(block.evil_C);
  ...
  void AbstractViewItem::build_context_menu(kContext & /*C*/, uiLayout & /*column*/) const
  {
  ...
  AbstractViewItemDragController::AbstractViewItemDragController(AbstractView &view) : m_view(view)
  {}
  ...
  AbstractViewItemDropController::AbstractViewItemDropController(AbstractView &view) : m_view(view)
  {}
  ...
  {
    KLI_assert_msg(get_view().is_reconstructed(),
...
namespace kraken::ui
{
  ...
  /**
   * Helper class to provide a higher level public (C-)API. Has access to private/protected view
   * item members and ensures some invariants that way.
   */
  class ViewItemAPIWrapper
  {
   public:
    ...
    static bool drag_start(kContext &C, const AbstractViewItem &item)
    {
    ...
    static bool drop_handle(kContext &C,
...
bool UI_view_item_drop_handle(kContext *C,
