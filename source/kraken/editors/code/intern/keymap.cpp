...
#define COMPARE(a, b)            \
  ...
  {
      return str.size() >= suffix.size() && 0 == str.compare(str.size() - suffix.size(),
  suffix.size(), suffix);
  }
  ...
  */
  ...
  {
    auto consumeDigits = [](std::shared_ptr<CommandNode> &spNode,
    ...
    auto consumeChar = [](std::shared_ptr<CommandNode> &spNode,
                          std::string::const_iterator &itrChar,
                          std::string::const_iterator itrEnd,
    ...
    auto consumeRegister = [](std::shared_ptr<CommandNode> &spNode,
                              std::string::const_iterator &itrChar,
                              std::string::const_iterator itrEnd,
    ...
    std::function<bool(std::shared_ptr<CommandNode>,
