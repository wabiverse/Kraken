...
namespace Zep
{
  ...
  // Most of these keyword values taken from : https://github.com/BalazsJako/ANCHOR_ColorTextEdit
  // another great ANCHOR based text editor.
  // I'll fill these out when I get time.  At the moment the syntax code matches on these, comments
  // and numbers.
  static std::unordered_set<std::string> cpp_keywords = {"alignas",
                                                         "alignof",
                                                         "and",
                                                         "and_eq",
                                                         "asm",
  ...
  static std::unordered_set<std::string> hlsl_identifiers = {"abort",
                                                             "abs",
                                                             "acos",
                                                             "all",
                                                             "AllMemoryBarrier",
  ...
  static std::unordered_set<std::string> glsl_keywords{"void",
                                                       "#version",
                                                       "attribute",
                                                       "uniform",
                                                       "varying",
  ...
  static std::unordered_set<std::string> cmake_keywords = {"option",
                                                           "add_compile_options",
  ...
  void RegisterSyntaxProviders(ZepEditor &editor)
  {
    ...
    editor.RegisterSyntaxFactory({".tree"}, SyntaxProvider{"tree", tSyntaxFactory([](ZepBuffer *pBuffer) {
