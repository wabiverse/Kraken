...
//
// A buffer is just an array of chars in a gap buffer, with simple operations to insert, delete and
// search A display is something that can display a collection of regions and the editor controls
// in a window A buffer region is a single view onto a buffer inside the main display
//
