...
namespace kraken::gpu
{
  ...
  struct MTLSSBOAttribute
  {
    ...
    MTLSSBOAttribute(){};
    MTLSSBOAttribute(int attribute_ind,
  ...
  struct MTLVertexDescriptor
  {
    ...
    MTL::PrimitiveTopologyClass prim_topology_class;
  ...
  struct MTLRenderPipelineStateDescriptor
  {
    ...
    MTL::PixelFormat color_attachment_format[GPU_FB_MAX_COLOR_ATTACHMENT];
    ...
    MTL::BlendOperation alpha_blend_op;
    MTL::BlendOperation rgb_blend_op;
    MTL::BlendFactor dest_alpha_blend_factor;
    MTL::BlendFactor dest_rgb_blend_factor;
    MTL::BlendFactor src_alpha_blend_factor;
    MTL::BlendFactor src_rgb_blend_factor;
    ...
    bool operator==(const MTLRenderPipelineStateDescriptor &other) const
    {
      ...
      if ((num_color_attachments != other.num_color_attachments) ||
          ...
          (alpha_blend_op != other.alpha_blend_op) || (rgb_blend_op != other.rgb_blend_op) ||
