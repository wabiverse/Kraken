...
namespace kraken::gpu
{
  ...
  class MTLIndexBuf : public IndexBuf
  {
   ...
   public:
    ...
    MTL::Buffer *get_index_buffer(GPUPrimType &in_out_primitive_type, uint &in_out_v_count);
    void flag_can_optimize(bool can_optimize);

    static MTL::IndexType gpu_index_type_to_metal(GPUIndexBufType type)
    {
      return (type == GPU_INDEX_U16) ? MTL::IndexTypeUInt16 : MTL::IndexTypeUInt32;
    }
