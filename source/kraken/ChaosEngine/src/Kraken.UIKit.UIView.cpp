...
namespace winrt::Kraken::UIKit::implementation
{
  ...
  template<typename D, typename... I> void UIViewT<D, I...>::InitializeComponent()
  {
    if (!_contentLoaded) {
      _contentLoaded = true;
  ...
  void UIViewT<D, I...>::Connect(int32_t connectionId, IInspectable const &target)
  {
    switch (connectionId) {
      ...
      case 3: {
        ...
        targetElement.DisplayModeChanged(
          [weakThis](
            ::winrt::Microsoft::UI::Xaml::Controls::NavigationView const &p0,
            ::winrt::Microsoft::UI::Xaml::Controls::NavigationViewDisplayModeChangedEventArgs const
              &p1) {
  ...
  template<typename D, typename... I> void UIViewT<D, I...>::DisconnectUnloadedObject(int32_t)
  {
    throw ::winrt::hresult_invalid_argument{L"No unloadable objects to disconnect."};
  }

  template<typename D, typename... I> void UIViewT<D, I...>::UnloadObject(DependencyObject const &)
  {
...
#pragma warning(pop)
  ...
  void UIView::TitleBarLayoutEvent(
  ...
  void UIView::TitleBarVisibilityEvent(
    Windows::ApplicationModel::Core::CoreApplicationViewTitleBar const &sender,
    IInspectable const &event)
  {
    if (sender.IsVisible()) {
                                    ...
                                    Windows::UI::Core::WindowActivatedEventArgs const &event)
  {
    ...
    auto primaryTextFillColor{Application::Current()
                                .Resources()
                                .Lookup(resPrimary)
                                .as<Windows::UI::Xaml::Media::SolidColorBrush>()};

    Uri resDisabled{L"TextFillColorDisabledBrush"};
    auto disabledTextFillColor{Application::Current()
                                 .Resources()
                                 .Lookup(resDisabled)
                                 .as<Windows::UI::Xaml::Media::SolidColorBrush>()};


    if (event.WindowActivationState() ==
  ...
  void UIView::NavigationViewControl_DisplayModeChanged(
    ...
    Microsoft::UI::Xaml::Controls::NavigationViewDisplayModeChangedEventArgs const &event)
  {
    ...
    if (NavigationViewControl().IsBackButtonVisible() ==
    ...
    else if (sender.DisplayMode() ==
             Microsoft::UI::Xaml::Controls::NavigationViewDisplayMode::Minimal) {
