...
/* texco (also in USD_material_types.h) */
...
{
  USD_DEFINE_CXX_METHODS(LineStyleModifier)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_AlongStroke)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_AlongStroke)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_AlongStroke)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_DistanceFromCamera)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_DistanceFromCamera)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_DistanceFromCamera)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_DistanceFromObject)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_DistanceFromObject)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_DistanceFromObject)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_Curvature_3D)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_Curvature_3D)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_Curvature_3D)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_Noise)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_Noise)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_Noise)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_CreaseAngle)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_CreaseAngle)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_CreaseAngle)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_Tangent)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_Tangent)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_Tangent)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleColorModifier_Material)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleAlphaModifier_Material)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_Material)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_Sampling)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_BezierCurve)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_SinusDisplacement)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_SpatialNoise)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_PerlinNoise1D)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_PerlinNoise2D)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_BackboneStretcher)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_TipRemover)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_Polygonalization)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_GuidingLines)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_Blueprint)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_2DOffset)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_2DTransform)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleGeometryModifier_Simplification)
...
{
  USD_DEFINE_CXX_METHODS(LineStyleThicknessModifier_Calligraphy)
...
{
  USD_DEFINE_CXX_METHODS(FreestyleLineStyle)
