...
{
  USD_DEFINE_CXX_METHODS(TexPaintSlot)
...
{
  USD_DEFINE_CXX_METHODS(MaterialGPencilStyle)
  ...
  float gradient_angle USD_DEPRECATED;
  /** Radius for radial gradients. */
  float gradient_radius USD_DEPRECATED;
  char _pad2[4];
  /** Uv coordinates scale. */
  float gradient_scale[2] USD_DEPRECATED;
  /** Factor to shift filling in 2d space. */
  float gradient_shift[2] USD_DEPRECATED;
  ...
  /** Texture opacity. */
  float texture_opacity USD_DEPRECATED;
...
{
  USD_DEFINE_CXX_METHODS(Material)
  ...
  float alpha USD_DEPRECATED;
  float ray_mirror USD_DEPRECATED;
  float spec;
  /** Renamed and inversed to roughness. */
  float gloss_mir USD_DEPRECATED;
  float roughness;
  float metallic;
