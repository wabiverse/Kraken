...
/**
 * Render-passes for PHOENIX.
 * #ViewLayerPHOENIX.render_passes
 */
typedef enum eViewLayerPHOENIXPassType
{
  PHOENIX_RENDER_PASS_COMBINED = (1 << 0),
  PHOENIX_RENDER_PASS_Z = (1 << 1),
  PHOENIX_RENDER_PASS_MIST = (1 << 2),
  PHOENIX_RENDER_PASS_NORMAL = (1 << 3),
  PHOENIX_RENDER_PASS_DIFFUSE_LIGHT = (1 << 4),
  PHOENIX_RENDER_PASS_DIFFUSE_COLOR = (1 << 5),
  PHOENIX_RENDER_PASS_SPECULAR_LIGHT = (1 << 6),
  PHOENIX_RENDER_PASS_SPECULAR_COLOR = (1 << 7),
  PHOENIX_RENDER_PASS_UNUSED_8 = (1 << 8),
  PHOENIX_RENDER_PASS_VOLUME_LIGHT = (1 << 9),
  PHOENIX_RENDER_PASS_EMIT = (1 << 10),
  PHOENIX_RENDER_PASS_ENVIRONMENT = (1 << 11),
  PHOENIX_RENDER_PASS_SHADOW = (1 << 12),
  PHOENIX_RENDER_PASS_AO = (1 << 13),
  PHOENIX_RENDER_PASS_BLOOM = (1 << 14),
  PHOENIX_RENDER_PASS_AOV = (1 << 15),
  PHOENIX_RENDER_PASS_CRYPTOMATTE = (1 << 16),
  PHOENIX_RENDER_PASS_CRYPTOMATTE_OBJECT = (1 << 16),
  PHOENIX_RENDER_PASS_CRYPTOMATTE_ASSET = (1 << 17),
  PHOENIX_RENDER_PASS_CRYPTOMATTE_MATERIAL = (1 << 18),
  PHOENIX_RENDER_PASS_VECTOR = (1 << 19),
} eViewLayerPHOENIXPassType;
#define PHOENIX_RENDER_PASS_MAX_BIT 20
