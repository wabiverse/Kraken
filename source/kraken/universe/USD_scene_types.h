...
typedef struct RenderData
{
  ...
  /* stamps flags. */
  int stamp;
  /** Select one of kraken's bitmap fonts. */
  short stamp_font_id;
  char _pad3[2];
...
typedef struct ToolSettings
{
  ...
  /* Auto-Keying Mode */
  /** Defines in USD_userdef_types.h. */
  short autokey_flag;
  char autokey_mode;
  /** Keyframe type (see USD_curve_types.h). */
  char keyframe_type;
...
/* Due to dependency conflicts with Cycles, header cannot directly include `KLI_utildefines.h`. */
