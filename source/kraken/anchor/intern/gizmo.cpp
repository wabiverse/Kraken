...
namespace AnchorGizmo
{
      ...
      for (unsigned int axisIndex = 0; axisIndex < numAxes; ++axisIndex)
      {
         ...
         if (gContext.mbUsingBounds && (gContext.mActualID == -1 || gContext.mActualID == gContext.mEditingID))
         {
            ...
            *matrix = res;
            ...
            char tmps[512];
            GfVec2f destinationPosOnScreen = worldToPos(gContext.mModel.v.position, gContext.mViewProjection);
            AnchorFormatString(tmps, sizeof(tmps), "X: %.2f Y: %.2f Z:%.2f"
   ...
   void ViewManipulate(float* view, float length, GfVec2f position, GfVec2f size, AnchorU32 backgroundColor)
   {
      ...
      // panels
      static const GfVec2f panelPosition[9] = { GfVec2f(0.75f,0.75f), GfVec2f(0.25f, 0.75f), GfVec2f(0.f, 0.75f),
         GfVec2f(0.75f, 0.25f), GfVec2f(0.25f, 0.25f), GfVec2f(0.f, 0.25f),
         GfVec2f(0.75f, 0.f), GfVec2f(0.25f, 0.f), GfVec2f(0.f, 0.f) };

      static const GfVec2f panelSize[9] = { GfVec2f(0.25f,0.25f), GfVec2f(0.5f, 0.25f), GfVec2f(0.25f, 0.25f),
         GfVec2f(0.25f, 0.5f), GfVec2f(0.5f, 0.5f), GfVec2f(0.25f, 0.5f),
         GfVec2f(0.25f, 0.25f), GfVec2f(0.5f, 0.25f), GfVec2f(0.25f, 0.25f) };
