...
function(_wabi_target_link_libraries NAME)
    ...
    if("${type}" STREQUAL "OBJECT_LIBRARY")
        ...
        elseif(NOT BUILD_SHARED_LIBS)
            ...
            foreach(lib ${internal})
                ...
                elseif(WIN32)
                    ...
                    set_property(TARGET ${lib} PROPERTY VS_PACKAGE_REFERENCES "Microsoft.Windows.CppWinRT_2.0.210806.1;Microsoft.WindowsAppSDK.DWrite_1.0.0-experimental1;Microsoft.WindowsAppSDK_1.0.0-experimental1;Microsoft.WindowsAppSDK.Foundation_1.0.0-experimental1;Microsoft.WindowsAppSDK.WinUI_1.0.0-experimental1")
                    ...
                    set_property(TARGET ${lib} PROPERTY VS_GLOBAL_TargetFramework "net6.0-windows10.0.22000.0")
                elseif(CMAKE_COMPILER_IS_GNUCXX)
        ...
        if(WIN32)
            ...
            set_property(TARGET ${NAME} PROPERTY VS_GLOBAL_TargetFramework "net6.0-windows10.0.22000.0")
            if(TARGET maelstrom)
                ...
                set_property(TARGET maelstrom PROPERTY VS_PACKAGE_REFERENCES "Microsoft.Windows.CppWinRT_2.0.210806.1;Microsoft.WindowsAppSDK.DWrite_1.0.0-experimental1;Microsoft.WindowsAppSDK_1.0.0-experimental1;Microsoft.WindowsAppSDK.Foundation_1.0.0-experimental1;Microsoft.WindowsAppSDK.WinUI_1.0.0-experimental1")
                ...
                set_property(TARGET maelstrom PROPERTY VS_GLOBAL_TargetFramework "net6.0-windows10.0.22000.0")
