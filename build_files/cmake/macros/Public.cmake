...
function(wabi_python_bin BIN_NAME)
    ...
    if(UNIX AND NOT APPLE)
        set(outfile /usr/local/share/kraken/${TARGETDIR_VER}/python/lib/python3.10/site-packages/wabi/${BIN_NAME})
    elseif(APPLE)
...
function(wabi_setup_python)
    ...
    if(UNIX AND NOT APPLE)
        # _get_install_dir("/usr/local/share/kraken/${TARGETDIR_VER}/python/lib/python3.10/site-packages/wabi" installPrefix)
    elseif(APPLE)
...
function (wabi_create_test_module MODULE_NAME)
    ...
    elseif(UNIX ABD NOT APPLE)
        set(PY_SITE_PACKAGES ${TARGETDIR_VER}/python/lib/python3.10/site-packages/wabi/${MODULE_NAME})
    elseif(APPLE)
        set(PY_SITE_PACKAGES ${TARGETDIR_VER}/scripts/modules/wabi/${MODULE_NAME})
    endif()
...
function(wabi_register_test TEST_NAME)
    ...
    elseif(UNIX AND NOT APPLE)
        set(_testPythonPath "${CMAKE_INSTALL_PREFIX}/${TARGETDIR_VER}/python/lib/python3.10/site-packages;$ENV{PYTHONPATH}")
    elseif(APPLE)
        set(_testPythonPath "${CMAKE_INSTALL_PREFIX}/${TARGETDIR_VER}/scripts/modules;$ENV{PYTHONPATH}")
    endif()
    if(WIN32)
