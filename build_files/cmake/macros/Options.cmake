...
if(${WABI_BUILD_USDVIEW})
  if(NOT ${WABI_BUILD_USD_IMAGING})
    message(STATUS "Setting WABI_BUILD_USDVIEW=OFF because WABI_BUILD_USD_IMAGING=OFF")
    set(WABI_BUILD_USDVIEW "OFF" CACHE BOOL "" FORCE)
  elseif (NOT ${WABI_ENABLE_PYTHON_SUPPORT})
    message(STATUS "Setting WABI_BUILD_USDVIEW=OFF because WABI_ENABLE_PYTHON_SUPPORT=OFF")
    set(WABI_BUILD_USDVIEW "OFF" CACHE BOOL "" FORCE)
  elseif (NOT ${WITH_GPU_SUPPORT})
    message(STATUS "Setting WABI_BUILD_USDVIEW=OFF because WITH_GPU_SUPPORT=OFF")
    set(WABI_BUILD_USDVIEW "OFF" CACHE BOOL "" FORCE)
  endif()
endif()
