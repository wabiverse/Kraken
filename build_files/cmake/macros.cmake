...
function(kraken_add_lib__impl
  ...
  elseif(APPLE)
    set_property(TARGET ${name} APPEND_STRING PROPERTY LINK_FLAGS "-Wl,-force_load $<TARGET_FILE:kraken>")
    set_property(TARGET ${name} APPEND_STRING PROPERTY LINK_FLAGS_DEBUG "-Wl,-force_load $<TARGET_FILE:kraken>")
    set_property(TARGET ${name} APPEND_STRING PROPERTY LINK_FLAGS_RELEASE "-Wl,-force_load $<TARGET_FILE:kraken>")
  elseif(UNIX)
