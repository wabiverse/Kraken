...
{
  static let logger: Logger = .init(subsystem: "foundation.wabi.CosmoEditor", category: "TreeSitterClient")
  ...
  private let operationQueue = DispatchQueue(
    label: "CosmoEditor.TreeSitter.EditQueue",
    qos: .userInteractive
  )
  ...
  public func applyEdit(textView: TextView, range: NSRange, delta: Int, completion: @escaping (IndexSet) -> Void)
  {
    ...
    {
      textView.pointForLocation(range.max) ?? .zero
    }
